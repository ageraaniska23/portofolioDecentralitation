...
function unfetch_module_default(e2, n3) {
  return n3 = n3 || {}, new Promise(function(t, r2) {
    ...
    }, s2.onerror = r2, s2.withCredentials = "include" == n3.credentials, n3.headers) s2.setRequestHeader(l2, n3.headers[l2]);
...
var f2 = class {
  constructor(e2) {
    if (this.url = e2, this.events = new import_events.EventEmitter(), this.registering = false, !isWsUrl(e2)) throw new Error(`Provided URL is not compatible with WebSocket connection: ${e2}`);
    this.url = e2;
  }
  get connected() {
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-IZQD6UD7.js.map
