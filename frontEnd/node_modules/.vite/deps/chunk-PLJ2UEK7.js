...
async function registerPasskey(options) {
  ...
  const registration = await S.register(generatedName, challenge, {
...
async function loginWithPasskey(options) {
  ...
  const authentication = await S.authenticate(credentials, challenge, {
    authenticatorType: options.authenticatorType ?? "auto",
    userVerification: "required"
  });
  const customHeaders = {};
...
//# sourceMappingURL=chunk-PLJ2UEK7.js.map
