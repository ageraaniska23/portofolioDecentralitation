...
var Spacer = ({ y }) => {
  return (0, import_jsx_runtime4.jsx)("div", { style: {
    height: spacing[y]
  } });
};
...
var QueryClientProvider = ({
  ...
  return (0, import_jsx_runtime5.jsx)(QueryClientContext.Provider, { value: client, children });
};
...
var _client2, _result, _queries2, _observers3, _combinedResult, _lastCombine, _lastResult, _QueriesObserver_instances, combineResult_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn2, _a10;
...
}, _client2 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _observers3 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _QueriesObserver_instances = new WeakSet(), combineResult_fn = function(input, combine2) {
  if (combine2) {
...
//# sourceMappingURL=chunk-WOF5MGUW.js.map
