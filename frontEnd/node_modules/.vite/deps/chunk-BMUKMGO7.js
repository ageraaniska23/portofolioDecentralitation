...
import {
  preAuthenticate
} from "./chunk-QNGRS3PX.js";
import {
  hasStoredPasskey
} from "./chunk-PLJ2UEK7.js";
import {
  loginWithOauthRedirect
} from "./chunk-FSUHYENI.js";
import {
  webLocalStorage
...
function OTPLoginUI(props) {
  ...
  if (screen === "base") {
    return (0, import_jsx_runtime2.jsxs)(Container, { fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime2.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime2.jsx)(ModalHeader, { title: locale.signIn, onBack: goBack }) }), (0, import_jsx_runtime2.jsx)(Container, { expand: true, flex: "column", center: "y", children: (0, import_jsx_runtime2.jsxs)("form", { onSubmit: (e) => {
      ...
      textAlign: "center"
    }, children: [(0, import_jsx_runtime2.jsx)(Text, { size: "sm", children: locale.emailLoginScreen.sendingCode }), (0, import_jsx_runtime2.jsx)(Spinner, { size: "xs", color: "secondaryText" })] }), typeof accountStatus === "object" && (0, import_jsx_runtime2.jsx)(LinkButton, { onClick: sendEmailOrSms, type: "button", children: locale.emailLoginScreen.resendCode })] })] }) })] });
  }
  return null;
}
...
var AccentFailIcon = (props) => {
  return (0, import_jsx_runtime3.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 109 109", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: [(0, import_jsx_runtime3.jsxs)("g", { clipPath: "url(#clip0_4036_4155)", children: [(0, import_jsx_runtime3.jsx)("path", { d: "M54.5 109C84.5995 109 109 84.5995 109 54.5C109 24.4005 84.5995 0 54.5 0C24.4005 0 0 24.4005 0 54.5C0 84.5995 24.4005 109 54.5 109Z", fill: "#4BABFF" }), (0, import_jsx_runtime3.jsx)("path", { d: "M55 96C77.6437 96 96 77.6437 96 55C96 32.3563 77.6437 14 55 14C32.3563 14 14 32.3563 14 55C14 77.6437 32.3563 96 55 96Z", fill: "#1C85FF" }), (0, import_jsx_runtime3.jsx)("path", { d: "M73.2352 69.389C73.7459 69.8997 74.0329 70.5924 74.0329 71.3147C74.0329 72.037 73.7459 72.7298 73.2352 73.2405C72.7244 73.7513 72.0317 74.0382 71.3094 74.0382C70.5871 74.0382 69.8944 73.7513 69.3836 73.2405L54.9992 58.8515L40.6102 73.236C40.0994 73.7467 39.4067 74.0337 38.6844 74.0337C37.9621 74.0337 37.2694 73.7467 36.7586 73.236C36.2479 72.7252 35.9609 72.0325 35.9609 71.3102C35.9609 70.5879 36.2479 69.8952 36.7586 69.3844L51.1476 55L36.7632 40.611C36.2524 40.1002 35.9655 39.4075 35.9655 38.6852C35.9655 37.9629 36.2524 37.2702 36.7632 36.7594C37.2739 36.2487 37.9666 35.9617 38.6889 35.9617C39.4112 35.9617 40.104 36.2487 40.6147 36.7594L54.9992 51.1484L69.3881 36.7572C69.8989 36.2464 70.5916 35.9595 71.3139 35.9595C72.0362 35.9595 72.729 36.2464 73.2397 36.7572C73.7505 37.2679 74.0374 37.9606 74.0374 38.6829C74.0374 39.4052 73.7505 40.098 73.2397 40.6087L58.8507 55L73.2352 69.389Z", fill: "url(#paint0_linear_4036_4155)" })] }), (0, import_jsx_runtime3.jsxs)("defs", { children: [(0, import_jsx_runtime3.jsxs)("linearGradient", { id: "paint0_linear_4036_4155", x1: "54.9992", y1: "35.9595", x2: "54.9992", y2: "74.0382", gradientUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime3.jsx)("stop", { stopColor: "white" }), (0, import_jsx_runtime3.jsx)("stop", { offset: "1", stopColor: "#90CBFF" })] }), (0, import_jsx_runtime3.jsx)("clipPath", { id: "clip0_4036_4155", children: (0, import_jsx_runtime3.jsx)("rect", { width: "109", height: "109", fill: "white" }) })] })] });
};
...
function PassKeyLogin(props) {
  ...
  return (0, import_jsx_runtime5.jsxs)(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, import_jsx_runtime5.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime5.jsx)(ModalHeader, { title: "Passkey", onBack: props.onBack }) }), (0, import_jsx_runtime5.jsx)(Container, { px: size === "wide" ? "xxl" : "lg", expand: true, flex: "column", center: "y", children: (0, import_jsx_runtime5.jsxs)("div", { children: [screen === "loading" && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)(LoadingScreen, {}), (0, import_jsx_runtime5.jsx)(Spacer, { y: "xxl" })] }), screen === "select" && (0, import_jsx_runtime5.jsx)(SelectLoginMethod, { onSignin: () => {
    setScreen("login");
  }, onSignup: () => {
    setScreen("signup");
  } }), screen === "login" && (0, import_jsx_runtime5.jsx)(LoginScreen, { wallet, client, done, onCreate: () => {
    setScreen("signup");
  }, chain }), screen === "signup" && (0, import_jsx_runtime5.jsx)(SignupScreen, { wallet, client, done, chain })] }) })] });
}
function LoginScreen(props) {
  ...
  if (status === "loading") {
    return (0, import_jsx_runtime5.jsx)(LoadingState, { title: "Requesting Passkey", subtitle: "A pop-up prompt will appear to sign-in and verify your passkey" });
  }
  if (status === "error") {
    return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)(ErrorState, { onTryAgain: login, title: "Failed to Login" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime5.jsx)(Button, { variant: "outline", fullWidth: true, onClick: props.onCreate, children: "Create a new Passkey" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "lg" })] });
  }
  return null;
}
function SignupScreen(props) {
  ...
  if (status === "loading") {
    return (0, import_jsx_runtime5.jsx)(LoadingState, { title: "Creating Passkey", subtitle: "A pop-up prompt will appear to sign-in and verify your passkey" });
  }
  if (status === "error") {
    return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)(ErrorState, { onTryAgain: signup, title: "Failed to create passkey" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "lg" })] });
  }
  return null;
}
function SelectLoginMethod(props) {
  return (0, import_jsx_runtime5.jsxs)(Container, { children: [(0, import_jsx_runtime5.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime5.jsx)(Container, { flex: "row", center: "x", color: "accentText", children: (0, import_jsx_runtime5.jsx)(FingerPrintIcon, { size: iconSize["4xl"] }) }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime5.jsx)(Button, { variant: "accent", onClick: props.onSignup, fullWidth: true, children: "Create a Passkey" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime5.jsx)(Button, { variant: "outline", onClick: props.onSignin, fullWidth: true, children: "I have a Passkey" }), (0, import_jsx_runtime5.jsx)(Spacer, { y: "lg" })] });
}
...
function SocialLogin(props) {
  ...
  const handleSocialLogin = async () => {
    ...
    if (walletConfig && "auth" in walletConfig && ((_a2 = walletConfig == null ? void 0 : walletConfig.auth) == null ? void 0 : _a2.mode) === "redirect") {
  ...
  return (0, import_jsx_runtime6.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: (0, import_jsx_runtime6.jsxs)(Container, { flex: "column", expand: true, p: "lg", style: {
    paddingBottom: 0
  }, children: [props.goBack && (0, import_jsx_runtime6.jsx)(ModalHeader, { title: locale.title, onBack: props.goBack }), props.size === "compact" ? (0, import_jsx_runtime6.jsx)(Spacer, { y: "xl" }) : null, (0, import_jsx_runtime6.jsxs)(Container, { flex: "column", center: "both", expand: true, style: {
    textAlign: "center",
    minHeight: "250px"
  }, children: [status !== "error" && (0, import_jsx_runtime6.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime6.jsx)(Text, { color: "primaryText", center: true, multiline: true, style: {
    maxWidth: "250px"
  }, children: locale.instruction }), (0, import_jsx_runtime6.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime6.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime6.jsx)(Spinner, { size: "lg", color: "accentText" }) }), (0, import_jsx_runtime6.jsx)(Spacer, { y: "xxl" })] }), status === "error" && (0, import_jsx_runtime6.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime6.jsx)(Text, { color: "danger", children: locale.failed }), authError && (0, import_jsx_runtime6.jsx)(Text, { color: "danger", children: authError }), (0, import_jsx_runtime6.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime6.jsx)(Button, { variant: "primary", onClick: handleSocialLogin, children: locale.retry }), (0, import_jsx_runtime6.jsx)(Spacer, { y: "xxl" })] })] })] }) });
}
...
function TOS(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime7.jsxs)(Text, { size: "xs", multiline: true, balance: true, inline: true, center: true, style: {
    maxWidth: "250px"
  }, children: [locale.prefix, " ", termsOfServiceUrl && (0, import_jsx_runtime7.jsxs)(Link, { inline: true, size: "xs", href: termsOfServiceUrl, target: "_blank", style: {
    whiteSpace: "nowrap"
  }, children: [" ", locale.termsOfService, " "] }), bothGiven && `${locale.and} `, privacyPolicyUrl && (0, import_jsx_runtime7.jsx)(Link, { inline: true, size: "xs", href: privacyPolicyUrl, target: "_blank", children: locale.privacyPolicy })] }) });
}
...
//# sourceMappingURL=chunk-BMUKMGO7.js.map
