...
var RemoveScroll = React16.forwardRef(function(props, parentRef) {
  ...
  return React16.createElement(
    ...
    forwardProps ? React16.cloneElement(React16.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React16.createElement(Container2, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var Modal = (props) => {
  ...
  return (0, import_jsx_runtime8.jsxs)(Root, { open, onOpenChange: props.setOpen, children: [props.trigger && (0, import_jsx_runtime8.jsx)(Trigger, { asChild: true, children: props.trigger }), (0, import_jsx_runtime8.jsxs)(Portal2, { children: [!props.hide && (0, import_jsx_runtime8.jsx)(Overlay, { asChild: true, children: (0, import_jsx_runtime8.jsx)(Overlay2, { ref: overlayRef }) }), (0, import_jsx_runtime8.jsx)(FocusScope, { trapped: !props.hide, children: (0, import_jsx_runtime8.jsx)(Content, { asChild: true, children: (0, import_jsx_runtime8.jsxs)(DialogContent2, { ref: contentRef, style: props.hide ? { width: 0, height: 0, overflow: "hidden", opacity: 0 } : {
    height: props.size === "compact" ? "auto" : wideModalMaxHeight,
    maxWidth: props.size === "compact" ? modalMaxWidthCompact : modalMaxWidthWide
  }, children: [props.size === "compact" ? (0, import_jsx_runtime8.jsxs)(DynamicHeight, { maxHeight: compactModalMaxHeight, children: [props.children, " "] }) : props.children, !props.hideCloseIcon && (0, import_jsx_runtime8.jsx)(CrossContainer, { children: (0, import_jsx_runtime8.jsx)(Close, { asChild: true, children: (0, import_jsx_runtime8.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime8.jsx)(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
    color: "inherit"
  } }) }) }) })] }) }) })] })] });
};
...
var Drawer = (0, import_react9.forwardRef)(function Drawer_(props, ref) {
  return (0, import_jsx_runtime9.jsx)(DrawerContainer, { ref, children: (0, import_jsx_runtime9.jsx)(DynamicHeight, { children: (0, import_jsx_runtime9.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime9.jsx)(CrossContainer, { children: (0, import_jsx_runtime9.jsx)(IconButton, { type: "button", "aria-label": "Close", onClick: props.close, children: (0, import_jsx_runtime9.jsx)(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
    color: "inherit"
  } }) }) }), props.children] }) }) });
});
...
function SwitchNetworkButton(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(Button, { ...props, gap: "xs", onClick: async () => {
    setIsSwitching(true);
    try {
  ...
  }, children: isSwitching ? (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: ["Switching", (0, import_jsx_runtime10.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] }) : "Switch Network" });
}
...
function TokenSymbol(props) {
  if (!isNativeToken(props.token)) {
    return (0, import_jsx_runtime11.jsx)(Text, { size: props.size, color: props.color || "primaryText", inline: props.inline, children: props.token.symbol });
  }
  return (0, import_jsx_runtime11.jsx)(NativeTokenSymbol, { chain: props.chain, size: props.size, color: props.color, inline: props.inline });
}
function NativeTokenSymbol(props) {
  const chainSymbolQuery = useChainSymbol(props.chain);
  if (chainSymbolQuery.isLoading) {
    return (0, import_jsx_runtime11.jsx)(Skeleton, { width: "70px", height: fontSize[props.size] });
  }
  return (0, import_jsx_runtime11.jsx)(Text, { size: props.size, color: props.color || "primaryText", inline: props.inline, children: chainSymbolQuery.symbol ?? "ETH" });
}
  ...
  const loginMutation = useMutation({
    ...
    mutationFn: async () => {
      ...
      const [payload, { signLoginPayload }] = await Promise.all([
        ...
        import("./sign-login-payload-2S4TILW6.js")
      ]);
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-FSTFG62C.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-4II4MOMG.js"),
              import("./in-app-core-REVYNPNL.js")
            ]);
...
function useAutoConnectCore(storage, props, getInstalledWallets2) {
  ...
  const autoConnect = async () => {
    ...
    const availableWallets = [...wallets, ...(getInstalledWallets2 == null ? void 0 : getInstalledWallets2()) ?? []];
...
var ChainIcon = (props) => {
  ...
  return (0, import_jsx_runtime13.jsxs)("div", { style: {
    ...
    flexShrink: 0,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime13.jsx)(Img, { src: getSrc(), width: props.size, height: props.size, fallbackImage: fallbackChainIcon, client: props.client }), props.active && (0, import_jsx_runtime13.jsx)(ActiveDot, {})] });
};
...
// node_modules/thirdweb/dist/esm/react/web/ui/components/Tooltip.js
var ToolTip = (props) => {
  return (0, import_jsx_runtime18.jsx)(Provider, { delayDuration: 200, children: (0, import_jsx_runtime18.jsxs)(Root32, { children: [(0, import_jsx_runtime18.jsx)(Trigger2, { asChild: true, children: props.children }), (0, import_jsx_runtime18.jsx)(Portal3, { children: (0, import_jsx_runtime18.jsxs)(TooltipContent2, { sideOffset: props.sideOffset || 6, align: props.align || "center", side: props.side || "top", children: [props.tip, (0, import_jsx_runtime18.jsx)(TooltipArrow2, {})] }) })] }) });
};
...
var CopyIcon2 = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)("div", { onClick: onCopy, style: {
    display: "flex",
    alignItems: "center",
  ...
  }, children: (0, import_jsx_runtime19.jsx)(ToolTip, { tip: props.tip, side: props.side, align: props.align, children: (0, import_jsx_runtime19.jsx)("div", { children: (0, import_jsx_runtime19.jsx)(Container, { color: showCheckIcon ? "success" : void 0, flex: "row", center: "both", children: showCheckIcon ? (0, import_jsx_runtime19.jsx)(CheckIcon, {}) : (0, import_jsx_runtime19.jsx)(CopyIcon, {}) }) }) }) });
};
...
async function getConnectLocale(localeId) {
  switch (localeId) {
    case "es_ES": {
      return (await import("./es-DK77TFOG.js")).default;
    }
    case "ja_JP": {
      return (await import("./ja-GYS6WSX2.js")).default;
    }
    case "tl_PH": {
      return (await import("./tl-GSXGPN5P.js")).default;
    }
    case "vi_VN": {
      return (await import("./vi-UYDALI6T.js")).default;
    }
    case "de_DE": {
      return (await import("./de-WMUNUWOB.js")).default;
    }
    case "ko_KR": {
      return (await import("./kr-42PNJMX3.js")).default;
    }
    case "fr_FR": {
      return (await import("./fr-VL7WPU4J.js")).default;
    }
    default: {
      return (await import("./en-J72UBSCY.js")).default;
    }
  }
}
...
function NetworkSelectorContent(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(Container, { children: [(0, import_jsx_runtime20.jsx)(Container, { p: "lg", children: props.onBack ? (0, import_jsx_runtime20.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }) : (0, import_jsx_runtime20.jsx)(ModalTitle, { children: locale.title }) }), props.showTabs !== false && (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime20.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime20.jsx)(TabButton, { onClick: () => setSelectedTab("all"), "data-active": selectedTab === "all", children: locale.allNetworks }), (0, import_jsx_runtime20.jsx)(TabButton, { onClick: () => setSelectedTab("mainnet"), "data-active": selectedTab === "mainnet", children: locale.mainnets }), (0, import_jsx_runtime20.jsx)(TabButton, { onClick: () => setSelectedTab("testnet"), "data-active": selectedTab === "testnet", children: locale.testnets })] }) }), (0, import_jsx_runtime20.jsx)(Spacer, { y: "lg" })] }), props.showTabs === false && (0, import_jsx_runtime20.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime20.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime20.jsxs)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: [(0, import_jsx_runtime20.jsx)(StyledMagnifyingGlassIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime20.jsx)(Input, { style: {
    padding: `${spacing.sm} ${spacing.md} ${spacing.sm} ${spacing.xxl}`
  }, tabIndex: -1, variant: "outline", value: searchTerm, onChange: (e) => {
    setSearchTerm(e.target.value);
  }, disabled: isAllChainsQueryLoading, placeholder: isAllChainsQueryLoading ? "Loading chains..." : locale.inputPlaceholder }), (deferredSearchTerm !== searchTerm || isAllChainsQueryLoading) && (0, import_jsx_runtime20.jsx)("div", { style: {
    position: "absolute",
    right: spacing.md
  }, children: (0, import_jsx_runtime20.jsx)(Spinner, { size: "md", color: "accentText" }) })] }) }), (0, import_jsx_runtime20.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime20.jsx)(Container, { px: "md", children: (0, import_jsx_runtime20.jsx)(NetworkTabContent, { chainSections: filteredChainSections, onSwitch: handleSwitch, renderChain: (_d = props.networkSelector) == null ? void 0 : _d.renderChain, connectLocale: props.connectLocale, client: props.client, close: props.closeModal }) }), onCustomClick && (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)(Line, {}), (0, import_jsx_runtime20.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime20.jsx)(Button, { fullWidth: true, variant: "link", onClick: () => {
    onCustomClick();
    props.closeModal();
  }, style: {
    display: "flex",
...
var NetworkTabContent = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(Container, { scrollY: true, animate: "fadein", style: {
    height: "330px",
    paddingBottom: spacing.lg
  }, children: noChainsToShow ? (0, import_jsx_runtime20.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", children: [(0, import_jsx_runtime20.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime20.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime20.jsx)(Text, { children: " No Results " })] }) : chainSections.map((section, idx) => {
    if (section.chains.length === 0) {
      return null;
    }
    return (0, import_jsx_runtime20.jsxs)(import_react19.Fragment, { children: [idx !== 0 && (0, import_jsx_runtime20.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime20.jsx)(SectionLabel, { children: section.label }), (0, import_jsx_runtime20.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime20.jsx)(NetworkList, { chains: section.chains, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close, client: props.client, connectLocale: props.connectLocale })] }, section.label);
  }) });
};
var NetworkList = (0, import_react19.memo)(function NetworkList2(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(NetworkListUl, { children: chainsToShow.map((chain, i) => {
    if (!chain) {
      return null;
    }
    ...
    return (0, import_jsx_runtime20.jsx)("li", { ref: isLast ? lastItemRef : void 0, children: RenderChain ? (0, import_jsx_runtime20.jsx)(RenderChain, { switchChain: () => {
      handleSwitch(chain);
    }, chain, switching: switchingChainId === chain.id, switchFailed: errorSwitchingChainId === chain.id, close: props.close }) : (0, import_jsx_runtime20.jsx)(ChainButton, { chain, confirming, onClick: () => handleSwitch(chain), switchingFailed, client: props.client, connectLocale: props.connectLocale }) }, chain.id);
  }) });
});
var ChainButton = (0, import_react19.memo)(function ChainButton2(props) {
  ...
  if (chainNameQuery.name) {
    chainName = (0, import_jsx_runtime20.jsxs)("span", { children: [chainNameQuery.name, " "] });
  } else {
    chainName = (0, import_jsx_runtime20.jsx)(Skeleton, { width: "150px", height: "20px" });
  }
  return (0, import_jsx_runtime20.jsxs)(NetworkButton, { "data-active": (activeChain == null ? void 0 : activeChain.id) === chain.id, onClick: props.onClick, children: [!chainIconQuery.isLoading ? (0, import_jsx_runtime20.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, active: (activeChain == null ? void 0 : activeChain.id) === chain.id, loading: "lazy", client: props.client }) : (0, import_jsx_runtime20.jsx)(Skeleton, { width: `${iconSize.lg}px`, height: `${iconSize.lg}px` }), confirming || switchingFailed ? (0, import_jsx_runtime20.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: spacing.xs
  }, children: [chainName, (0, import_jsx_runtime20.jsxs)(Container, { animate: "fadein", flex: "row", gap: "xxs", center: "y", children: [confirming && (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)(Text, { size: "xs", color: "accentText", children: locale.confirmInWallet }), (0, import_jsx_runtime20.jsx)(Spinner, { size: "xs", color: "accentText" })] }), switchingFailed && (0, import_jsx_runtime20.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime20.jsx)(Text, { size: "xs", color: "danger", children: locale.networkSelector.failedToSwitch }) })] })] }) : chainName] });
});
...
function useNetworkSwitcherModal() {
  ...
  const openNetworkSwitcher = (0, import_react19.useCallback)(async (props) => {
    ...
    setRootEl((0, import_jsx_runtime20.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime20.jsx)(Modal, { size: "compact", open: true, setOpen: (value) => {
      if (!value) {
        closeModal();
      }
    }, style: {
      paddingBottom: props.onCustomClick ? spacing.md : "0px"
    }, children: (0, import_jsx_runtime20.jsx)(NetworkSelectorContent, { client: props.client, closeModal, chains: [activeChain], connectLocale: locale, networkSelector: {
...
function Tabs({ selected, onSelect, options, children }) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime21.jsxs)("div", { children: [(0, import_jsx_runtime21.jsx)(Container, { flex: "row", center: "y", style: { width: "100%", borderRadius: radius.lg }, p: "xxs", bg: "secondaryButtonBg", children: options.map((option) => (0, import_jsx_runtime21.jsx)(Button, { variant: "accent", type: "button", onClick: () => onSelect(option.value), style: {
    flex: 1,
  ...
  }, children: (0, import_jsx_runtime21.jsx)(Text, { color: option.value === selected ? "primaryText" : "secondaryText", style: { textAlign: "center" }, size: "sm", children: option.label }) }, option.value)) }), (0, import_jsx_runtime21.jsx)(Spacer, { y: "sm" }), children] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/CoinsIcon.js
var import_jsx_runtime22 = __toESM(require_jsx_runtime(), 1);
var CoinsIcon = (props) => {
  return (0, import_jsx_runtime22.jsxs)("svg", { width: props.size, height: props.size, role: "presentation", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime22.jsx)("path", { d: "M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime22.jsx)("path", { d: "M18.0901 10.37C19.0354 10.7224 19.8766 11.3075 20.5358 12.0712C21.1951 12.8349 21.6512 13.7524 21.8618 14.7391C22.0725 15.7257 22.031 16.7495 21.7411 17.7158C21.4513 18.6822 20.9224 19.5598 20.2035 20.2676C19.4846 20.9754 18.5988 21.4905 17.6281 21.7652C16.6573 22.04 15.633 22.0655 14.6498 21.8395C13.6666 21.6134 12.7562 21.1431 12.0029 20.472C11.2496 19.8009 10.6777 18.9507 10.3401 18", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime22.jsx)("path", { d: "M7 6H8V10", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime22.jsx)("path", { d: "M16.7101 13.88L17.4101 14.59L14.5901 17.41", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/FundsIcon.js
var import_jsx_runtime23 = __toESM(require_jsx_runtime(), 1);
var FundsIcon = ({ size: size4 }) => {
  return (0, import_jsx_runtime23.jsxs)("svg", { width: size4, height: size4, viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: [(0, import_jsx_runtime23.jsx)("path", { d: "M14.001 8.00048C14.001 9.18726 13.649 10.3474 12.9897 11.3342C12.3304 12.3209 11.3932 13.09 10.2968 13.5442C9.20032 13.9984 7.99382 14.1172 6.82984 13.8857C5.66587 13.6541 4.59668 13.0826 3.7575 12.2435C2.91832 11.4043 2.34683 10.3351 2.1153 9.17111C1.88377 8.00713 2.0026 6.80064 2.45676 5.70419C2.91092 4.60775 3.68002 3.6706 4.66679 3.01126C5.65357 2.35192 6.8137 2 8.00048 2", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime23.jsx)("path", { d: "M14.0005 2L8 8.00048", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime23.jsx)("path", { d: "M10.3984 2H13.9987V5.60029", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function TokenIcon(props) {
  ...
  const tokenImage = (0, import_react20.useMemo)(() => {
  ...
  return (0, import_jsx_runtime24.jsx)(Img, { src: tokenImage || "", width: iconSize[props.size], height: iconSize[props.size], fallbackImage: genericTokenIcon, client: props.client });
}
...
function PayTokenIcon(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(TokenIcon, { token: isNativeToken(token) ? { nativeToken: true } : {
...
function BuyTxHistoryButton(props) {
  ...
  return (0, import_jsx_runtime26.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime26.jsxs)(Container, { flex: "row", center: "y", gap: "sm", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime26.jsx)(PayTokenIcon, { client: props.client, chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
    address: props.txInfo.status.quote.toToken.tokenAddress
  } }), (0, import_jsx_runtime26.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime26.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime26.jsxs)(Text, { size: "sm", color: "primaryText", children: ["Buy", " ", formatNumber(Number(props.txInfo.type === "swap" ? props.txInfo.status.quote.toAmount : props.txInfo.status.quote.estimatedToTokenAmount), 6), " ", props.txInfo.status.quote.toToken.symbol] }), " "] }), (0, import_jsx_runtime26.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime26.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime26.jsx)(ChainName, { chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime26.jsx)(Container, { flex: "row", gap: "xxs", center: "y", children: (0, import_jsx_runtime26.jsx)(Text, { size: "xs", color: statusMeta.color, children: statusMeta.status }) })] });
}
...
function TokenInfoRow(props) {
  const chainObj = (0, import_react21.useMemo)(() => getCachedChain(props.chainId), [props.chainId]);
  const { name } = useChainName(chainObj);
  return (0, import_jsx_runtime27.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime27.jsx)(Text, { size: "sm", children: props.label }), (0, import_jsx_runtime27.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime27.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime27.jsx)(PayTokenIcon, { chain: chainObj, size: "sm", token: {
    address: props.tokenAddress
  }, client: props.client }), (0, import_jsx_runtime27.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.tokenAmount), 6), " ", props.tokenSymbol] })] }), (0, import_jsx_runtime27.jsx)(Text, { size: "sm", children: name })] })] });
}
...
var CADIcon = (props) => {
  return (0, import_jsx_runtime28.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime28.jsx)("mask", { id: "a", children: (0, import_jsx_runtime28.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime28.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime28.jsx)("path", { fill: "#d80027", d: "M0 0v512h144l112-64 112 64h144V0H368L256 64 144 0Z" }), (0, import_jsx_runtime28.jsx)("path", { fill: "#eee", d: "M144 0h224v512H144Z" }), (0, import_jsx_runtime28.jsx)("path", { fill: "#d80027", d: "m301 289 44-22-22-11v-22l-45 22 23-44h-23l-22-34-22 33h-23l23 45-45-22v22l-22 11 45 22-12 23h45v33h22v-33h45z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/EURIcon.js
var import_jsx_runtime29 = __toESM(require_jsx_runtime(), 1);
var EURIcon = (props) => {
  return (0, import_jsx_runtime29.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime29.jsx)("mask", { id: "a", children: (0, import_jsx_runtime29.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime29.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime29.jsx)("path", { fill: "#0052b4", d: "M0 0h512v512H0z" }), (0, import_jsx_runtime29.jsx)("path", { fill: "#ffda44", d: "m256 100.2 8.3 25.5H291l-21.7 15.7 8.3 25.6-21.7-15.8-21.7 15.8 8.3-25.6-21.7-15.7h26.8zm-110.2 45.6 24 12.2 18.9-19-4.2 26.5 23.9 12.2-26.5 4.2-4.2 26.5-12.2-24-26.5 4.3 19-19zM100.2 256l25.5-8.3V221l15.7 21.7 25.6-8.3-15.8 21.7 15.8 21.7-25.6-8.3-15.7 21.7v-26.8zm45.6 110.2 12.2-24-19-18.9 26.5 4.2 12.2-23.9 4.2 26.5 26.5 4.2-24 12.2 4.3 26.5-19-19zM256 411.8l-8.3-25.5H221l21.7-15.7-8.3-25.6 21.7 15.8 21.7-15.8-8.3 25.6 21.7 15.7h-26.8zm110.2-45.6-24-12.2-18.9 19 4.2-26.5-23.9-12.2 26.5-4.2 4.2-26.5 12.2 24 26.5-4.3-19 19zM411.8 256l-25.5 8.3V291l-15.7-21.7-25.6 8.3 15.8-21.7-15.8-21.7 25.6 8.3 15.7-21.7v26.8zm-45.6-110.2-12.2 24 19 18.9-26.5-4.2-12.2 23.9-4.2-26.5-26.5-4.2 24-12.2-4.3-26.5 19 19z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/GBPIcon.js
var import_jsx_runtime30 = __toESM(require_jsx_runtime(), 1);
var GBPIcon = (props) => {
  return (0, import_jsx_runtime30.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", id: "Layer_1", x: "0px", y: "0px", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime30.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime30.jsxs)("g", { children: [(0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M52.92,100.142c-20.109,26.163-35.272,56.318-44.101,89.077h133.178L52.92,100.142z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M503.181,189.219c-8.829-32.758-23.993-62.913-44.101-89.076l-89.075,89.076H503.181z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M8.819,322.784c8.83,32.758,23.993,62.913,44.101,89.075l89.074-89.075L8.819,322.784L8.819,322.784   z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M411.858,52.921c-26.163-20.109-56.317-35.272-89.076-44.102v133.177L411.858,52.921z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M100.142,459.079c26.163,20.109,56.318,35.272,89.076,44.102V370.005L100.142,459.079z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M189.217,8.819c-32.758,8.83-62.913,23.993-89.075,44.101l89.075,89.075V8.819z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M322.783,503.181c32.758-8.83,62.913-23.993,89.075-44.101l-89.075-89.075V503.181z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#0052B4", d: "M370.005,322.784l89.075,89.076c20.108-26.162,35.272-56.318,44.101-89.076H370.005z" })] }), (0, import_jsx_runtime30.jsxs)("g", { children: [(0, import_jsx_runtime30.jsx)("path", { fill: "#D80027", d: "M509.833,222.609h-220.44h-0.001V2.167C278.461,0.744,267.317,0,256,0   c-11.319,0-22.461,0.744-33.391,2.167v220.44v0.001H2.167C0.744,233.539,0,244.683,0,256c0,11.319,0.744,22.461,2.167,33.391   h220.44h0.001v220.442C233.539,511.256,244.681,512,256,512c11.317,0,22.461-0.743,33.391-2.167v-220.44v-0.001h220.442   C511.256,278.461,512,267.319,512,256C512,244.683,511.256,233.539,509.833,222.609z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#D80027", d: "M322.783,322.784L322.783,322.784L437.019,437.02c5.254-5.252,10.266-10.743,15.048-16.435   l-97.802-97.802h-31.482V322.784z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#D80027", d: "M189.217,322.784h-0.002L74.98,437.019c5.252,5.254,10.743,10.266,16.435,15.048l97.802-97.804   V322.784z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#D80027", d: "M189.217,189.219v-0.002L74.981,74.98c-5.254,5.252-10.266,10.743-15.048,16.435l97.803,97.803   H189.217z" }), (0, import_jsx_runtime30.jsx)("path", { fill: "#D80027", d: "M322.783,189.219L322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.047   l-97.802,97.803V189.219z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/USDIcon.js
var import_jsx_runtime31 = __toESM(require_jsx_runtime(), 1);
var USDIcon = (props) => {
  return (0, import_jsx_runtime31.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: props.size, height: props.size, x: "0px", y: "0px", viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime31.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime31.jsxs)("g", { children: [(0, import_jsx_runtime31.jsx)("path", { fill: "#D80027", d: "M244.87,256H512c0-23.106-3.08-45.49-8.819-66.783H244.87V256z" }), (0, import_jsx_runtime31.jsx)("path", { fill: "#D80027", d: "M244.87,122.435h229.556c-15.671-25.572-35.708-48.175-59.07-66.783H244.87V122.435z" }), (0, import_jsx_runtime31.jsx)("path", { fill: "#D80027", d: "M256,512c60.249,0,115.626-20.824,159.356-55.652H96.644C140.374,491.176,195.751,512,256,512z" }), (0, import_jsx_runtime31.jsx)("path", { fill: "#D80027", d: "M37.574,389.565h436.852c12.581-20.529,22.338-42.969,28.755-66.783H8.819   C15.236,346.596,24.993,369.036,37.574,389.565z" })] }), (0, import_jsx_runtime31.jsx)("path", { fill: "#0052B4", d: "M118.584,39.978h23.329l-21.7,15.765l8.289,25.509l-21.699-15.765L85.104,81.252l7.16-22.037  C73.158,75.13,56.412,93.776,42.612,114.552h7.475l-13.813,10.035c-2.152,3.59-4.216,7.237-6.194,10.938l6.596,20.301l-12.306-8.941  c-3.059,6.481-5.857,13.108-8.372,19.873l7.267,22.368h26.822l-21.7,15.765l8.289,25.509l-21.699-15.765l-12.998,9.444  C0.678,234.537,0,245.189,0,256h256c0-141.384,0-158.052,0-256C205.428,0,158.285,14.67,118.584,39.978z M128.502,230.4  l-21.699-15.765L85.104,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822l-21.7,15.765L128.502,230.4z   M120.213,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  L120.213,130.317z M220.328,230.4l-21.699-15.765L176.93,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  l-21.7,15.765L220.328,230.4z M212.039,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822  l8.288-25.509l8.288,25.509h26.822L212.039,130.317z M212.039,55.743l8.289,25.509l-21.699-15.765L176.93,81.252l8.289-25.509  l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822L212.039,55.743z" })] });
};
...
var UnknownCurrencyIcon = (props) => {
  return (0, import_jsx_runtime32.jsx)(RadiobuttonIcon, { width: props.size, height: props.size });
};
...
function OnRampTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [(0, import_jsx_runtime33.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime33.jsx)(Line, {}), (0, import_jsx_runtime33.jsx)(Spacer, { y: "md" })] });
  return (0, import_jsx_runtime33.jsxs)("div", { children: [(0, import_jsx_runtime33.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime33.jsx)(Text, { children: "Pay" }), (0, import_jsx_runtime33.jsx)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: (0, import_jsx_runtime33.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime33.jsx)(currencyMeta.icon, { size: iconSize.sm }), (0, import_jsx_runtime33.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.fiat.amount), 2), " ", props.fiat.currencySymbol] })] }) })] }), lineSpacer, (0, import_jsx_runtime33.jsx)(TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), props.statusMeta && (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [lineSpacer, (0, import_jsx_runtime33.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime33.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime33.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime33.jsx)(Text, { color: props.statusMeta.color, children: props.statusMeta.text }) })] })] }), lineSpacer, onrampTxHash && ((_c = (_b = onRampExplorers.explorers) == null ? void 0 : _b[0]) == null ? void 0 : _c.url) && (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [(0, import_jsx_runtime33.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime33.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${onRampExplorers.explorers[0].url || ""}/tx/${onrampTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm
  }, children: ["View on Explorer", (0, import_jsx_runtime33.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function StepIcon(props) {
  return (0, import_jsx_runtime34.jsx)(Container, { flex: "row", center: "both", color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: (0, import_jsx_runtime34.jsx)(Circle, { children: props.isDone ? (0, import_jsx_runtime34.jsx)(CheckIcon, { width: iconSize.sm, height: iconSize.sm }) : (0, import_jsx_runtime34.jsx)(PulsingDot, { "data-active": props.isActive }) }) });
}
function Step(props) {
  return (0, import_jsx_runtime34.jsxs)(Container, { flex: "row", center: "y", gap: "xs", style: {
    fontSize: fontSize.sm
  }, color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: [(0, import_jsx_runtime34.jsx)(StepIcon, { isDone: props.isDone, isActive: props.isActive }), props.label] });
}
...
function FiatSteps(props) {
  ...
  const toChain = (0, import_react23.useMemo)(() => getCachedChain(toTokenMeta.chainId), [toTokenMeta.chainId]);
  const destinationChain = (0, import_react23.useMemo)(() => {
    var _a2, _b2, _c2;
  ...
  const toToken = (0, import_react23.useMemo)(() => {
  ...
  const onRampChain = (0, import_react23.useMemo)(() => getCachedChain(onRampTokenMeta.chainId), [onRampTokenMeta.chainId]);
  const onRampToken = (0, import_react23.useMemo)(() => {
  ...
  const onRampTokenInfo = (0, import_jsx_runtime35.jsx)("div", { children: (0, import_jsx_runtime35.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(onRampTokenAmount), 6), " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) });
  const fiatIcon = (0, import_jsx_runtime35.jsx)(currency.icon, { size: iconSize.sm });
  const onRampTokenIcon = (0, import_jsx_runtime35.jsx)(PayTokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client });
  const toTokenIcon = (0, import_jsx_runtime35.jsx)(PayTokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client });
  const onRampChainInfo = (0, import_jsx_runtime35.jsx)(Text, { size: "xs", children: onRampName.name });
  const partialSuccessToTokenInfo = ((_a = props.status) == null ? void 0 : _a.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination ? (0, import_jsx_runtime35.jsxs)("div", { children: [(0, import_jsx_runtime35.jsxs)(Text, { color: "secondaryText", size: "sm", inline: true, style: {
    textDecoration: "line-through"
  }, children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", (0, import_jsx_runtime35.jsxs)(Text, { color: "danger", size: "sm", inline: true, children: [formatNumber(Number(props.status.destination.amount), 6), " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: {
  ...
  const toTokenInfo = partialSuccessToTokenInfo || (0, import_jsx_runtime35.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] });
  const partialSuccessToChainInfo = ((_b = props.status) == null ? void 0 : _b.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination && props.status.destination.token.chainId !== props.status.quote.toToken.chainId ? (0, import_jsx_runtime35.jsxs)("div", { children: [(0, import_jsx_runtime35.jsx)(Text, { size: "xs", inline: true, style: {
    textDecoration: "line-through"
  }, children: toChainName.name }), " ", (0, import_jsx_runtime35.jsx)(Text, { size: "xs", inline: true, children: destinationName.name })] }) : null;
  const toTokehChainInfo = partialSuccessToChainInfo || (0, import_jsx_runtime35.jsx)(Text, { size: "xs", children: toChainName.name });
  ...
  return (0, import_jsx_runtime35.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime35.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime35.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime35.jsx)(PaymentStep, { title: (0, import_jsx_runtime35.jsxs)(Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
    icon: fiatIcon,
    primaryText: (0, import_jsx_runtime35.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(fromCurrencyAmount), 6), " ", fromCurrencySymbol] })
  }, to: {
  ...
  } : void 0 }), (0, import_jsx_runtime35.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime35.jsx)(PaymentStep, { title: (0, import_jsx_runtime35.jsxs)(Text, { color: "primaryText", size: "md", children: ["Convert", " ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "to ", (0, import_jsx_runtime35.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "md", inline: true })] }), step: 2, from: {
    icon: onRampTokenIcon,
    primaryText: onRampTokenInfo,
    secondaryText: onRampChainInfo
  }, to: {
  ...
  } : void 0 }), isPartialSuccess && props.status && props.status.status !== "NOT_FOUND" && props.status.source && props.status.destination && (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [(0, import_jsx_runtime35.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime35.jsxs)(Text, { color: "danger", size: "sm", center: true, children: ["Expected ", (_l = props.status.source) == null ? void 0 : _l.token.symbol, ", Got", " ", (_m = props.status.destination) == null ? void 0 : _m.token.symbol, " instead"] }), (0, import_jsx_runtime35.jsx)(Spacer, { y: "sm" })] }), showContinueBtn && (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [(0, import_jsx_runtime35.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime35.jsx)(Button, { variant: "accent", onClick: props.onContinue, fullWidth: true, children: "Continue" })] })] });
}
function PaymentStep(props) {
  return (0, import_jsx_runtime35.jsxs)(StepContainer, { state: props.state, children: [(0, import_jsx_runtime35.jsxs)(Text, { size: "sm", children: ["Step ", props.step] }), (0, import_jsx_runtime35.jsx)(Spacer, { y: "sm" }), props.title, (0, import_jsx_runtime35.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime35.jsx)(Line, {}), (0, import_jsx_runtime35.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime35.jsx)(PaymentSubStep, { ...props.from }), (0, import_jsx_runtime35.jsxs)(Container, { color: "borderColor", style: {
    paddingLeft: "18px",
    position: "relative",
    marginBlock: "3px"
  }, children: [(0, import_jsx_runtime35.jsx)("div", { style: {
    height: "18px",
    width: "2px",
    backgroundColor: "currentColor",
    transform: "translateX(-50%)"
  } }), (0, import_jsx_runtime35.jsx)(TriangleDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    position: "absolute",
    bottom: "0",
    transform: "translate(-50%, 50%)"
  } })] }), (0, import_jsx_runtime35.jsx)(PaymentSubStep, { ...props.to }), props.explorer && (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [(0, import_jsx_runtime35.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime35.jsxs)(ButtonLink, { variant: "outline", fullWidth: true, href: props.explorer.url, style: {
    fontSize: fontSize.xs,
    padding: spacing.xs
  }, gap: "xxs", target: "_blank", children: [props.explorer.label, " ", (0, import_jsx_runtime35.jsx)(ExternalLinkIcon, { width: iconSize.xs, height: iconSize.xs })] })] })] });
}
function PaymentSubStep(props) {
  return (0, import_jsx_runtime35.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime35.jsx)(Container, { p: "xs", borderColor: "borderColor", flex: "row", center: "both", style: {
    borderStyle: "solid",
    borderWidth: "1.5px",
    borderRadius: radius.lg
  }, children: props.icon }), (0, import_jsx_runtime35.jsxs)(Container, { flex: "column", gap: "xxs", children: [props.primaryText, props.secondaryText] })] });
}
function StepContainer(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(Container, { bg: "tertiaryBg", borderColor: color === "success" ? "borderColor" : color, py: "sm", px: "md", style: {
    borderRadius: radius.lg,
    alignItems: "flex-start",
    borderWidth: "1px",
    borderStyle: "solid",
    position: "relative"
  }, children: [props.children, (0, import_jsx_runtime35.jsxs)("div", { style: {
    position: "absolute",
    right: spacing.sm,
    top: spacing.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center"
  }, children: [props.state && text && (0, import_jsx_runtime35.jsx)(Text, { size: "sm", color, children: text }), (props.state === "actionRequired" || props.state === "completed") && (0, import_jsx_runtime35.jsx)(StepIcon, { isActive: props.state === "actionRequired", isDone: props.state === "completed" }), props.state === "pending" && (0, import_jsx_runtime35.jsx)(Spinner, { color: "accentText", size: "sm" }), props.state === "failed" && (0, import_jsx_runtime35.jsx)(Container, { color: "danger", flex: "row", center: "both", children: (0, import_jsx_runtime35.jsx)(Cross1Icon, { width: iconSize.sm, height: iconSize.sm }) })] })] });
}
...
function StepBar(props) {
  return (0, import_jsx_runtime36.jsx)(Container, { bg: "tertiaryBg", flex: "row", style: {
    height: "8px",
    borderRadius: radius.lg
  }, children: (0, import_jsx_runtime36.jsx)(Container, { bg: "accentText", style: {
...
function SwapFees(props) {
  return (0, import_jsx_runtime37.jsx)(Container, { flex: "column", gap: "xs", style: {
    ...
    return (0, import_jsx_runtime37.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime37.jsxs)(Text, { color: "primaryText", size: "sm", style: { textAlign: "right" }, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime37.jsxs)(Text, { color: "secondaryText", size: "xs", style: { textAlign: "right" }, children: ["$", (fee.amountUSDCents / 100).toFixed(2)] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
function FiatFees(props) {
  return (0, import_jsx_runtime37.jsxs)(Container, { flex: "column", gap: "xs", children: [(0, import_jsx_runtime37.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime37.jsx)(Text, { inline: true, color: "secondaryText", children: "Amount" }), (0, import_jsx_runtime37.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrency.amount), 2), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime37.jsxs)("div", { style: {
      display: "flex",
      justifyContent: "space-between"
    }, children: [(0, import_jsx_runtime37.jsx)(Text, { inline: true, color: "secondaryText", children: fee.feeType === "NETWORK" ? "Network Fee" : "Processing Fee" }), (0, import_jsx_runtime37.jsxs)(Text, { color: "primaryText", inline: true, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.currencySymbol, " "] })] }, i);
  }), (0, import_jsx_runtime37.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime37.jsx)(Line, {}), (0, import_jsx_runtime37.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime37.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime37.jsx)(Text, { inline: true, color: "secondaryText", children: "Total" }), (0, import_jsx_runtime37.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrencyWithFees.amount), 6), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] });
}
...
function SwapConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react24.useState)(initialStep);
  ...
  return (0, import_jsx_runtime38.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime38.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.isFiatFlow ? (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime38.jsx)(StepBar, { steps: 2, currentStep: 2 }), (0, import_jsx_runtime38.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime38.jsxs)(Text, { size: "xs", children: ["Step 2 of 2 - Converting ", props.fromTokenSymbol, " to", " ", props.toTokenSymbol] }), (0, import_jsx_runtime38.jsx)(Spacer, { y: "md" })] }) : (0, import_jsx_runtime38.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime38.jsx)(ConfirmItem, { label: "Pay", children: (0, import_jsx_runtime38.jsx)(RenderTokenInfo, { chain: props.fromChain, amount: String(formatNumber(Number(props.fromAmount), 6)), symbol: props.fromTokenSymbol || "", token: props.fromToken, client: props.client }) }), !isDifferentRecipient && (0, import_jsx_runtime38.jsx)(ConfirmItem, { label: "Receive", children: (0, import_jsx_runtime38.jsx)(RenderTokenInfo, { chain: props.toChain, amount: String(formatNumber(Number(props.toAmount), 6)), symbol: props.toTokenSymbol, token: props.toToken, client: props.client }) }), (0, import_jsx_runtime38.jsx)(ConfirmItem, { label: "Fees", children: (0, import_jsx_runtime38.jsx)(SwapFees, { quote: props.quote, align: "right" }) }), (0, import_jsx_runtime38.jsx)(ConfirmItem, { label: "Time", children: (0, import_jsx_runtime38.jsxs)(Text, { size: "sm", color: "primaryText", children: ["~", formatSeconds(props.quote.swapDetails.estimated.durationSeconds || 0)] }) }), isDifferentRecipient && (0, import_jsx_runtime38.jsx)(ConfirmItem, { label: "Seller", children: (0, import_jsx_runtime38.jsx)(Text, { color: "primaryText", size: "sm", children: ensName.data || shortenAddress(receiver) }) }), (0, import_jsx_runtime38.jsx)(Spacer, { y: "xl" }), isApprovalRequired && (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime38.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime38.jsx)(Step, { isDone: step === "swap", isActive: step === "approval", label: step === "approval" ? "Approve" : "Approved" }), (0, import_jsx_runtime38.jsx)(ConnectorLine, {}), (0, import_jsx_runtime38.jsx)(Step, { isDone: false, label: "Confirm", isActive: step === "swap" })] }), (0, import_jsx_runtime38.jsx)(Spacer, { y: "lg" })] }), status === "error" && (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, import_jsx_runtime38.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime38.jsx)(Text, { color: "danger", size: "sm", children: step === "approval" ? "Failed to Approve" : "Failed to Confirm" })] }), (0, import_jsx_runtime38.jsx)(Spacer, { y: "md" })] }), props.payer.chain.id !== props.fromChain.id ? (0, import_jsx_runtime38.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(props.fromChain);
  } }) : (0, import_jsx_runtime38.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
  ...
  }, gap: "xs", children: [step === "approval" && (status === "pending" ? "Approving" : "Approve"), step === "swap" && (status === "pending" ? "Confirming" : "Confirm"), status === "pending" && (0, import_jsx_runtime38.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}
...
function RenderTokenInfo(props) {
  const { name } = useChainName(props.chain);
  return (0, import_jsx_runtime38.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime38.jsxs)(Container, { flex: "row", center: "y", gap: "xs", children: [(0, import_jsx_runtime38.jsxs)(Text, { color: "primaryText", size: "sm", children: [props.amount, " ", props.symbol] }), (0, import_jsx_runtime38.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "xs", client: props.client })] }), name ? (0, import_jsx_runtime38.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime38.jsx)(Skeleton, { width: "100px", height: fontSize.xs })] });
}
function ConfirmItem(props) {
  return (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsxs)(Container, { flex: "row", gap: "md", py: "md", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime38.jsx)(Text, { size: "sm", color: "secondaryText", children: props.label }), props.children] }), (0, import_jsx_runtime38.jsx)(Line, {})] });
}
...
function SwapDetailsScreen(props) {
  ...
  return (0, import_jsx_runtime39.jsxs)(Container, { children: [(0, import_jsx_runtime39.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime39.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime39.jsx)(Line, {}), (0, import_jsx_runtime39.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime39.jsx)(SwapTxDetailsTable, { type: "status", status, client }) })] });
}
function SwapTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [(0, import_jsx_runtime39.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime39.jsx)(Line, {}), (0, import_jsx_runtime39.jsx)(Spacer, { y: "md" })] });
  return (0, import_jsx_runtime39.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
    // Expected + Got
    (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [(0, import_jsx_runtime39.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: isPartialSuccess ? "Expected" : "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address }), lineSpacer, (0, import_jsx_runtime39.jsx)(TokenInfoRow, { chainId: gotToken.chainId, client, label: "Got", tokenAmount: gotToken.amount, tokenSymbol: gotToken.symbol || "", tokenAddress: gotToken.address })] })
  ) : (
    // Receive
    (0, import_jsx_runtime39.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: "Receive", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })
  ), lineSpacer, (0, import_jsx_runtime39.jsx)(TokenInfoRow, { chainId: fromToken.chainId, client, label: "Pay", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime39.jsx)(Text, { children: " Time " }), (0, import_jsx_runtime39.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime39.jsxs)(Text, { color: "primaryText", children: ["~", formatSeconds(estimatedDuration || 0)] }) })] }), statusMeta && showStatusRow && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [lineSpacer, (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime39.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime39.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime39.jsx)(Text, { color: statusMeta.color, children: statusMeta.status }) })] })] }), uiData.fromAddress.toLowerCase() !== uiData.toAddress.toLowerCase() && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [lineSpacer, (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime39.jsx)(Text, { children: "Send to" }), (0, import_jsx_runtime39.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime39.jsx)(Text, { color: "primaryText", size: "sm", children: shortenAddress(uiData.toAddress) }) })] })] }), lineSpacer, ((_d = (_c = fromChainExplorers.explorers) == null ? void 0 : _c[0]) == null ? void 0 : _d.url) && sourceTxHash && (0, import_jsx_runtime39.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime39.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }), destinationTxHash && sourceTxHash !== destinationTxHash && ((_f = (_e = toChainExplorers == null ? void 0 : toChainExplorers.explorers) == null ? void 0 : _e[0]) == null ? void 0 : _f.url) && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [(0, import_jsx_runtime39.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime39.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainExplorers.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", toChainName.name, " Explorer", (0, import_jsx_runtime39.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function SwapStatusScreen(props) {
  ...
  const queryClient = useQueryClient();
  const balanceInvalidated = (0, import_react25.useRef)(false);
  ...
  const swapDetails = swapStatus.data && swapStatus.data.status !== "NOT_FOUND" ? (0, import_jsx_runtime40.jsx)(SwapTxDetailsTable, { status: swapStatus.data, type: "status", hideStatusRow: true, client: props.client }) : (0, import_jsx_runtime40.jsx)(SwapTxDetailsTable, { type: "quote", quote: props.quote, client: props.client });
  return (0, import_jsx_runtime40.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime40.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime40.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), uiStatus === "success" && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime40.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime40.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Complete" })] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), swapDetails, (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), !props.isEmbed && (0, import_jsx_runtime40.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] }), uiStatus === "partialSuccess" && ((_e = swapStatus.data) == null ? void 0 : _e.status) !== "NOT_FOUND" && ((_f = swapStatus.data) == null ? void 0 : _f.destination) && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime40.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime40.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime40.jsx)(Text, { color: "primaryText", size: "lg", children: "Incomplete" }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime40.jsxs)(Text, { size: "sm", color: "danger", children: ["Expected ", swapStatus.data.quote.toToken.symbol, ", Got", " ", swapStatus.data.destination.token.symbol, " instead"] })] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), swapDetails] }), uiStatus === "failed" && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime40.jsxs)(Container, { flex: "column", children: [(0, import_jsx_runtime40.jsxs)(Container, { flex: "column", center: "both", children: [(0, import_jsx_runtime40.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime40.jsx)(Text, { color: "primaryText", size: "lg", children: "Transaction Failed" }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime40.jsxs)(Text, { size: "sm", children: ["Your transaction ", `couldn't`, " be processed"] })] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onTryAgain, children: "Try Again" }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), swapDetails] })] }), uiStatus === "pending" && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime40.jsxs)(Container, { flex: "column", animate: "fadein", center: "both", children: [(0, import_jsx_runtime40.jsx)("div", { style: {
    position: "relative",
    display: "flex",
    alignItems: "center",
    justifyContent: "center"
  }, children: (0, import_jsx_runtime40.jsx)(Spinner, { size: "3xl", color: "accentText" }) }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime40.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Pending" })] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "xxl" }), swapDetails] })] }) });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/SwapFlow.js
function SwapFlow(props) {
  const [swapTxHash, setSwapTxHash] = (0, import_react26.useState)();
  const quote = props.buyWithCryptoQuote;
  const fromChain = (0, import_react26.useMemo)(() => getCachedChain(quote.swapDetails.fromToken.chainId), [quote]);
  const toChain = (0, import_react26.useMemo)(() => getCachedChain(quote.swapDetails.toToken.chainId), [quote]);
  ...
  const toToken = (0, import_react26.useMemo)(() => {
  ...
  const fromToken = (0, import_react26.useMemo)(() => {
  ...
  if (swapTxHash) {
    return (0, import_jsx_runtime41.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote });
  }
  return (0, import_jsx_runtime41.jsx)(SwapConfirmationScreen, { title: props.title, setSwapTxHash, toChain, toAmount, toTokenSymbol, fromChain, toToken, fromAmount, fromToken, fromTokenSymbol, client: props.client, onBack: props.onBack, onTryAgain: props.onTryAgain, quote, isFiatFlow: props.isFiatFlow, payer: props.payer });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/PostOnRampSwap.js
function PostOnRampSwap(props) {
  const [lockedOnRampQuote, setLockedOnRampQuote] = (0, import_react27.useState)(void 0);
  ...
  if (postOnRampQuoteQuery.isError) {
    return (0, import_jsx_runtime42.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime42.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime42.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime42.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", p: "lg", children: [(0, import_jsx_runtime42.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime42.jsx)(Text, { color: "primaryText", children: "Failed to get a price quote" }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime42.jsx)(Button, { fullWidth: true, variant: "primary", onClick: () => {
      postOnRampQuoteQuery.refetch();
    }, children: "Try Again" })] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xxl" })] });
  }
  if (!lockedOnRampQuote) {
    return (0, import_jsx_runtime42.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime42.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime42.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime42.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", children: [(0, import_jsx_runtime42.jsx)(Spinner, { size: "xxl", color: "accentText" }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime42.jsx)(Text, { color: "primaryText", children: "Getting price quote" })] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xxl" })] });
  }
  return (0, import_jsx_runtime42.jsx)(SwapFlow, { title: props.title, payer: props.payer, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
...
function PostOnRampSwapFlow(props) {
  const [statusForSwap, setStatusForSwap] = (0, import_react28.useState)();
  if (statusForSwap) {
    return (0, import_jsx_runtime43.jsx)(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer });
  }
  return (0, import_jsx_runtime43.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
...
function FiatDetailsScreen(props) {
  ...
  const [stopPolling, setStopPolling] = (0, import_react29.useState)(false);
  ...
  if (hasTwoSteps) {
    ...
    return (0, import_jsx_runtime44.jsx)(PostOnRampSwapFlow, { title: props.title, client: props.client, status, onBack: props.onBack, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote: {
  ...
  return (0, import_jsx_runtime44.jsxs)(Container, { children: [(0, import_jsx_runtime44.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime44.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime44.jsx)(Line, {}), (0, import_jsx_runtime44.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime44.jsx)(OnRampTxDetailsTable, { client: props.client, token: status.source ? {
...
function TxDetailsScreen(props) {
  ...
  if (statusInfo.type === "swap") {
    return (0, import_jsx_runtime45.jsx)(SwapDetailsScreen, { client: props.client, status: statusInfo.status, onBack: props.onBack });
  }
  if (statusInfo.type === "fiat") {
    return (0, import_jsx_runtime45.jsx)(FiatDetailsScreen, { title: props.title, client: props.client, status: statusInfo.status, onBack: props.onBack, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer });
  }
  return null;
}
...
function useBuyTransactionsToShow(client) {
  ...
  const [pageIndex, setPageIndex] = (0, import_react30.useState)(0);
  const txStatusList = [];
  const PAGE_SIZE = 10;
  ...
  const pendingTxStoreValue = (0, import_react30.useSyncExternalStore)(pendingTransactions.subscribe, pendingTransactions.getValue);
...
function PayTxHistoryList(props) {
  ...
  return (0, import_jsx_runtime46.jsxs)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    width: "100%",
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime46.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [noTransactions && !isLoading && (0, import_jsx_runtime46.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime46.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime46.jsx)(Text, { children: "No Transactions" })] }), noTransactions && isLoading && (0, import_jsx_runtime46.jsx)(Container, { flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime46.jsx)(Spinner, { size: "xl", color: "accentText" }) }), txInfosToShow.length > 0 && (0, import_jsx_runtime46.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
    var _a;
    return (0, import_jsx_runtime46.jsx)(BuyTxHistoryButton, { txInfo, client: props.client, onClick: () => {
      props.onSelectTx(txInfo);
    } }, txInfo.type === "swap" ? (_a = txInfo.status.source) == null ? void 0 : _a.transactionHash : txInfo.status.intentId);
  }) }), isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime46.jsxs)(import_jsx_runtime46.Fragment, { children: [(0, import_jsx_runtime46.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime46.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime46.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] })] }), pagination && !hidePagination && (0, import_jsx_runtime46.jsx)(Container, { py: "md", children: (0, import_jsx_runtime46.jsxs)("div", { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: spacing.sm
  }, children: [(0, import_jsx_runtime46.jsxs)(Button, { variant: "outline", gap: "xs", disabled: pageIndex === 0, "data-disabled": pageIndex === 0, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev - 1);
  }, children: [(0, import_jsx_runtime46.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "rotate(180deg)"
  } }), "Prev"] }), (0, import_jsx_runtime46.jsxs)(Button, { variant: "outline", gap: "xs", disabled: !pagination.hasNextPage, "data-disabled": !pagination.hasNextPage, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev + 1);
  }, children: ["Next", (0, import_jsx_runtime46.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] }) })] });
}
...
function WalletTransactionHistory(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: (0, import_jsx_runtime47.jsx)(Container, { flex: "column", gap: "xs", expand: true, children: transactions.length === 0 ? (0, import_jsx_runtime47.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime47.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime47.jsx)(Text, { children: "No Transactions" })] }) : (0, import_jsx_runtime47.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", style: { minHeight: "250px" }, children: transactions.map((tx) => {
    var _a;
    return (0, import_jsx_runtime47.jsx)(TransactionButton, { explorerUrl: (_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url, client: props.client, hash: tx.transactionHash, chainId: tx.chainId }, tx.transactionHash);
  }) }) }) });
}
function TransactionButton(props) {
  ...
  const content = (0, import_jsx_runtime47.jsxs)(TxButton2, { variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime47.jsxs)(Container, { flex: "row", center: "y", gap: "md", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime47.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), (0, import_jsx_runtime47.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime47.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime47.jsx)(Text, { size: "sm", color: "primaryText", children: (receipt == null ? void 0 : receipt.to) ? `Interacted with ${shortenHex(receipt.to, 4)}` : `Hash: ${shortenHex(props.hash, 4)}` }) }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime47.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime47.jsx)(ChainName, { chain: getCachedChain(props.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime47.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [isLoading && (0, import_jsx_runtime47.jsx)(Spinner, { size: "sm", color: "primaryText" }), !isLoading && receipt && receipt.status === "success" && (0, import_jsx_runtime47.jsx)(Text, { size: "md", color: "success", children: (0, import_jsx_runtime47.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }), (error || !isLoading && receipt && receipt.status !== "success") && (0, import_jsx_runtime47.jsx)(Text, { size: "md", color: "danger", children: (0, import_jsx_runtime47.jsx)(CrossCircledIcon, { width: iconSize.md, height: iconSize.md }) })] })] });
  if (props.explorerUrl) {
    return (0, import_jsx_runtime47.jsx)("a", { href: `${props.explorerUrl}/tx/${props.hash}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function TransactionsScreen(props) {
  ...
  if (selectedTx) {
    return (0, import_jsx_runtime48.jsx)(TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: () => setSelectedTx(null), payer, transactionMode: false, isEmbed: false });
  }
  return (0, import_jsx_runtime48.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime48.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime48.jsx)(ModalHeader, { title: props.locale.transactions, onBack: props.onBack }) }), (0, import_jsx_runtime48.jsx)(Line, {}), (0, import_jsx_runtime48.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime48.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime48.jsxs)(Tabs, { options: [
    {
      label: (0, import_jsx_runtime48.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime48.jsx)(CoinsIcon, { size: iconSize.sm }), " Transactions"] }),
      value: "Transactions"
    },
    {
      label: (0, import_jsx_runtime48.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime48.jsx)(FundsIcon, { size: iconSize.sm }), " Purchases"] }),
      value: "Purchases"
    }
  ], selected: activeTab, onSelect: setActiveTab, children: [activeTab === "Purchases" && (0, import_jsx_runtime48.jsx)(PayTxHistoryList, { client: props.client, onSelectTx: setSelectedTx }), activeTab === "Transactions" && (0, import_jsx_runtime48.jsx)(WalletTransactionHistory, { locale: props.locale, client: props.client, address: payer.account.address })] })] }), (0, import_jsx_runtime48.jsx)(Line, {}), (0, import_jsx_runtime48.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime48.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${(_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url}/address/${activeAccount == null ? void 0 : activeAccount.address}`, target: "_blank", as: "a", gap: "xs", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: ["View on Explorer", " ", (0, import_jsx_runtime48.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }) })] });
}
...
var GenericWalletIcon = (props) => {
  return (0, import_jsx_runtime49.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 18 18", width: props.size, height: props.size, role: "presentation", children: (0, import_jsx_runtime49.jsx)("path", { fill: "currentColor", d: "M15.6 4.6H1.85v-.55l12.1-.968v.968h1.65V2.4c0-1.21-.98-2.059-2.177-1.888L2.378 2.089C1.18 2.26.2 3.39.2 4.6v11a2.2 2.2 0 002.2 2.2h13.2a2.2 2.2 0 002.2-2.2V6.8a2.2 2.2 0 00-2.2-2.2zm-1.65 7.707a1.65 1.65 0 01-.63-3.176 1.65 1.65 0 11.63 3.176z" }) });
};
...
var OutlineWalletIcon = (props) => {
  return (0, import_jsx_runtime50.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", role: "presentation", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime50.jsx)("path", { d: "M19 7V4C19 3.73478 18.8946 3.48043 18.7071 3.29289C18.5196 3.10536 18.2652 3 18 3H5C4.46957 3 3.96086 3.21071 3.58579 3.58579C3.21071 3.96086 3 4.46957 3 5C3 5.53043 3.21071 6.03914 3.58579 6.41421C3.96086 6.78929 4.46957 7 5 7H20C20.2652 7 20.5196 7.10536 20.7071 7.29289C20.8946 7.48043 21 7.73478 21 8V12M21 12H18C17.4696 12 16.9609 12.2107 16.5858 12.5858C16.2107 12.9609 16 13.4696 16 14C16 14.5304 16.2107 15.0391 16.5858 15.4142C16.9609 15.7893 17.4696 16 18 16H21C21.2652 16 21.5196 15.8946 21.7071 15.7071C21.8946 15.5196 22 15.2652 22 15V13C22 12.7348 21.8946 12.4804 21.7071 12.2929C21.5196 12.1054 21.2652 12 21 12Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime50.jsx)("path", { d: "M3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H20C20.2652 21 20.5196 20.8946 20.7071 20.7071C20.8946 20.5196 21 20.2652 21 20V16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/ShuffleIconLucide.js
var import_jsx_runtime51 = __toESM(require_jsx_runtime(), 1);
var ShuffleIconLucide = (props) => {
  return (0, import_jsx_runtime51.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", role: "presentation", children: [(0, import_jsx_runtime51.jsx)("path", { d: "M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.1-8.6c.7-1.1 2-1.7 3.3-1.7H22" }), (0, import_jsx_runtime51.jsx)("path", { d: "m18 2 4 4-4 4" }), (0, import_jsx_runtime51.jsx)("path", { d: "M2 6h1.9c1.5 0 2.9.9 3.6 2.2" }), (0, import_jsx_runtime51.jsx)("path", { d: "M22 18h-5.9c-1.3 0-2.6-.7-3.3-1.8l-.5-.8" }), (0, import_jsx_runtime51.jsx)("path", { d: "m18 14 4 4-4 4" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/SmartAccountBadgeIcon.js
var import_jsx_runtime52 = __toESM(require_jsx_runtime(), 1);
var SmartWalletBadgeIcon = (props) => {
  return (0, import_jsx_runtime52.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 12 12", width: props.size, height: props.size, role: "presentation", children: [(0, import_jsx_runtime52.jsxs)("g", { clipPath: "url(#clip0_5539_26604)", children: [(0, import_jsx_runtime52.jsx)("path", { d: "M10 6.85691C10 9.35691 8.25 10.6069 6.17 11.3319C6.06108 11.3688 5.94277 11.3671 5.835 11.3269C3.75 10.6069 2 9.35691 2 6.85691V3.35691C2 3.22431 2.05268 3.09713 2.14645 3.00336C2.24021 2.90959 2.36739 2.85691 2.5 2.85691C3.5 2.85691 4.75 2.25691 5.62 1.49691C5.72593 1.40641 5.86068 1.35669 6 1.35669C6.13932 1.35669 6.27407 1.40641 6.38 1.49691C7.255 2.26191 8.5 2.85691 9.5 2.85691C9.63261 2.85691 9.75979 2.90959 9.85355 3.00336C9.94732 3.09713 10 3.22431 10 3.35691V6.85691Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime52.jsx)("path", { d: "M4.5 6.35693L5.5 7.35693L7.5 5.35693", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })] }), (0, import_jsx_runtime52.jsx)("defs", { children: (0, import_jsx_runtime52.jsx)("clipPath", { id: "clip0_5539_26604", children: (0, import_jsx_runtime52.jsx)("rect", { width: "12", height: "12", fill: "white", transform: "translate(0 0.356934)" }) }) })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/LazyBuyScreen.js
var import_jsx_runtime53 = __toESM(require_jsx_runtime(), 1);
var import_react34 = __toESM(require_react(), 1);
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-PHSS7QMB.js"));
function LazyBuyScreen(props) {
  return (0, import_jsx_runtime53.jsx)(import_react34.Suspense, { fallback: (0, import_jsx_runtime53.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime53.jsx)(BuyScreen, { ...props }) });
}
...
function useConnectedWallets() {
  ...
  return (0, import_react35.useSyncExternalStore)(store.subscribe, store.getValue, store.getValue);
}
...
async function getSmartWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-TANCC7QG.js")).default;
    case "ja_JP":
      return (await import("./ja-DY6WVRC7.js")).default;
    case "tl_PH":
      return (await import("./tl-FAWNE5I4.js")).default;
    case "vi_VN":
      return (await import("./vi-AJ6BAQTT.js")).default;
    case "de_DE":
      return (await import("./de-EEBZFS7U.js")).default;
    case "ko_KR":
      return (await import("./kr-TGUZFDSY.js")).default;
    case "fr_FR":
      return (await import("./fr-ML6TSSHV.js")).default;
    default:
      return (await import("./en-RDFPKMPD.js")).default;
  }
}
...
function EcosystemWalletHeader(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(ModalHeader, { onBack: props.onBack, title: (0, import_jsx_runtime54.jsx)(import_jsx_runtime54.Fragment, { children: walletInfo.isLoading ? (0, import_jsx_runtime54.jsx)(Skeleton, { height: "24px", width: "200px" }) : (0, import_jsx_runtime54.jsxs)(import_jsx_runtime54.Fragment, { children: [!((_a = walletInfo.data) == null ? void 0 : _a.image_id) ? null : (0, import_jsx_runtime54.jsx)(Img, { src: (_b = walletInfo.data) == null ? void 0 : _b.image_id, style: {
    borderRadius: radius.sm
  }, width: iconSize.md, height: iconSize.md, client: props.client }), (0, import_jsx_runtime54.jsx)(ModalTitle, { children: (_c = walletInfo.data) == null ? void 0 : _c.name })] }) }), leftAligned: true });
}
...
function EcosystemWalletFormUIScreen(props) {
  ...
  return (0, import_jsx_runtime55.jsxs)(Container, { fullHeight: true, flex: "column", p: "lg", animate: "fadein", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime55.jsx)(EcosystemWalletHeader, { client: props.client, onBack: isCompact ? onBack : void 0, wallet: props.wallet }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime55.jsx)(Container, { expand: true, flex: "column", center: "y", p: isCompact ? void 0 : "lg", children: (0, import_jsx_runtime55.jsx)(ConnectWalletSocialOptions, { ...props }) }), isCompact && (props.meta.showThirdwebBranding !== false || props.meta.termsOfServiceUrl || props.meta.privacyPolicyUrl) && (0, import_jsx_runtime55.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime55.jsxs)(Container, { flex: "column", gap: "lg", children: [(0, import_jsx_runtime55.jsx)(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement }), props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime55.jsx)(PoweredByThirdweb, {})] })] });
}
...
function EcosystemWalletConnectUI(props) {
  ...
  const goBackToMain = props.size === "compact" ? props.goBack : () => {
    setSelectionData({});
  };
  ...
  if (otpUserInfo) {
    return (0, import_jsx_runtime56.jsx)(OTPLoginUI, { userInfo: otpUserInfo, locale, done: props.done, goBack: goBackToMain, wallet: props.wallet, chain: props.chain, client: props.client, size: props.size });
  }
  if (state == null ? void 0 : state.passkeyLogin) {
    return (0, import_jsx_runtime56.jsx)(PassKeyLogin, { wallet: props.wallet, done: props.done, onBack: goBackToMain, chain: props.chain, client: props.client, size: props.size });
  }
  if (state == null ? void 0 : state.socialLogin) {
    return (0, import_jsx_runtime56.jsx)(SocialLogin, { socialAuth: state.socialLogin.type, locale, done: props.done, goBack: goBackToMain, wallet: props.wallet, state, chain: props.chain, client: props.client, size: props.size });
  }
  return (0, import_jsx_runtime56.jsx)(EcosystemWalletFormUIScreen, { select: () => {
  }, locale, done: props.done, goBack: props.goBack, wallet: props.wallet, chain: props.chain, client: props.client, size: props.size, connectLocale: props.connectLocale, meta: props.meta });
}
...
async function getInjectedWalletLocale(locale) {
  switch (locale) {
    case "es_ES":
      return (await import("./es-324QZXN7.js")).default;
    case "ja_JP":
      return (await import("./ja-7Y2BMMSN.js")).default;
    case "tl_PH":
      return (await import("./tl-YZALGUX5.js")).default;
    case "vi_VN":
      return (await import("./vi-DX54OR32.js")).default;
    case "de_DE":
      return (await import("./de-JBNTSMHH.js")).default;
    case "ko_KR":
      return (await import("./kr-TTHC4BRG.js")).default;
    case "fr_FR":
      return (await import("./fr-H2SB6CYD.js")).default;
    default:
      return (await import("./en-RXTH7GXQ.js")).default;
  }
}
...
var AppleIcon = (props) => {
  return (0, import_jsx_runtime57.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 23 28", fill: "none", role: "presentation", children: (0, import_jsx_runtime57.jsx)("path", { d: "M22.4181 21.6041C22.008 22.5506 21.5224 23.422 20.9599 24.223C20.1931 25.3151 19.5652 26.0711 19.0814 26.4908C18.3313 27.1799 17.5277 27.5327 16.6671 27.5528C16.0493 27.5528 15.3043 27.3772 14.437 27.021C13.5669 26.6664 12.7673 26.4908 12.0362 26.4908C11.2694 26.4908 10.447 26.6664 9.56734 27.021C8.68636 27.3772 7.97665 27.5628 7.43403 27.5812C6.60879 27.6164 5.78624 27.2534 4.96519 26.4908C4.44116 26.0343 3.78569 25.2516 3.00047 24.1428C2.15799 22.9587 1.46536 21.5857 0.92274 20.0203C0.341611 18.3295 0.050293 16.6922 0.050293 15.1071C0.050293 13.2914 0.44307 11.7253 1.2298 10.413C1.84809 9.35886 2.67065 8.52734 3.70014 7.91691C4.72963 7.30648 5.84199 6.99541 7.03991 6.97551C7.69538 6.97551 8.55493 7.17804 9.6231 7.57607C10.6882 7.97544 11.3722 8.17797 11.672 8.17797C11.8962 8.17797 12.656 7.94116 13.944 7.46904C15.162 7.0312 16.19 6.84991 17.0321 6.92133C19.3141 7.10529 21.0285 8.00387 22.1687 9.62276C20.1278 10.858 19.1182 12.5881 19.1383 14.8076C19.1567 16.5363 19.7846 17.9749 21.0185 19.1172C21.5777 19.6473 22.2022 20.0571 22.897 20.3481C22.7463 20.7846 22.5872 21.2027 22.4181 21.6041ZM17.1845 1.03178C17.1845 2.38678 16.6889 3.65194 15.7011 4.82296C14.509 6.21507 13.0672 7.0195 11.5036 6.89256C11.4837 6.73 11.4721 6.55892 11.4721 6.37913C11.4721 5.07833 12.039 3.68622 13.0457 2.54798C13.5484 1.97167 14.1876 1.49247 14.9628 1.11021C15.7363 0.733653 16.4679 0.525407 17.156 0.489746C17.1761 0.670889 17.1845 0.85206 17.1845 1.03178Z", fill: "#959CA0" }) });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/ChromeIcon.js
var import_jsx_runtime58 = __toESM(require_jsx_runtime(), 1);
var ChromeIcon = (props) => {
  return (0, import_jsx_runtime58.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 190.5 190.5", role: "presentation", children: (0, import_jsx_runtime58.jsxs)("g", { transform: "translate(90.669 -507.469)", children: [(0, import_jsx_runtime58.jsx)("path", { d: "M4.583 650.342c26.304 0 47.627-21.324 47.627-47.628s-21.323-47.628-47.627-47.628-47.627 21.324-47.627 47.628 21.323 47.628 47.627 47.628z", fill: "#fff", clipPath: "none", mask: "none" }), (0, import_jsx_runtime58.jsx)("path", { d: "M-36.664 626.539l-41.24-71.43c-8.362 14.479-12.765 30.904-12.765 47.625s4.401 33.146 12.762 47.625 20.387 26.503 34.868 34.86 30.908 12.755 47.628 12.75l41.24-71.43v-.011c-4.177 7.244-10.188 13.26-17.428 17.443a47.62 47.62 0 0 1-47.632.007 47.62 47.62 0 0 1-17.433-17.437z", fill: "#229342", clipPath: "none", mask: "none" }), (0, import_jsx_runtime58.jsx)("path", { d: "M45.826 626.536l-41.239 71.43c16.72.003 33.146-4.398 47.626-12.757s26.504-20.384 34.863-34.865a95.24 95.24 0 0 0 12.755-47.627c-.003-16.72-4.408-33.145-12.772-47.623H4.58l-.01.007a47.62 47.62 0 0 1 23.819 6.372c7.243 4.179 13.257 10.19 17.439 17.431a47.62 47.62 0 0 1-.001 47.633z", fill: "#fbc116", clipPath: "none", mask: "none" }), (0, import_jsx_runtime58.jsx)("path", { d: "M4.583 640.43c20.824 0 37.705-16.881 37.705-37.706s-16.881-37.705-37.705-37.705-37.705 16.881-37.705 37.705 16.881 37.706 37.705 37.706z", fill: "#1a73e8", clipPath: "none", mask: "none" }), (0, import_jsx_runtime58.jsx)("path", { d: "M4.583 555.097h82.479c-8.358-14.481-20.381-26.507-34.861-34.868a95.23 95.23 0 0 0-47.625-12.76c-16.72.001-33.145 4.404-47.623 12.767a95.23 95.23 0 0 0-34.856 34.872l41.24 71.43.011.006a47.62 47.62 0 0 1-.015-47.633c4.179-7.242 10.193-13.256 17.434-17.436s15.456-6.381 23.818-6.379z", fill: "#e33b2e", clipPath: "none", mask: "none" })] }) });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/PlayStoreIcon.js
var import_jsx_runtime59 = __toESM(require_jsx_runtime(), 1);
var PlayStoreIcon = (props) => {
  return (0, import_jsx_runtime59.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 23 26", fill: "none", role: "presentation", children: [(0, import_jsx_runtime59.jsx)("path", { d: "M10.5832 12.0978L0.0976562 23.2275C0.0980507 23.2298 0.0988382 23.2317 0.0992076 23.2341C0.420793 24.4427 1.52467 25.3326 2.83473 25.3326C3.35844 25.3326 3.85012 25.191 4.27179 24.9424L4.30528 24.9228L16.1087 18.1117L10.5838 12.0977", fill: "#EB3131" }), (0, import_jsx_runtime59.jsx)("path", { d: "M21.1922 10.2046L21.1821 10.1977L16.0862 7.2435L10.345 12.3523L16.1061 18.1127L21.1752 15.1879C22.0639 14.7081 22.6672 13.7712 22.6672 12.6908C22.6672 11.6182 22.072 10.6859 21.1922 10.2046Z", fill: "#F6B60B" }), (0, import_jsx_runtime59.jsx)("path", { d: "M0.0961678 2.10416C0.0331317 2.33661 0 2.58009 0 2.83292V22.5002C0 22.7526 0.0327407 22.9969 0.0965672 23.2285L10.9441 12.3832L0.0965672 2.10444", fill: "#5778C5" }), (0, import_jsx_runtime59.jsx)("path", { d: "M10.6603 12.6667L16.088 7.24061L4.29785 0.404818C3.8693 0.148138 3.36912 0 2.83391 0C1.52384 0 0.418474 0.891502 0.0968301 2.10147C0.0964356 2.10265 0.0964355 2.10347 0.0964355 2.1045L10.6603 12.6669", fill: "#3BAD49" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/components/QRCode.js
var import_jsx_runtime60 = __toESM(require_jsx_runtime(), 1);
var import_react37 = __toESM(require_react(), 1);
var QRCodeRenderer = (0, import_react37.lazy)(() => import("./QRCodeRenderer-GEVTMPAW.js"));
var QRCode = (props) => {
  const size4 = props.size || 310;
  const placeholder = (0, import_jsx_runtime60.jsxs)(QRPlaceholder, { style: {
    width: `${size4}px`,
    height: `${size4}px`
  }, children: [(0, import_jsx_runtime60.jsx)("span", { "data-v1": true }), (0, import_jsx_runtime60.jsx)("span", { "data-v2": true }), (0, import_jsx_runtime60.jsx)("span", { "data-v3": true }), (0, import_jsx_runtime60.jsx)("div", {})] });
  return (0, import_jsx_runtime60.jsxs)("div", { style: {
    position: "relative",
    display: "flex",
    justifyContent: "center"
  }, children: [props.qrCodeUri ? (0, import_jsx_runtime60.jsx)(import_react37.Suspense, { fallback: placeholder, children: (0, import_jsx_runtime60.jsx)(QRCodeContainer, { children: (0, import_jsx_runtime60.jsx)(QRCodeRenderer, { uri: props.qrCodeUri, size: size4 + 20, ecl: "M", clearSize: props.QRIcon ? 70 : void 0 }) }) }) : placeholder, props.QRIcon && (0, import_jsx_runtime60.jsx)(IconContainer, { children: props.QRIcon })] });
};
...
var GetStartedScreen = ({ wallet, walletInfo, header, footer, onBack, locale, client }) => {
  const [showScreen, setShowScreen] = (0, import_react38.useState)("base");
  ...
  return (0, import_jsx_runtime61.jsx)(Container, { fullHeight: true, flex: "column", animate: "fadein", children: (0, import_jsx_runtime61.jsxs)(Container, { expand: true, flex: "column", p: "lg", children: [showScreen === "android-scan" && walletInfo.app.android && (0, import_jsx_runtime61.jsx)(InstallScanScreen, { platformIcon: (0, import_jsx_runtime61.jsx)(PlayStoreIcon, { size: iconSize.md }), url: walletInfo.app.android, platform: "Google Play", walletName: walletInfo.name, walletId: wallet.id, onBack: handleBack, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, client }), showScreen === "ios-scan" && walletInfo.app.ios && (0, import_jsx_runtime61.jsx)(InstallScanScreen, { platformIcon: (0, import_jsx_runtime61.jsx)(AppleIcon, { size: iconSize.md }), url: walletInfo.app.ios, platform: "App Store", walletName: walletInfo.name, walletId: wallet.id, onBack: handleBack, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, client }), showScreen === "base" && (0, import_jsx_runtime61.jsxs)(Container, { expand: true, flex: "column", children: [header || (0, import_jsx_runtime61.jsx)(ModalHeader, { onBack: handleBack, title: walletInfo.name }), (0, import_jsx_runtime61.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime61.jsx)(Container, { expand: true, animate: "fadein", flex: "column", center: "y", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime61.jsxs)(Container, { flex: "column", gap: "xs", children: [walletInfo.app.chrome && (0, import_jsx_runtime61.jsxs)(ButtonLink2, { onClick: () => {
    openWindow(walletInfo.app.chrome || "");
  }, children: [(0, import_jsx_runtime61.jsx)(ChromeIcon, { size: iconSize.lg }), (0, import_jsx_runtime61.jsx)("span", { children: locale.download.chrome })] }), walletInfo.app.android && (0, import_jsx_runtime61.jsxs)(ButtonLink2, { as: "button", onClick: () => {
    if (isMobile()) {
      openWindow(walletInfo.app.android || "");
    } else {
      setShowScreen("android-scan");
    }
  }, children: [(0, import_jsx_runtime61.jsx)(PlayStoreIcon, { size: iconSize.lg }), (0, import_jsx_runtime61.jsx)("span", { children: locale.download.android })] }), walletInfo.app.ios && (0, import_jsx_runtime61.jsxs)(ButtonLink2, { as: "button", onClick: () => {
    if (isMobile()) {
      openWindow(walletInfo.app.ios || "");
    } else {
      setShowScreen("ios-scan");
    }
  }, children: [(0, import_jsx_runtime61.jsx)(AppleIcon, { size: iconSize.lg }), (0, import_jsx_runtime61.jsx)("span", { children: locale.download.iOS })] })] }) })] }), !isScanScreen && footer] }) });
};
var InstallScanScreen = (props) => {
  return (0, import_jsx_runtime61.jsxs)(Container, { animate: "fadein", expand: true, children: [(0, import_jsx_runtime61.jsx)(ModalHeader, { title: props.walletName, onBack: props.onBack }), (0, import_jsx_runtime61.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime61.jsxs)(Container, { flex: "column", expand: true, center: "both", style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime61.jsx)(QRCode, { qrCodeUri: props.url, QRIcon: (0, import_jsx_runtime61.jsx)(WalletImage, { id: props.walletId, size: iconSize.xxl, client: props.client }) }), (0, import_jsx_runtime61.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime61.jsx)(Text, { multiline: true, center: true, balance: true, children: props.locale.scanToDownload }), (0, import_jsx_runtime61.jsx)(Spacer, { y: "xs" })] })] });
};
...
var ScanScreen = (props) => {
  ...
  const [linkCopied, setLinkCopied] = (0, import_react39.useState)(false);
  return (0, import_jsx_runtime62.jsxs)(Container, { fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime62.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime62.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletName }) }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime62.jsxs)(Container, { expand: true, flex: "column", px: "lg", center: "both", children: [!props.error && (0, import_jsx_runtime62.jsxs)("div", { style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime62.jsx)(QRCode, { qrCodeUri: props.qrCodeUri, QRIcon: (0, import_jsx_runtime62.jsx)(WalletImage, { size: iconSize.xxl, id: props.walletId, client }) }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime62.jsxs)(Button, { disabled: props.qrCodeUri === void 0, variant: "link", style: {
    fontSize: "12px",
  ...
  }, children: [linkCopied ? (0, import_jsx_runtime62.jsx)(CheckIcon, { width: 14, height: 14 }) : (0, import_jsx_runtime62.jsx)(CopyIcon, { width: 14, height: 14 }), (0, import_jsx_runtime62.jsx)("span", { style: { padding: "0 4px" }, children: "Copy Link" })] }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime62.jsx)(Text, { center: true, multiline: true, balance: true, style: {
    paddingInline: spacing.lg
  }, children: props.qrScanInstruction })] }), props.error && (0, import_jsx_runtime62.jsxs)(Container, { animate: "fadein", style: {
    width: "100%"
  }, children: [(0, import_jsx_runtime62.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime62.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime62.jsx)(AccentFailIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime62.jsx)(Text, { center: true, size: "lg", color: "primaryText", children: "Connection Failed" }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "3xl" }), (0, import_jsx_runtime62.jsx)(Button, { fullWidth: true, variant: "accent", onClick: props.onRetry, children: "Try again" })] })] }), (0, import_jsx_runtime62.jsx)(Spacer, { y: "lg" }), props.onGetStarted && (0, import_jsx_runtime62.jsx)(ScreenBottomContainer, { style: {
    border: connectModalSize === "compact" ? void 0 : "none"
  }, children: (0, import_jsx_runtime62.jsx)(Button, { variant: "link", onClick: props.onGetStarted, style: {
    fontSize: fontSize.sm,
    textAlign: "center"
...
var WalletConnectConnection = (props) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react40.useState)();
  const [errorConnecting, setErrorConnecting] = (0, import_react40.useState)(false);
  const connect = (0, import_react40.useCallback)(() => {
    var _a;
  ...
  const scanStarted = (0, import_react40.useRef)(false);
  ...
  if (isMobile()) {
    return (0, import_jsx_runtime63.jsx)(ConnectingScreen, { locale: {
  ...
  return (0, import_jsx_runtime63.jsx)(ScanScreen, { qrScanInstruction: locale.scanScreen.instruction, onBack, onGetStarted, qrCodeUri, walletName: walletInfo.name, walletId: wallet.id, getStartedLink: locale.getStartedLink, error: errorConnecting, onRetry: connect, client: props.client, connectModalSize: props.size });
};
var WalletConnectStandaloneConnection = (props) => {
  ...
  return (0, import_jsx_runtime63.jsx)(ScanScreen, { qrScanInstruction: locale.scanScreen.instruction, onBack, qrCodeUri, walletName: walletInfo.name, walletId: wallet.id, getStartedLink: locale.getStartedLink, error: errorConnecting, onRetry: connect, client: props.client, connectModalSize: props.size });
};
...
var wait2 = (ms) => new Promise((resolve2) => setTimeout(resolve2, ms));

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/InjectedConnectUI.js
var InjectedConnectUI = (props) => {
  const { wallet, done } = props;
  const [errorConnecting, setErrorConnecting] = (0, import_react42.useState)(false);
  const locale = props.locale;
  const connectToExtension = (0, import_react42.useCallback)(async () => {
    try {
  ...
  const connectPrompted = (0, import_react42.useRef)(false);
  ...
  return (0, import_jsx_runtime65.jsx)(ConnectingScreen, { locale: {
    getStartedLink: locale.getStartedLink,
    instruction: locale.connectionScreen.instruction,
    tryAgain: locale.connectionScreen.retry,
    inProgress: locale.connectionScreen.inProgress,
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/AnyWalletConnectUI.js
var CoinbaseSDKWalletConnectUI = (0, import_react43.lazy)(() => import("./CoinbaseSDKConnection-2Q36LBQH.js"));
var InAppWalletConnectUI = (0, import_react43.lazy)(() => import("./InAppWalletConnectUI-HTKNI6EW.js"));
function AnyWalletConnectUI(props) {
  var _a, _b;
  const [screen, setScreen] = (0, import_react43.useState)("main");
  const { wallet } = props;
  const walletInfo = useWalletInfo(props.wallet.id);
  const localeId = props.connectLocale.id;
  ...
  if (walletInfo.isLoading || !localeFnQuery.data) {
    return (0, import_jsx_runtime66.jsx)(LoadingScreen, {});
  }
  const localeFn = localeFnQuery.data;
  if (!walletInfo.data) {
    const injectedProvider2 = getInstalledWalletProviders().find((w) => w.info.rdns === wallet.id);
    if (injectedProvider2) {
      return (0, import_jsx_runtime66.jsx)(InjectedConnectUI, { wallet: props.wallet, walletName: injectedProvider2.info.name, done: props.done, locale: localeFn(injectedProvider2.info.name), onBack: props.onBack, chain: props.chain, client: props.client, size: props.size });
    }
    return (0, import_jsx_runtime66.jsxs)(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, import_jsx_runtime66.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime66.jsx)(ModalHeader, { title: "Not Supported", onBack: props.onBack }) }), (0, import_jsx_runtime66.jsxs)(Container, { flex: "column", expand: true, center: "both", p: "lg", style: {
      minHeight: "300px"
    }, children: [(0, import_jsx_runtime66.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime66.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime66.jsx)(Text, { color: "primaryText", center: true, children: "Wallet is not supported" }), (0, import_jsx_runtime66.jsx)(Spacer, { y: "xxl" })] })] });
  }
  ...
  if (screen === "get-started") {
    return (0, import_jsx_runtime66.jsx)(GetStartedScreen, { locale, wallet: props.wallet, walletInfo: walletInfo.data, onBack: () => {
      setScreen("main");
    }, client: props.client });
  }
  if (walletInfo.data.deepLink && !isInstalled && ((_b = wallet.getConfig()) == null ? void 0 : _b.preferDeepLink) && isMobile()) {
    return (0, import_jsx_runtime66.jsx)(DeepLinkConnectUI, { wallet: props.wallet, walletInfo: walletInfo.data, deepLinkPrefix: walletInfo.data.deepLink.mobile, locale, onGetStarted: () => {
      setScreen("get-started");
    }, onBack: props.onBack, client: props.client });
  }
  if (walletInfo.data.rdns && isInstalled) {
    return (0, import_jsx_runtime66.jsx)(InjectedConnectUI, { wallet: props.wallet, walletName: walletInfo.data.name, done: props.done, locale, onGetStarted: () => {
      setScreen("get-started");
    }, onBack: props.onBack, chain: props.chain, client: props.client, size: props.size });
  }
  if (props.wallet.id === COINBASE) {
    return (0, import_jsx_runtime66.jsx)(import_react43.Suspense, { fallback: (0, import_jsx_runtime66.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime66.jsx)(CoinbaseSDKWalletConnectUI, { locale, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (walletInfo.data.mobile.native || walletInfo.data.mobile.universal) {
    return (0, import_jsx_runtime66.jsx)(WalletConnectConnection, { locale, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (props.wallet.id === "walletConnect") {
    return (0, import_jsx_runtime66.jsx)(WalletConnectStandaloneConnection, { locale, onBack: props.onBack, done: props.done, wallet: props.wallet, walletInfo: walletInfo.data, setModalVisibility: props.setModalVisibility, chain: props.chain, chains: props.chains, client: props.client, size: props.size, walletConnect: props.walletConnect });
  }
  if (props.wallet.id === "inApp" || props.wallet.id === "embedded") {
    return (0, import_jsx_runtime66.jsx)(import_react43.Suspense, { fallback: (0, import_jsx_runtime66.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime66.jsx)(InAppWalletConnectUI, { wallet: props.wallet, done: props.done, goBack: props.onBack, chain: props.chain, client: props.client, size: props.size, connectLocale: props.connectLocale, meta: props.meta }) });
  }
  if (isEcosystemWallet(props.wallet.id)) {
    return (0, import_jsx_runtime66.jsx)(import_react43.Suspense, { fallback: (0, import_jsx_runtime66.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime66.jsx)(EcosystemWalletConnectUI_default, { wallet: props.wallet, done: props.done, goBack: props.onBack, chain: props.chain, client: props.client, size: props.size, meta: props.meta, connectLocale: props.connectLocale }) });
  }
  return (0, import_jsx_runtime66.jsx)(GetStartedScreen, { locale, wallet: props.wallet, walletInfo: walletInfo.data, onBack: () => {
    setScreen("main");
  }, client: props.client });
...
function SmartConnectUI(props) {
  ...
  const [keyConnected, setKeyConnected] = (0, import_react44.useState)(false);
  if (!personalWalletInfo.data) {
    return (0, import_jsx_runtime67.jsx)(LoadingScreen, {});
  }
  if (!keyConnected) {
    return (0, import_jsx_runtime67.jsx)(AnyWalletConnectUI, { wallet: props.personalWallet, done: () => {
  ...
  return (0, import_jsx_runtime67.jsx)(SmartWalletConnecting, { done: props.done, personalWallet: props.personalWallet, accountAbstraction: props.accountAbstraction, onBack: props.onBack, personalWalletInfo: personalWalletInfo.data, localeId: props.connectLocale.id, size: props.size, client: props.client });
}
function SmartWalletConnecting(props) {
  ...
  const { done } = props;
  const [personalWalletChainId, setPersonalWalletChainId] = (0, import_react44.useState)((_a = personalWallet.getChain()) == null ? void 0 : _a.id);
  ...
  const [smartWalletConnectionStatus, setSmartWalletConnectionStatus] = (0, import_react44.useState)("idle");
  const [personalWalletChainSwitchStatus, setPersonalWalletChainSwitchStatus] = (0, import_react44.useState)("idle");
  const connectionManager = useConnectionManager();
  const handleConnect = (0, import_react44.useCallback)(async () => {
    if (!personalWallet) {
  ...
  const connectStarted = (0, import_react44.useRef)(false);
  (0, import_react44.useEffect)(() => {
  ...
  if (wrongNetwork) {
    return (0, import_jsx_runtime67.jsxs)(Container, { fullHeight: true, animate: "fadein", flex: "column", children: [(0, import_jsx_runtime67.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime67.jsx)(ModalHeader, { title: props.personalWalletInfo.name, onBack: props.onBack }) }), props.size === "compact" && (0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsx)(Container, { expand: true, flex: "column", center: "both", p: "lg", children: (0, import_jsx_runtime67.jsxs)(Container, { p: props.size === "wide" ? "lg" : void 0, children: [(0, import_jsx_runtime67.jsx)(Container, { flex: "row", center: "x", color: "danger", children: (0, import_jsx_runtime67.jsx)(ExclamationTriangleIcon, { width: iconSize.lg, height: iconSize.lg }) }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime67.jsx)(Text, { size: "lg", color: "primaryText", center: true, weight: 500, children: localeQuery.data.wrongNetworkScreen.title }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsx)(Text, { multiline: true, center: true, children: localeQuery.data.wrongNetworkScreen.subtitle }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime67.jsxs)(Container, { flex: "column", gap: "md", children: [(0, import_jsx_runtime67.jsxs)(Button, { type: "button", fullWidth: true, variant: "accent", style: {
      display: "flex",
      alignItems: "center",
      gap: spacing.sm
    }, onClick: async () => {
    ...
    }, children: [" ", personalWalletChainSwitchStatus === "switching" ? "Switching" : "Switch Network", personalWalletChainSwitchStatus === "switching" && (0, import_jsx_runtime67.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] }), (0, import_jsx_runtime67.jsxs)(Container, { flex: "row", gap: "sm", center: "both", color: "danger", style: {
      textAlign: "center",
      fontSize: fontSize.sm,
      opacity: personalWalletChainSwitchStatus === "switch-error" ? 1 : 0,
      transition: "opacity 200ms ease"
    }, children: [(0, import_jsx_runtime67.jsx)(ExclamationTriangleIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime67.jsx)("span", { children: localeQuery.data.wrongNetworkScreen.failedToSwitch })] })] })] }) })] });
  }
  if (smartWalletConnectionStatus === "connect-error") {
    return (0, import_jsx_runtime67.jsx)(Container, { fullHeight: true, animate: "fadein", flex: "column", center: "both", p: "lg", style: {
      minHeight: "300px"
    }, children: (0, import_jsx_runtime67.jsx)(Text, { color: "danger", children: localeQuery.data.failedToConnect }) });
  }
  return (0, import_jsx_runtime67.jsxs)(Container, { fullHeight: true, flex: "column", center: "both", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime67.jsx)(Text, { color: "primaryText", multiline: true, center: true, children: localeQuery.data.connecting }), (0, import_jsx_runtime67.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime67.jsx)(Spinner, { color: "accentText", size: "lg" })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/WalletSelector.js
var InAppWalletSelectionUI = (0, import_react45.lazy)(() => import("./InAppWalletSelectionUI-MQ5RSIB2.js"));
var inAppWalletId = "inApp";
function WalletSelector(props) {
  const [personalWallet, setPersonalWallet] = (0, import_react45.useState)(null);
  if (!props.accountAbstraction) {
    return (0, import_jsx_runtime68.jsx)(WalletSelectorInner, { ...props });
  }
  if (personalWallet) {
    return (0, import_jsx_runtime68.jsx)(SmartConnectUI, { accountAbstraction: props.accountAbstraction, done: props.done, personalWallet, setModalVisibility: props.setModalVisibility, onBack: props.goBack, meta: props.meta, size: props.size, chain: props.chain, chains: props.chains, client: props.client, walletConnect: props.walletConnect, connectLocale: props.connectLocale });
  }
  return (0, import_jsx_runtime68.jsx)(WalletSelectorInner, { ...props, done: (w) => {
    setPersonalWallet(w);
  } });
}
var WalletSelectorInner = (props) => {
  ...
  const isCompact = props.size === "compact";
  const [isWalletGroupExpanded, setIsWalletGroupExpanded] = (0, import_react45.useState)(false);
  ...
  const continueAsGuest = localWalletConfig && (0, import_jsx_runtime68.jsx)(Button, { fullWidth: true, variant: isCompact ? "outline" : "link", style: !isCompact ? {
    textAlign: "left",
    justifyContent: "flex-start"
  } : void 0, onClick: () => {
    props.selectWallet(localWalletConfig);
  }, "data-test": "continue-as-guest-button", children: props.connectLocale.continueAsGuest });
  const enableTWIconLink = (0, import_react45.useRef)(false);
  (0, import_react45.useEffect)(() => {
    setTimeout(() => {
      enableTWIconLink.current = true;
    }, 1e3);
  }, []);
  const twTitle = props.modalHeader ? (0, import_jsx_runtime68.jsx)(ModalHeader, { title: props.modalHeader.title, onBack: props.modalHeader.onBack }) : (0, import_jsx_runtime68.jsxs)(Container, { gap: "xxs", center: "y", flex: "row", children: [!props.meta.titleIconUrl ? null : (0, import_jsx_runtime68.jsx)(Img, { src: props.meta.titleIconUrl, width: iconSize.md, height: iconSize.md, client: props.client }), (0, import_jsx_runtime68.jsxs)(ModalTitle, { children: [" ", props.title, " "] })] });
  const handleSelect = async (wallet) => {
    props.selectWallet(wallet);
  };
  const connectAWallet = (0, import_jsx_runtime68.jsx)(WalletTypeRowButton, { client: props.client, icon: genericWalletIcon, onClick: () => {
    setIsWalletGroupExpanded(true);
  }, title: props.connectLocale.connectAWallet });
  const newToWallets = (0, import_jsx_runtime68.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime68.jsx)(Text, { color: "secondaryText", size: "sm", weight: 500, children: props.connectLocale.newToWallets }), (0, import_jsx_runtime68.jsx)(Link, { weight: 500, size: "sm", target: "_blank", href: "https://blog.thirdweb.com/web3-wallet/", children: props.connectLocale.getStarted })] });
  const tos = props.meta.termsOfServiceUrl || props.meta.privacyPolicyUrl ? (0, import_jsx_runtime68.jsx)(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement }) : void 0;
  let topSection;
  let bottomSection;
  if (!isCompact) {
    topSection = (0, import_jsx_runtime68.jsx)(WalletSelection, { wallets: nonLocalWalletConfigs, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets });
    if (continueAsGuest) {
      bottomSection = (0, import_jsx_runtime68.jsx)(ScreenBottomContainer, { children: continueAsGuest });
    }
  } else {
    if (socialWallets.length === 0) {
      topSection = (0, import_jsx_runtime68.jsx)(WalletSelection, { wallets: nonLocalWalletConfigs, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets });
      bottomSection = (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [(0, import_jsx_runtime68.jsx)(Line, {}), (0, import_jsx_runtime68.jsxs)(Container, { flex: "column", p: "md", gap: "md", children: [newToWallets, continueAsGuest] }), !continueAsGuest && (0, import_jsx_runtime68.jsx)(Line, {}), tos && (0, import_jsx_runtime68.jsx)(Container, { px: "md", style: {
        paddingBottom: spacing.md,
        paddingTop: continueAsGuest ? 0 : spacing.md
      }, children: tos })] });
    } else {
      if (!isWalletGroupExpanded) {
        topSection = (0, import_jsx_runtime68.jsxs)(Container, { px: "xs", children: [(0, import_jsx_runtime68.jsx)(WalletSelection, { wallets: socialWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets }), eoaWallets.length > 0 && (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [(0, import_jsx_runtime68.jsx)(TextDivider, { text: props.connectLocale.or }), (0, import_jsx_runtime68.jsx)(Spacer, { y: "lg" })] })] });
        if (eoaWallets.length === 0) {
          bottomSection = tos || continueAsGuest ? (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [(0, import_jsx_runtime68.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime68.jsx)(Line, {}), continueAsGuest && (0, import_jsx_runtime68.jsxs)(Container, { p: "lg", children: [" ", continueAsGuest] }), tos && (0, import_jsx_runtime68.jsxs)(Container, { p: "md", children: [" ", tos, " "] })] }) : (0, import_jsx_runtime68.jsx)(Spacer, { y: "sm" });
        } else {
          if (eoaWallets.length > 1) {
            bottomSection = (0, import_jsx_runtime68.jsxs)(Container, { flex: "column", style: { position: "relative" }, gap: "sm", children: [(0, import_jsx_runtime68.jsx)(GradientDiv, {}), (0, import_jsx_runtime68.jsxs)(Container, { px: "lg", flex: "column", gap: "md", children: [connectAWallet, continueAsGuest] }), tos ? (0, import_jsx_runtime68.jsxs)(Container, { p: "md", children: [" ", tos, " "] }) : (0, import_jsx_runtime68.jsx)(Spacer, { y: "xxs" })] });
          } else {
            bottomSection = (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [(0, import_jsx_runtime68.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime68.jsx)(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets }) }), continueAsGuest && (0, import_jsx_runtime68.jsx)(Container, { flex: "column", px: "lg", gap: "lg", children: continueAsGuest }), tos ? (0, import_jsx_runtime68.jsxs)(import_jsx_runtime68.Fragment, { children: [continueAsGuest ? (0, import_jsx_runtime68.jsx)(Spacer, { y: "md" }) : (0, import_jsx_runtime68.jsx)(Line, {}), (0, import_jsx_runtime68.jsxs)(Container, { p: "md", children: [" ", tos, " "] })] }) : (0, import_jsx_runtime68.jsx)(import_jsx_runtime68.Fragment, { children: continueAsGuest && (0, import_jsx_runtime68.jsx)(Spacer, { y: "xl" }) })] });
          }
        }
      } else {
        topSection = (0, import_jsx_runtime68.jsx)(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain, showAllWallets: props.showAllWallets });
        bottomSection = (0, import_jsx_runtime68.jsx)(ScreenBottomContainer, { children: newToWallets });
      }
    }
  }
  const showHeader = !props.isEmbed || props.modalHeader;
  return (0, import_jsx_runtime68.jsxs)(Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
    maxHeight: props.size === "compact" ? compactModalMaxHeight : void 0
  }, children: [showHeader && (0, import_jsx_runtime68.jsx)(Container, { p: "lg", children: isWalletGroupExpanded ? (0, import_jsx_runtime68.jsx)(ModalHeader, { title: twTitle, onBack: () => {
    setIsWalletGroupExpanded(false);
  } }) : twTitle }), (0, import_jsx_runtime68.jsxs)(Container, { expand: true, scrollY: true, px: "md", style: !showHeader ? {
    paddingTop: spacing.lg
  } : {
    paddingTop: "2px"
  }, children: [!props.modalHeader && props.isEmbed && isWalletGroupExpanded && (0, import_jsx_runtime68.jsx)(Container, { flex: "row", center: "y", style: {
    padding: spacing.sm,
    paddingTop: 0
  }, children: (0, import_jsx_runtime68.jsxs)(IconButton, { onClick: () => {
    setIsWalletGroupExpanded(false);
  }, style: {
    gap: spacing.xxs,
  ...
  }, children: [(0, import_jsx_runtime68.jsx)(ChevronLeftIcon, { width: iconSize.sm, height: iconSize.sm }), props.connectLocale.goBackButton] }) }), topSection] }), bottomSection, isCompact && props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime68.jsx)(Container, { py: "md", children: (0, import_jsx_runtime68.jsx)(PoweredByThirdweb, {}) })] });
};
...
var WalletSelection = (props) => {
  ...
  const setSelectionData = useSetSelectionData();
  return (0, import_jsx_runtime68.jsxs)(WalletList, { style: {
    minHeight: "100%"
  }, children: [wallets.map((wallet) => {
    const isActive = screen ? typeof screen === "object" && screen.id === wallet.id : false;
    return (0, import_jsx_runtime68.jsx)("li", { children: wallet.id === "inApp" && props.size === "compact" ? (0, import_jsx_runtime68.jsx)(import_react45.Suspense, { fallback: (0, import_jsx_runtime68.jsx)(LoadingScreen, { height: "195px" }), children: (0, import_jsx_runtime68.jsx)(InAppWalletSelectionUI, { done: () => props.done(wallet), select: () => props.selectWallet(wallet), wallet, goBack: props.goBack, client: props.client, connectLocale: props.connectLocale, size: props.size, recommendedWallets: props.recommendedWallets, chain: props.chain }) }) : (0, import_jsx_runtime68.jsx)(WalletEntryButton, { walletId: wallet.id, selectWallet: () => {
      setSelectionData({});
      props.selectWallet(wallet);
  ...
  }), props.onShowAll && props.showAllWallets !== false && (0, import_jsx_runtime68.jsx)(ButtonContainer, { children: (0, import_jsx_runtime68.jsxs)(WalletButtonEl, { onClick: props.onShowAll, children: [(0, import_jsx_runtime68.jsxs)(ShowAllWalletsIcon, { children: [(0, import_jsx_runtime68.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime68.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime68.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime68.jsx)("div", { "data-dot": true })] }), (0, import_jsx_runtime68.jsxs)(Container, { flex: "row", gap: "xs", children: [(0, import_jsx_runtime68.jsx)(Text, { color: "primaryText", children: "All Wallets" }), (0, import_jsx_runtime68.jsx)(BadgeText, { children: " 350+ " })] })] }) })] });
};
...
var SignatureScreen = (props) => {
  ...
  const signIn = (0, import_react47.useCallback)(async () => {
    try {
      setStatus("signing");
  ...
  if (!wallet) {
    return (0, import_jsx_runtime69.jsx)(LoadingScreen, {});
  }
  if (wallet.id === "inApp" || wallet.id === "embedded") {
    return (0, import_jsx_runtime69.jsx)(HeadlessSignIn, { signIn, status, connectLocale, wallet });
  }
  const handleRetry = () => {
    signIn();
  };
  return (0, import_jsx_runtime69.jsxs)(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, import_jsx_runtime69.jsx)(Container, { p: "lg", style: {
    paddingBottom: 0
  }, children: (0, import_jsx_runtime69.jsx)(ModalHeader, { title: locale.instructionScreen.title }) }), (0, import_jsx_runtime69.jsx)(Container, { style: {
    paddingTop: 0,
    paddingBottom: spacing.xl
  }, flex: "column", px: modalSize === "compact" ? "lg" : "xxl", center: "y", expand: true, children: status === "idle" ? (0, import_jsx_runtime69.jsxs)(import_jsx_runtime69.Fragment, { children: [(0, import_jsx_runtime69.jsx)(Container, { flex: "row", center: "x", animate: "fadein", py: "3xl", children: (0, import_jsx_runtime69.jsx)(PulsatingContainer2, { children: (0, import_jsx_runtime69.jsx)(WalletImage, { id: wallet.id, client: props.client, size: "80" }) }) }), (0, import_jsx_runtime69.jsx)(Text, { center: true, multiline: true, balance: true, children: locale.instructionScreen.instruction }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime69.jsx)(Button, { fullWidth: true, variant: "accent", onClick: signIn, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.signInButton }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime69.jsx)(Button, { fullWidth: true, variant: "secondary", onClick: () => {
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: connectLocale.signatureScreen.instructionScreen.disconnectWallet })] }) : (0, import_jsx_runtime69.jsxs)(import_jsx_runtime69.Fragment, { children: [(0, import_jsx_runtime69.jsx)(Container, { py: "3xl", children: (0, import_jsx_runtime69.jsx)(WalletLogoSpinner, { client: props.client, error: status === "failed", id: wallet.id }) }), (0, import_jsx_runtime69.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [(0, import_jsx_runtime69.jsx)(Text, { size: "lg", center: true, color: "primaryText", children: status === "failed" ? locale.signingScreen.failedToSignIn : locale.signingScreen.inProgress }), status === "signing" && (0, import_jsx_runtime69.jsx)(Text, { center: true, multiline: true, balance: true, children: connectLocale.signatureScreen.signingScreen.prompt }), status === "failed" && (0, import_jsx_runtime69.jsxs)(Container, { children: [(0, import_jsx_runtime69.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime69.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: handleRetry, style: {
    gap: spacing.xs,
    alignItems: "center",
    padding: spacing.md
  }, children: [(0, import_jsx_runtime69.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), locale.signingScreen.tryAgain] }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime69.jsx)(Button, { fullWidth: true, variant: "secondary", onClick: () => {
    disconnect(wallet);
  }, style: {
    alignItems: "center",
    padding: spacing.md
  }, children: locale.instructionScreen.disconnectWallet })] })] }, status)] }) }), (termsOfServiceUrl || privacyPolicyUrl) && (0, import_jsx_runtime69.jsx)(Container, { p: "md", animate: "fadein", children: (0, import_jsx_runtime69.jsx)(TOS, { termsOfServiceUrl, privacyPolicyUrl, locale: connectLocale.agreement }) })] });
};
function HeadlessSignIn({ signIn, status, connectLocale, wallet }) {
  ...
  return (0, import_jsx_runtime69.jsxs)(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime69.jsx)(ModalHeader, { title: locale.signingScreen.title }), (0, import_jsx_runtime69.jsxs)(Container, { expand: true, flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: [status === "signing" && (0, import_jsx_runtime69.jsx)(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (0, import_jsx_runtime69.jsx)(import_jsx_runtime69.Fragment, { children: (0, import_jsx_runtime69.jsxs)(Container, { children: [(0, import_jsx_runtime69.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime69.jsx)(Text, { size: "lg", center: true, color: "danger", children: locale.signingScreen.failedToSignIn }), (0, import_jsx_runtime69.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime69.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => {
    signIn();
  }, style: {
    gap: spacing.xs,
    alignItems: "center",
...
`;
var PulsatingContainer2 = StyledDiv((_) => {
  const theme = useCustomTheme();
  return {
    position: "relative",
    "&::before": {
      ...
      right: 0,
      background: theme.colors.accentText,
      animation: `${pulseAnimation3} 2s cubic-bezier(0.175, 0.885, 0.32, 1.1) infinite`,
      zIndex: -1,
      borderRadius: radius.xl
    }
  };
...
function StartScreen(props) {
  ...
  if (WelcomeScreen) {
    if (typeof WelcomeScreen === "function") {
      return (0, import_jsx_runtime71.jsx)(WelcomeScreen, {});
    }
  }
  ...
  return (0, import_jsx_runtime71.jsxs)(Container, { fullHeight: true, animate: "fadein", flex: "column", children: [(0, import_jsx_runtime71.jsxs)(Container, { expand: true, flex: "column", center: "both", style: {
    minHeight: "300px"
  }, p: "lg", children: [(0, import_jsx_runtime71.jsx)(Container, { flex: "row", center: "x", children: img ? (0, import_jsx_runtime71.jsx)(Img, { src: img.src, width: img.width ? String(img.width) : void 0, height: img.height ? String(img.height) : void 0, client: props.client }) : (0, import_jsx_runtime71.jsx)(GlobalContainer, { children: (0, import_jsx_runtime71.jsx)(GlobeIcon, { size: "150" }) }) }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime71.jsx)(Text, { center: true, color: "primaryText", weight: 600, multiline: true, children: title }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime71.jsx)(Text, { color: "secondaryText", multiline: true, style: {
    textAlign: "center"
  }, children: subtitle }), (0, import_jsx_runtime71.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime71.jsx)(Link, { target: "_blank", center: true, href: "https://blog.thirdweb.com/web3-wallet/", children: props.connectLocale.newToWallets })] }), (0, import_jsx_runtime71.jsx)(Container, { py: "lg", flex: "column", gap: "lg", children: (0, import_jsx_runtime71.jsxs)("div", { children: [showTOS && (0, import_jsx_runtime71.jsx)(TOS, { termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, locale: props.connectLocale.agreement }), props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime71.jsx)(Container, { style: {
    paddingTop: spacing.xl
  }, children: (0, import_jsx_runtime71.jsx)(PoweredByThirdweb, {}) })] }) })] });
}
...
function ConnectModalWideLayout(props) {
  return (0, import_jsx_runtime72.jsxs)("div", { style: {
    height: "100%",
    display: "grid",
    gridTemplateColumns: "300px 1fr"
  }, children: [(0, import_jsx_runtime72.jsxs)(LeftContainer, { children: [" ", props.left, " "] }), (0, import_jsx_runtime72.jsx)(Container, { flex: "column", scrollY: true, relative: true, children: props.right })] });
}
function ConnectModalCompactLayout(props) {
  return (0, import_jsx_runtime72.jsx)(Container, { flex: "column", scrollY: true, relative: true, style: {
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react49.lazy)(() => import("./AllWalletsUI-KDHYMLTI.js"));
var ConnectModalContent = (props) => {
  ...
  const connectionManager = useConnectionManager();
  const handleConnected = (0, import_react49.useCallback)((wallet) => {
    if (shouldSetActive) {
  ...
  const handleBack = (0, import_react49.useCallback)(() => {
    setSelectionData({});
    setScreen(initialScreen);
  }, [setScreen, initialScreen, setSelectionData]);
  const walletList = (0, import_jsx_runtime73.jsx)(WalletSelector, { title: props.meta.title || props.connectLocale.defaultModalTitle, wallets: props.wallets, selectWallet: (newWallet) => {
  ...
  }, done: handleConnected, goBack: props.wallets.length > 1 ? handleBack : void 0, setModalVisibility, client: props.client, connectLocale: props.connectLocale, isEmbed: props.isEmbed, recommendedWallets: props.recommendedWallets, accountAbstraction: props.accountAbstraction, chain: props.chain, showAllWallets: props.showAllWallets, chains: props.chains, walletConnect: props.walletConnect, meta: props.meta, size: props.size, modalHeader: props.modalHeader, walletIdsToHide: props.walletIdsToHide });
  const showAll = (0, import_jsx_runtime73.jsx)(import_react49.Suspense, { fallback: (0, import_jsx_runtime73.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime73.jsx)(AllWalletsUI, { onBack: handleBack, onSelect: setScreen, client: props.client, connectLocale: props.connectLocale, recommendedWallets: props.recommendedWallets, specifiedWallets: props.wallets, size: props.size }) });
  const getStarted = (0, import_jsx_runtime73.jsx)(StartScreen, { client: props.client, connectLocale: props.connectLocale, meta: props.meta, welcomeScreen: props.welcomeScreen });
  const goBack = props.wallets.length > 1 ? handleBack : void 0;
  const getWalletUI = (wallet) => {
    if (props.accountAbstraction) {
      return (0, import_jsx_runtime73.jsx)(SmartConnectUI, { accountAbstraction: props.accountAbstraction, done: (smartWallet) => {
    ...
    return (0, import_jsx_runtime73.jsx)(AnyWalletConnectUI, { wallet, onBack: goBack, done: () => {
  ...
  const signatureScreen = (0, import_jsx_runtime73.jsx)(SignatureScreen, { onDone: onClose, modalSize: props.size, termsOfServiceUrl: props.meta.termsOfServiceUrl, privacyPolicyUrl: props.meta.privacyPolicyUrl, auth: props.auth, client: props.client, connectLocale: props.connectLocale });
  return (0, import_jsx_runtime73.jsx)(ScreenSetupContext.Provider, { value: props.screenSetup, children: props.size === "wide" ? (0, import_jsx_runtime73.jsx)(ConnectModalWideLayout, { left: walletList, right: (0, import_jsx_runtime73.jsxs)(import_jsx_runtime73.Fragment, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && getStarted, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) }) : (0, import_jsx_runtime73.jsxs)(ConnectModalCompactLayout, { children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && walletList, screen === reservedScreens.getStarted && getStarted, screen === reservedScreens.showAll && showAll, typeof screen !== "string" && getWalletUI(screen)] }) });
};
...
function WalletSwitcherConnectionScreen(props) {
  ...
  return (0, import_jsx_runtime74.jsx)(ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: void 0, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, isEmbed: props.isEmbed, isOpen: true, meta: {
...
function WalletManagerScreen(props) {
  var _a;
  const [screen, setScreen] = (0, import_react50.useState)("wallets");
  const connectedWallets = useConnectedWallets();
  ...
  if (screen === "connect") {
    return (0, import_jsx_runtime75.jsx)(WalletSwitcherConnectionScreen, { ...props, isEmbed: false, onSelect: (w) => {
      setActive(w);
      props.onBack();
    } });
  }
  return (0, import_jsx_runtime75.jsxs)(Container, { children: [(0, import_jsx_runtime75.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime75.jsx)(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, import_jsx_runtime75.jsx)(Line, {}), (0, import_jsx_runtime75.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime75.jsx)(Container, { px: "md", style: {
    minHeight: "150px"
  }, children: (0, import_jsx_runtime75.jsx)(Container, { flex: "column", gap: "xs", children: connectedWallets.map((w) => {
    return (0, import_jsx_runtime75.jsx)(WalletManangerButton, {
      client: props.client,
      // address={address || ""}
      onClick: () => {
        setActive(w);
  ...
  }) }) }), (0, import_jsx_runtime75.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime75.jsx)(Container, { p: "lg", children: !hideConnectButton && (0, import_jsx_runtime75.jsxs)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    setScreen("connect");
  }, gap: "xs", children: [(0, import_jsx_runtime75.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }), "Connect Wallet"] }) })] });
}
function WalletManangerButton(props) {
  ...
  return (0, import_jsx_runtime75.jsxs)("div", { style: {
    position: "relative"
  }, children: [(0, import_jsx_runtime75.jsx)(WalletButtonEl, { onClick: props.onClick, style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime75.jsxs)(Container, { flex: "row", gap: "sm", center: "y", children: [(0, import_jsx_runtime75.jsx)(WalletImage, { client: props.client, id: walletId, size: iconSize.xl }), (0, import_jsx_runtime75.jsxs)("div", { children: [(0, import_jsx_runtime75.jsx)(Text, { color: "primaryText", children: shortenAddress(address || "") }), (0, import_jsx_runtime75.jsx)(Spacer, { y: "xxs" }), balanceQuery.data ? (0, import_jsx_runtime75.jsx)(Text, { size: "sm", color: "secondaryText", children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime75.jsx)(Skeleton, { width: "100px", height: fontSize.sm })] })] }) }), (0, import_jsx_runtime75.jsx)("div", { style: {
    position: "absolute",
    zIndex: 1,
    right: spacing.xxs,
    top: "50%",
    transform: "translateY(-50%)"
  }, children: (activeWallet == null ? void 0 : activeWallet.id) === props.wallet.id ? (0, import_jsx_runtime75.jsx)(ToolTip, { tip: "Active Wallet", children: (0, import_jsx_runtime75.jsx)(IconButton, { children: (0, import_jsx_runtime75.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }) }) : (0, import_jsx_runtime75.jsx)(ToolTip, { tip: "Disconnect", children: (0, import_jsx_runtime75.jsx)(IconButton, { onClick: () => {
    disconnect(props.wallet);
  }, children: (0, import_jsx_runtime75.jsx)(CrossCircledIcon, { width: iconSize.md, height: iconSize.md, style: {
...
var KeyIcon = (props) => {
  return (0, import_jsx_runtime76.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", role: "presentation", children: [(0, import_jsx_runtime76.jsx)("path", { d: "M2 5.99999L2 2.99999C2 2.39999 2.4 1.99999 3 1.99999H7L7 4.99999H10V7.99999H12L13.4 9.39999C14.7898 8.91585 16.3028 8.9177 17.6915 9.40524C19.0801 9.89278 20.2622 10.8372 21.0444 12.0839C21.8265 13.3306 22.1624 14.8058 21.9971 16.2683C21.8318 17.7307 21.1751 19.0937 20.1344 20.1344C19.0937 21.1751 17.7307 21.8318 16.2683 21.9971C14.8058 22.1624 13.3306 21.8265 12.0839 21.0444C10.8372 20.2622 9.89279 19.0801 9.40525 17.6915C8.91771 16.3028 8.91585 14.7898 9.4 13.4L2 5.99999Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime76.jsx)("path", { d: "M15.5 15C15.7761 15 16 15.2239 16 15.5C16 15.7761 15.7761 16 15.5 16C15.2239 16 15 15.7761 15 15.5C15 15.2239 15.2239 15 15.5 15Z", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function ManageWalletScreen(props) {
  ...
  return (0, import_jsx_runtime78.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime78.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime78.jsx)(ModalHeader, { title: props.locale.manageWallet.title, onBack: props.onBack }) }), (0, import_jsx_runtime78.jsx)(Line, {}), (0, import_jsx_runtime78.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime78.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime78.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [(0, import_jsx_runtime78.jsx)(SwitchMetamaskAccount, { closeModal: props.closeModal, connectLocale: props.locale }), (0, import_jsx_runtime78.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("wallet-connect-receiver");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime78.jsx)(WalletConnectIcon, { size: iconSize.md }), (0, import_jsx_runtime78.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.connectAnApp })] }), activeWallet && (isInAppWallet(activeWallet) && !((_a = activeWallet.getConfig()) == null ? void 0 : _a.hidePrivateKeyExport) || isEcosystemWallet(activeWallet)) && (0, import_jsx_runtime78.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("private-key");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime78.jsx)(KeyIcon, { size: iconSize.md }), (0, import_jsx_runtime78.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.exportPrivateKey })] })] }), (0, import_jsx_runtime78.jsx)(Spacer, { y: "lg" })] })] });
}
function SwitchMetamaskAccount(props) {
  ...
  return (0, import_jsx_runtime78.jsxs)(MenuButton, { type: "button", onClick: async () => {
    await injectedMetamaskProvider.request({
      method: "wallet_requestPermissions",
      params: [{ eth_accounts: {} }]
    });
    props.closeModal();
  }, children: [(0, import_jsx_runtime78.jsx)(ShuffleIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime78.jsx)(Text, { color: "primaryText", children: connectLocale.switchAccount })] });
}
...
function PrivateKey(props) {
  var _a;
  const [isLoading, setLoading] = (0, import_react51.useState)(true);
  if (!props.wallet) {
  ...
  return (0, import_jsx_runtime79.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime79.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime79.jsx)(ModalHeader, { title: "Export Private Key", onBack: props.onBack }) }), (0, import_jsx_runtime79.jsx)(Line, {}), (0, import_jsx_runtime79.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime79.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime79.jsxs)(Container, { style: { position: "relative", height: "250px" }, children: [isLoading ? (0, import_jsx_runtime79.jsx)(Container, { center: "both", flex: "column", style: { position: "absolute", width: "100%", height: "100%" }, children: (0, import_jsx_runtime79.jsx)(Spinner, { size: "lg", color: "primaryButtonBg" }) }) : (0, import_jsx_runtime79.jsx)(import_jsx_runtime79.Fragment, {}), (0, import_jsx_runtime79.jsx)(Container, { style: {
    position: "absolute",
    height: "100%",
    width: "100%",
    zIndex: 11
  }, children: (0, import_jsx_runtime79.jsx)("iframe", { title: "Export In-App Wallet", style: {
    width: "100%",
    height: "250px",
    visibility: isLoading ? "hidden" : "unset"
  }, onLoad: () => {
    setLoading(false);
  }, allow: "clipboard-read; clipboard-write", src: `${baseDomain.includes("localhost") ? "http" : "https"}://${baseDomain}/sdk/2022-08-12/embedded-wallet/export-private-key?clientId=${props.client.clientId}&theme=${typeof props.theme === "string" ? props.theme : props.theme.type}${ecosystem ? `&ecosystemId=${ecosystem.id}` : ""}${(ecosystem == null ? void 0 : ecosystem.partnerId) ? `&partnerId=${ecosystem.partnerId}` : ""}` }) })] }), (0, import_jsx_runtime79.jsx)(Spacer, { y: "lg" })] })] });
}
...
function ReceiveFunds(props) {
  ...
  return (0, import_jsx_runtime80.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime80.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime80.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime80.jsx)(QRCode, { qrCodeUri: address, size: 310, QRIcon: props.walletId && (0, import_jsx_runtime80.jsx)(WalletImage, { id: props.walletId, size: iconSize.xxl, client }) }) }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime80.jsxs)(WalletAddressContainer, { onClick: onCopy, children: [(0, import_jsx_runtime80.jsx)(Text, { color: "primaryText", size: "md", children: shortenString(address || "") }), (0, import_jsx_runtime80.jsx)(CopyIcon2, { text: address || "", tip: "Copy address", hasCopied })] }), (0, import_jsx_runtime80.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime80.jsx)(Text, { multiline: true, center: true, balance: true, children: locale.instruction })] });
}
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-OMBHT4NA.js");
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-SXCWJO2I.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-AQ4XP7OG.js");
...
function TokenSelector(props) {
  const [screen, setScreen] = (0, import_react52.useState)("base");
  const [input, setInput] = (0, import_react52.useState)("");
  ...
  if (screen === "select-chain" && chainSelection) {
    return (0, import_jsx_runtime81.jsx)(NetworkSelectorContent, {
      client: props.client,
      connectLocale: props.connectLocale,
      showTabs: false,
      ...
      networkSelector: {
        renderChain(renderChainProps) {
          return (0, import_jsx_runtime81.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
  ...
  return (0, import_jsx_runtime81.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime81.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime81.jsx)(ModalHeader, { onBack: props.onBack, title: props.modalTitle || locale.selectTokenTitle }) }), (0, import_jsx_runtime81.jsx)(Line, {}), (0, import_jsx_runtime81.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "450px"
  }, children: [(0, import_jsx_runtime81.jsx)(Spacer, { y: "md" }), props.chainSelection && (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, { children: (0, import_jsx_runtime81.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime81.jsx)(Text, { size: "sm", children: "Select Network" }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime81.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: () => {
    setScreen("select-chain");
  }, children: [(0, import_jsx_runtime81.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), chainNameQuery.name ? (0, import_jsx_runtime81.jsx)(Text, { color: "primaryText", size: "sm", children: chainNameQuery.name }) : (0, import_jsx_runtime81.jsx)(Skeleton, { height: fontSize.md }), (0, import_jsx_runtime81.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    marginLeft: "auto"
  } })] }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime81.jsx)(Text, { size: "sm", children: "Select Token" })] }) }), (0, import_jsx_runtime81.jsxs)(Container, { px: "lg", children: [(0, import_jsx_runtime81.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime81.jsx)(Input, { placeholder: locale.searchToken, variant: "outline", value: input, onChange: (e) => {
    setInput(e.target.value);
  } })] }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "md" }), (filteredList.length > 0 || !input) && (0, import_jsx_runtime81.jsxs)(Container, { flex: "column", gap: "xs", px: "lg", scrollY: true, style: {
    paddingTop: 0,
    paddingBottom: spacing.lg
    // maxHeight: props.chainSelection ? "300px" : "400px",
  }, children: [!input && (0, import_jsx_runtime81.jsx)(SelectTokenButton, { onClick: () => {
    props.onTokenSelect(NATIVE_TOKEN);
  }, chain: props.chain, token: NATIVE_TOKEN, client: props.client }), filteredList.map((token) => {
    return (0, import_jsx_runtime81.jsx)(SelectTokenButton, { onClick: () => props.onTokenSelect(token), token, chain: props.chain, client: props.client }, token.address);
  })] }), filteredList.length === 0 && tokenQuery.isLoading && input && (0, import_jsx_runtime81.jsx)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: (0, import_jsx_runtime81.jsx)(Spinner, { size: "lg", color: "accentText" }) }), filteredList.length === 0 && !tokenQuery.isLoading && input && (0, import_jsx_runtime81.jsxs)(Container, { animate: "fadein", p: "lg", flex: "column", gap: "md", center: "both", style: {
    minHeight: "200px",
    paddingTop: 0
  }, color: "secondaryText", children: [(0, import_jsx_runtime81.jsx)(CrossCircledIcon, { width: iconSize.lg, height: iconSize.lg }), locale.noTokensFound] }), (0, import_jsx_runtime81.jsx)(Spacer, { y: "md" })] })] });
}
function SelectTokenButton(props) {
  ...
  return (0, import_jsx_runtime81.jsxs)(SelectTokenBtn, { fullWidth: true, variant: "secondary", onClick: props.onClick, children: [(0, import_jsx_runtime81.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime81.jsxs)(Container, { flex: "column", gap: "xxs", children: [tokenName ? (0, import_jsx_runtime81.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime81.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), account && (0, import_jsx_runtime81.jsx)(TokenBalance, { account, chain: props.chain, client: props.client, tokenAddress: isNativeToken(props.token) ? void 0 : props.token.address })] })] });
}
function TokenBalance(props) {
  ...
  if (tokenBalanceQuery.data) {
    return (0, import_jsx_runtime81.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] });
  }
  return (0, import_jsx_runtime81.jsx)(Skeleton, { height: fontSize.xs, width: "100px" });
}
...
function SendFunds(props) {
  const [screen, setScreen] = (0, import_react53.useState)("base");
  const activeChain = useActiveWalletChain();
  ...
  const [token, setToken] = (0, import_react53.useState)(defaultToken);
  const [receiverAddress, setReceiverAddress] = (0, import_react53.useState)("");
  const [amount, setAmount] = (0, import_react53.useState)("0");
  const chain = useActiveWalletChain();
  const tokenList = ((chain == null ? void 0 : chain.id) ? supportedTokens[chain.id] : void 0) || [];
  if (screen === "tokenSelector" && chain) {
    return (0, import_jsx_runtime82.jsx)(TokenSelector, { tokenList, onBack: () => {
      setScreen("base");
  ...
  return (0, import_jsx_runtime82.jsx)(SendFundsForm, { token, onTokenSelect: () => {
...
function SendFundsForm(props) {
  ...
  if (sendTokenMutation.isError) {
    return (0, import_jsx_runtime82.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime82.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime82.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "200px"
    }, color: "danger", children: [(0, import_jsx_runtime82.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime82.jsx)(Text, { center: true, multiline: true, color: "danger", children: getErrorMessage(sendTokenMutation.error) })] })] });
  }
  if (sendTokenMutation.isSuccess) {
    return (0, import_jsx_runtime82.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime82.jsx)(ModalHeader, { title: locale.title, onBack: () => {
      sendTokenMutation.reset();
    } }), (0, import_jsx_runtime82.jsxs)(Container, { flex: "column", gap: "lg", animate: "fadein", center: "both", style: {
      minHeight: "250px"
    }, color: "success", children: [(0, import_jsx_runtime82.jsx)(CheckCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime82.jsxs)(Text, { color: "success", children: [" ", locale.successMessage, " "] })] })] });
  }
  ...
  return (0, import_jsx_runtime82.jsxs)(Container, { p: "lg", animate: "fadein", children: [(0, import_jsx_runtime82.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime82.jsxs)("form", { onSubmit: (e) => {
    e.preventDefault();
  }, children: [(0, import_jsx_runtime82.jsx)(Label, { htmlFor: "token", color: "secondaryText", children: locale.token }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime82.jsxs)(Button, { id: "token", variant: "outline", fullWidth: true, style: {
    justifyContent: "flex-start",
    gap: spacing.sm,
    padding: spacing.sm
  }, onClick: props.onTokenSelect, children: [(0, import_jsx_runtime82.jsx)(TokenIcon, { token: props.token, chain: activeChain, size: "lg", client: props.client }), (0, import_jsx_runtime82.jsxs)(Container, { flex: "column", gap: "xs", children: [tokenName ? (0, import_jsx_runtime82.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: fontSize.xs, width: "150px" }), balanceQuery.data ? (0, import_jsx_runtime82.jsx)(Text, { size: "xs", children: formatTokenBalance(balanceQuery.data) }) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime82.jsx)(Label, { htmlFor: "receiver", color: "secondaryText", children: locale.sendTo }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime82.jsx)(Input, { required: true, id: "receiver", placeholder: "0x... or ENS name", variant: "outline", value: receiverAddress, onChange: (e) => {
    setReceiverAddress(e.target.value);
  } }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime82.jsx)(Label, { htmlFor: "amount", color: "secondaryText", children: locale.amount }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime82.jsxs)(Container, { relative: true, children: [(0, import_jsx_runtime82.jsx)(Input, { required: true, type: "number", id: "amount", variant: "outline", value: amount, onChange: (e) => {
    setAmount(e.target.value);
  } }), (0, import_jsx_runtime82.jsx)(CurrencyBadge, { children: (0, import_jsx_runtime82.jsxs)(Text, { size: "xs", children: [" ", tokenSymbol, " "] }) })] }), (0, import_jsx_runtime82.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime82.jsxs)(Button, { fullWidth: true, variant: "accent", type: "submit", onClick: async () => {
    ...
    gap: spacing.sm,
    padding: spacing.md
  }, children: [sendTokenMutation.isPending && (0, import_jsx_runtime82.jsx)(Spinner, { size: "sm", color: "accentButtonText" }), sendTokenMutation.isPending ? locale.sending : locale.submitButton] })] })] });
}
...
var ImageIcon = (props) => {
  return (0, import_jsx_runtime83.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", role: "presentation", children: [(0, import_jsx_runtime83.jsx)("rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2" }), (0, import_jsx_runtime83.jsx)("circle", { cx: "9", cy: "9", r: "2" }), (0, import_jsx_runtime83.jsx)("path", { d: "m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" })] });
};
...
async function isTokensOfOwnerSupported(contract) {
  return detectMethod({
    contract,
...
async function isTokenOfOwnerByIndexSupported(contract) {
  return detectMethod({
    contract,
...
async function getOwnedTokenIds(options) {
  ...
  const supportsTokensOfOwnerByIndex = await isTokenOfOwnerByIndexSupported(options.contract);
  ...
  const supportsTokensOfOwner = await isTokensOfOwnerSupported(options.contract);
  if (supportsTokensOfOwner) {
    return (await tokensOfOwner({ ...options })).map((token) => token);
  }
...
var CarbonDocumentUnknown = (props) => {
  return (0, import_jsx_runtime84.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime84.jsx)("circle", { cx: "9", cy: "28.5", r: "1.5", fill: "currentColor" }), (0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "M10 25H8v-4h2a2 2 0 0 0 0-4H8a2.002 2.002 0 0 0-2 2v.5H4V19a4.005 4.005 0 0 1 4-4h2a4 4 0 0 1 0 8Z" }), (0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "m27.7 9.3l-7-7A.908.908 0 0 0 20 2H10a2.006 2.006 0 0 0-2 2v8h2V4h8v6a2.006 2.006 0 0 0 2 2h6v16H14v2h12a2.006 2.006 0 0 0 2-2V10a.91.91 0 0 0-.3-.7ZM20 10V4.4l5.6 5.6Z" })] });
};
var CarbonDocumentAudio = (props) => {
  return (0, import_jsx_runtime84.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: [(0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "M29 31a.999.999 0 0 1-.625-.22L23.65 27H20a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h3.65l4.726-3.78A1 1 0 0 1 30 17v13a1 1 0 0 1-1 1Zm-8-6h3a1 1 0 0 1 .625.22L28 27.92v-8.84l-3.376 2.7A1 1 0 0 1 24 22h-3Z" }), (0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "M16 28H8V4h8v6a2.006 2.006 0 0 0 2 2h6v3h2v-5a.91.91 0 0 0-.3-.7l-7-7A.909.909 0 0 0 18 2H8a2.006 2.006 0 0 0-2 2v24a2.006 2.006 0 0 0 2 2h8Zm2-23.6l5.6 5.6H18Z" })] });
};
var CarbonPauseFilled = (props) => {
  return (0, import_jsx_runtime84.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "M12 6h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zm10 0h-2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" }) });
};
var CarbonPlayFilledAlt = (props) => {
  return (0, import_jsx_runtime84.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 32 32", role: "presentation", ...props, children: (0, import_jsx_runtime84.jsx)("path", { fill: "currentColor", d: "M7 28a1 1 0 0 1-1-1V5a1 1 0 0 1 1.482-.876l20 11a1 1 0 0 1 0 1.752l-20 11A1 1 0 0 1 7 28Z" }) });
};
...
function useResolvedMediaType(client, uri, mimeType, gatewayUrl) {
  const resolvedUrl = (0, import_react54.useMemo)(() => {
    if (!uri) {
      return "";
    }
...
// node_modules/thirdweb/dist/esm/react/web/ui/MediaRenderer/MediaRenderer.js
var MediaRenderer = (() => import_react55.default.forwardRef(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className }, ref) {
  var _a;
  const mergedStyle = {
    objectFit: "contain",
    ...style
  ...
  if (!mediaInfoIsFetched || !src) {
    return (0, import_jsx_runtime85.jsx)("div", { style });
  }
  if (mediaInfo.mimeType) {
    if (mediaInfo.mimeType.startsWith("text/html")) {
      return (0, import_jsx_runtime85.jsx)(IframePlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, ref, requireInteraction, className, alt });
    }
    if (mediaInfo.mimeType.startsWith("model")) {
      return (0, import_jsx_runtime85.jsx)(import_react55.Suspense, { fallback: poster ? (0, import_jsx_runtime85.jsx)("img", { style: mergedStyle, src: poster, alt, ref, className }) : null, children: (0, import_jsx_runtime85.jsx)(ModelViewer, { style: mergedStyle, src: mediaInfo.url || "", poster, alt, className }) });
    }
    if (mediaInfo.mimeType.startsWith("video")) {
      return (0, import_jsx_runtime85.jsx)(VideoPlayer, { style: mergedStyle, src: mediaInfo.url, ref, poster: ((_a = possiblePosterSrc.mimeType) == null ? void 0 : _a.startsWith("image/")) ? possiblePosterSrc.url : void 0, requireInteraction, className, controls });
    }
    if (mediaInfo.mimeType.startsWith("audio")) {
      return (0, import_jsx_runtime85.jsx)(AudioPlayer, { style: mergedStyle, src: mediaInfo.url, poster: possiblePosterSrc.url, alt, ref, className, height, width, controls });
    }
    if (mediaInfo.mimeType.startsWith("image/")) {
      return (0, import_jsx_runtime85.jsx)(ImageRenderer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className, height, width });
    }
  }
  return (0, import_jsx_runtime85.jsx)(LinkPlayer, { style: mergedStyle, src: mediaInfo.url, alt, ref, className });
}))();
var ModelViewer = (0, import_react55.lazy)(() => import("./ModelViewer-J5HOYDVZ.js"));
var PlayButton = ({ onClick, isPlaying }) => {
  const [isHovering, setIsHovering] = (0, import_react55.useState)(false);
  const onMouseEnter = () => setIsHovering(true);
  const onMouseLeave = () => setIsHovering(false);
  const onMouseDown = () => setIsHovering(false);
  const onMouseUp = () => setIsHovering(true);
  return (0, import_jsx_runtime85.jsx)("button", { type: "button", style: {
    position: "absolute",
    bottom: 0,
    right: 0,
  ...
  }, onClick, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp, children: !isPlaying ? (0, import_jsx_runtime85.jsx)(CarbonPlayFilledAlt, {}) : (0, import_jsx_runtime85.jsx)(CarbonPauseFilled, {}) });
};
var ImageRenderer = (() => import_react55.default.forwardRef(function Image_Renderer(props, ref) {
  const { style, src, alt, className, height, width } = props;
  const [error, setError] = (0, import_react55.useState)(false);
  if (error) {
    return (0, import_jsx_runtime85.jsx)(LinkPlayer, { style, src, alt, ref, className });
  }
  return (0, import_jsx_runtime85.jsx)("img", { style, src: src ?? void 0, alt, ref, className, height, width, onError: () => {
    setError(true);
  } });
}))();
var VideoPlayer = (() => import_react55.default.forwardRef(function Video_Player({ src, alt, poster, requireInteraction, style, width, height, controls, className }, ref) {
  const videoRef = (0, import_react55.useRef)(null);
  const [playing, setPlaying] = (0, import_react55.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react55.useState)(true);
  const [error, setError] = (0, import_react55.useState)(false);
  ...
  return (0, import_jsx_runtime85.jsxs)("div", { style: { position: "relative", ...style }, className, children: [(0, import_jsx_runtime85.jsx)("video", { ref: mergeRefs2([videoRef, ref]), src: src ?? void 0, poster: poster ?? void 0, loop: true, playsInline: true, controlsList: "nodownload", muted, preload: poster ? "metadata" : "auto", onCanPlay: () => {
    var _a;
    if (playing) {
  ...
  } }), poster && (0, import_jsx_runtime85.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
    ...
    right: 0,
    bottom: 0
  }, alt }), (0, import_jsx_runtime85.jsx)(PlayButton, { onClick: () => {
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing })] });
}))();
var AudioPlayer = (() => import_react55.default.forwardRef(function Audio_Player({ src, alt, poster, style, height, width, className, controls }, ref) {
  const audioRef = (0, import_react55.useRef)(null);
  ...
  return (0, import_jsx_runtime85.jsxs)("div", { style: { position: "relative", ...style }, className, children: [poster ? (0, import_jsx_runtime85.jsx)("img", { height, width, src: poster, style: {
    height: "100%",
    width: "100%",
    pointerEvents: "none",
    objectFit: "contain"
  }, alt }) : (0, import_jsx_runtime85.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    ...
    backgroundColor: "#fff",
    color: "rgb(138, 147, 155)"
  }, children: (0, import_jsx_runtime85.jsx)(CarbonDocumentAudio, { style: { height: "64px", width: "64px" } }) }), (0, import_jsx_runtime85.jsx)(PlayButton, { onClick: () => {
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing }), (0, import_jsx_runtime85.jsx)("audio", { ref: mergeRefs2([audioRef, ref]), src: src ?? void 0, loop: true, playsInline: true, controls, muted, preload: "none", controlsList: "nodownload", style: {
    position: "absolute",
    opacity: 0,
    pointerEvents: "none",
    zIndex: -1,
...
var IframePlayer = (() => import_react55.default.forwardRef(function Iframe_Player({ src, alt, poster, requireInteraction, style, ...restProps }, ref) {
  const [playing, setPlaying] = (0, import_react55.useState)(!requireInteraction);
  return (0, import_jsx_runtime85.jsxs)("div", { style: { position: "relative", ...style }, ...restProps, children: [(0, import_jsx_runtime85.jsx)("iframe", { title: alt || "thirdweb iframe player", src: playing ? src ?? void 0 : void 0, ref, style: {
    objectFit: "contain",
    zIndex: 1,
    height: "100%",
    width: "100%",
    ...
    opacity: !poster ? 1 : playing ? 1 : 0,
    border: "none"
  }, sandbox: "allow-scripts", allow: "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" }), poster && (0, import_jsx_runtime85.jsx)("img", { src: poster, style: {
    objectFit: "contain",
    pointerEvents: "none",
    position: "absolute",
    width: "100%",
...
var LinkPlayer = (() => import_react55.default.forwardRef(function Link_Player({ src, alt, style, className }, ref) {
  return (0, import_jsx_runtime85.jsx)("div", { style: { position: "relative", ...style }, className, children: (0, import_jsx_runtime85.jsx)("div", { style: {
    width: "100%",
    height: "100%",
    display: "grid",
    placeItems: "center",
    backgroundColor: "#fff",
    color: "rgb(138, 147, 155)"
  }, children: (0, import_jsx_runtime85.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: "8px",
    alignItems: "center",
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime85.jsx)(CarbonDocumentUnknown, { style: {
    maxWidth: "128px",
    minWidth: "48px",
    width: "50%",
    aspectRatio: "1"
  } }), (0, import_jsx_runtime85.jsx)("a", { rel: "noopener noreferrer", style: {
...
function ViewNFTs(props) {
  return (0, import_jsx_runtime86.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime86.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime86.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.viewNFTs, onBack: props.onBack }) }), (0, import_jsx_runtime86.jsx)(Line, {}), (0, import_jsx_runtime86.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime86.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime86.jsx)(ViewNFTsContent, { ...props })] })] });
}
function ViewNFTsContent(props) {
  ...
  const nftList = (0, import_react56.useMemo)(() => {
    const nfts = [];
  ...
  const results = useQueries({
    queries: nftList.map((nft) => ({
      ...
      queryFn: () => fetchNFTs(props.client, nft.chain, nft.address, activeAccount == null ? void 0 : activeAccount.address)
    }))
  });
  return (0, import_jsx_runtime86.jsxs)(import_jsx_runtime86.Fragment, { children: [(0, import_jsx_runtime86.jsx)(Container, { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: "12px"
    ...
    return result.isLoading || !result.data ? (0, import_jsx_runtime86.jsx)(Skeleton, { height: "150px", width: "150px" }, `${(_b = (_a = nftList[index2]) == null ? void 0 : _a.chain) == null ? void 0 : _b.id}:${(_c = nftList[index2]) == null ? void 0 : _c.address}`) : result.data.map((nft) => (0, import_jsx_runtime86.jsx)(NftCard, { ...nft, client: props.client, chain: nft.chain, theme: props.theme }, `${nft.chain.id}:${nft.address}:${nft.id}`));
  }) }), (0, import_jsx_runtime86.jsx)(Spacer, { y: "lg" })] });
}
function NftCard(props) {
  ...
  const content = (0, import_jsx_runtime86.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: "4px",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime86.jsxs)("div", { style: {
    position: "relative",
    display: "flex",
    flexShrink: 0,
    alignItems: "center",
  ...
  }, children: [props.metadata.image && (0, import_jsx_runtime86.jsx)(MediaRenderer, { src: props.metadata.image, style: {
    width: "100%",
    height: "100%"
  }, client: props.client }), props.quantityOwned > 1 && (0, import_jsx_runtime86.jsx)("div", { style: {
    position: "absolute",
    bottom: "4px",
    right: "4px",
    ...
    justifyContent: "center",
    borderRadius: "100%"
  }, children: props.quantityOwned.toString() }), props.chain.icon && (0, import_jsx_runtime86.jsx)("img", { alt: props.chain.name, style: {
    position: "absolute",
    bottom: "4px",
    left: "4px",
    width: "20px",
    height: "20px"
  }, src: props.chain.icon.url })] }), (0, import_jsx_runtime86.jsx)("span", { style: { fontWeight: 600 }, children: props.metadata.name })] });
  if (props.chain.name) {
    return (0, import_jsx_runtime86.jsx)("a", { href: `https://thirdweb.com/${props.chain.id}/${props.address}/nfts/${props.id}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function ViewTokens(props) {
  return (0, import_jsx_runtime87.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime87.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime87.jsx)(ModalHeader, { title: props.connectLocale.viewFunds.title, onBack: props.onBack }) }), (0, import_jsx_runtime87.jsx)(Line, {}), (0, import_jsx_runtime87.jsxs)(Container, { px: "sm", scrollY: true, style: {
    maxHeight: "500px"
  }, children: [(0, import_jsx_runtime87.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime87.jsx)(ViewTokensContent, { ...props }), (0, import_jsx_runtime87.jsx)(Spacer, { y: "lg" })] })] });
}
function ViewTokensContent(props) {
  ...
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime87.Fragment, { children: [(0, import_jsx_runtime87.jsx)(TokenInfo, { token: NATIVE_TOKEN, chain: activeChain, client: props.client }), tokenList.map((token) => {
    return (0, import_jsx_runtime87.jsx)(TokenInfo, { token, chain: activeChain, client: props.client }, token.address);
  })] });
}
function TokenInfo(props) {
  ...
  return (0, import_jsx_runtime87.jsxs)(Container, { flex: "row", gap: "sm", p: "sm", children: [(0, import_jsx_runtime87.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "lg", client: props.client }), (0, import_jsx_runtime87.jsxs)(Container, { flex: "column", gap: "xxs", children: [tokenName ? (0, import_jsx_runtime87.jsx)(Text, { size: "sm", color: "primaryText", children: tokenName }) : (0, import_jsx_runtime87.jsx)(Skeleton, { height: fontSize.md, width: "150px" }), tokenBalanceQuery.data ? (0, import_jsx_runtime87.jsxs)(Text, { size: "xs", children: [" ", formatTokenBalance(tokenBalanceQuery.data)] }) : (0, import_jsx_runtime87.jsx)(Skeleton, { height: fontSize.xs, width: "100px" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/ViewAssets.js
function ViewAssets(props) {
  const [activeTab, setActiveTab] = (0, import_react57.useState)("Tokens");
  const { connectLocale } = props;
  return (0, import_jsx_runtime88.jsxs)(Container, { animate: "fadein", style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime88.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime88.jsx)(ModalHeader, { title: connectLocale.viewFunds.title, onBack: props.onBack }) }), (0, import_jsx_runtime88.jsx)(Line, {}), (0, import_jsx_runtime88.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime88.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime88.jsx)(Tabs, { options: [
    {
      label: (0, import_jsx_runtime88.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime88.jsx)(CoinsIcon, { size: iconSize.sm }), " Tokens"] }),
      value: "Tokens"
    },
    {
      label: (0, import_jsx_runtime88.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime88.jsx)(ImageIcon, { size: iconSize.sm }), " NFTs"] }),
      value: "NFTs"
    }
  ], selected: activeTab, onSelect: setActiveTab, children: (0, import_jsx_runtime88.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "300px"
  }, children: [activeTab === "Tokens" && (0, import_jsx_runtime88.jsx)(ViewTokensContent, { client: props.client, connectLocale, supportedTokens: props.supportedTokens }), activeTab === "NFTs" && (0, import_jsx_runtime88.jsx)(ViewNFTsContent, { supportedNFTs: props.supportedNFTs, client: props.client, theme: props.theme, connectLocale })] }) }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "lg" })] })] });
}
...
function WalletConnectDisconnectScreen(props) {
  return (0, import_jsx_runtime89.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime89.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime89.jsx)(ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, import_jsx_runtime89.jsx)(Line, {}), (0, import_jsx_runtime89.jsx)(Container, { px: "lg", scrollY: true, style: {
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime89.jsxs)(Container, { py: "lg", style: { position: "relative" }, children: [(0, import_jsx_runtime89.jsx)(Container, { py: "md", children: (0, import_jsx_runtime89.jsx)(WalletLogoSpinner, { client: props.client, error: !!props.error, id: "walletConnect", hideSpinner: true }) }), (0, import_jsx_runtime89.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !props.error ? (0, import_jsx_runtime89.jsxs)(import_jsx_runtime89.Fragment, { children: [(0, import_jsx_runtime89.jsxs)(Text, { balance: true, center: true, multiline: true, size: "md", children: ["Connected to ", props.session.origin ?? "another app."] }), (0, import_jsx_runtime89.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime89.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.disconnect();
  }, children: "Disconnect" })] }) : (0, import_jsx_runtime89.jsxs)(import_jsx_runtime89.Fragment, { children: [(0, import_jsx_runtime89.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: props.error }), (0, import_jsx_runtime89.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime89.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime89.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => props.disconnect(), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime89.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), " ", "Retry"] }) })] }) })] }) })] });
}
...
function WalletConnectReceiverScreen(props) {
  ...
  const [errorConnecting, setErrorConnecting] = (0, import_react58.useState)(false);
  const queryClient = useQueryClient();
  ...
  if (session) {
    return (0, import_jsx_runtime90.jsx)(WalletConnectDisconnectScreen, { disconnect, error: errorConnecting, ...props, session });
  }
  return (0, import_jsx_runtime90.jsxs)(Container, { style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime90.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime90.jsx)(ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, import_jsx_runtime90.jsx)(Line, {}), (0, import_jsx_runtime90.jsx)(Container, { px: "lg", scrollY: true, style: {
    maxHeight: "500px"
  }, children: (0, import_jsx_runtime90.jsxs)(Container, { py: "sm", style: { position: "relative" }, children: [(0, import_jsx_runtime90.jsx)(Container, { py: "md", children: (0, import_jsx_runtime90.jsx)(WalletLogoSpinner, { client: props.client, error: !!errorConnecting, id: "walletConnect", hideSpinner: !loading }) }), (0, import_jsx_runtime90.jsx)(Container, { animate: "fadein", style: {
    animationDuration: "200ms"
  }, children: !errorConnecting ? (0, import_jsx_runtime90.jsxs)(import_jsx_runtime90.Fragment, { children: [(0, import_jsx_runtime90.jsx)(Text, { balance: true, center: true, multiline: true, size: "sm", children: "Copy your connection URI from the external app." }), (0, import_jsx_runtime90.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime90.jsx)(InputSelectionUI, { type: "text", disabled: loading || !!errorConnecting || !walletConnectClient, onSelect: async (value) => {
    setLoading(true);
    if (!walletConnectClient) {
  ...
  }, placeholder: "WalletConnect URI", name: "wcUri", emptyErrorMessage: "Please enter a valid URI", submitButtonText: "Connect" })] }) : (0, import_jsx_runtime90.jsxs)(import_jsx_runtime90.Fragment, { children: [(0, import_jsx_runtime90.jsx)(Text, { center: true, balance: true, multiline: true, size: "sm", children: errorConnecting }), (0, import_jsx_runtime90.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime90.jsx)(Container, { flex: "row", center: "x", animate: "fadein", children: (0, import_jsx_runtime90.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => setErrorConnecting(false), style: {
    gap: spacing.xs,
    alignItems: "center"
  }, children: [(0, import_jsx_runtime90.jsx)(ReloadIcon, { width: iconSize.sm, height: iconSize.sm }), " ", "Retry"] }) })] }) })] }) }), (0, import_jsx_runtime90.jsxs)(Container, { children: [(0, import_jsx_runtime90.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime90.jsx)(Line, {}), (0, import_jsx_runtime90.jsx)(Container, { flex: "row", center: "x", p: "lg", children: (0, import_jsx_runtime90.jsx)("a", { href: "https://blog.thirdweb.com/p/a62c0ef4-1d8f-424d-95b9-a006e5239849/", children: (0, import_jsx_runtime90.jsx)(Button, { variant: "link", onClick: () => {
...
var ConnectedWalletDetails = (props) => {
  ...
  const setRootEl = (0, import_react59.useContext)(SetRootElementContext);
  const activeWallet = useActiveWallet();
  const activeAccount = useActiveAccount();
  ...
  if ((_b = props.detailsButton) == null ? void 0 : _b.render) {
    return (
      ...
      (0, import_jsx_runtime91.jsx)("div", { onClick: openModal, children: (0, import_jsx_runtime91.jsx)(props.detailsButton.render, {}) })
    );
  }
  if (props.chain && isNetworkMismatch) {
    return (0, import_jsx_runtime91.jsx)(SwitchNetworkButton2, { style: (_c = props.switchButton) == null ? void 0 : _c.style, className: (_d = props.switchButton) == null ? void 0 : _d.className, switchNetworkBtnTitle: (_e = props.switchButton) == null ? void 0 : _e.label, targetChain: props.chain, connectLocale: locale });
  }
  return (0, import_jsx_runtime91.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${((_f = props.detailsButton) == null ? void 0 : _f.className) || ""}`, style: (_g = props.detailsButton) == null ? void 0 : _g.style, "data-test": "connected-wallet-details", onClick: openModal, children: [ensAvatarQuery.data ? (0, import_jsx_runtime91.jsx)(Img, { src: ensAvatarQuery.data, width: iconSize.lg, height: iconSize.lg, style: {
    borderRadius: radius.sm
  }, client }) : (activeWallet == null ? void 0 : activeWallet.id) ? (0, import_jsx_runtime91.jsx)(WalletImage, { size: iconSize.lg, id: activeWallet.id, client }) : (0, import_jsx_runtime91.jsx)(GenericWalletIcon, { size: iconSize.lg }), (0, import_jsx_runtime91.jsxs)(Container, { flex: "column", gap: "xxs", children: [addressOrENS ? (0, import_jsx_runtime91.jsx)(Text, { size: "sm", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: addressOrENS }) : (0, import_jsx_runtime91.jsx)(Skeleton, { height: fontSize.sm, width: "88px" }), balanceQuery.data ? (0, import_jsx_runtime91.jsxs)(Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", weight: 500, children: [Number(balanceQuery.data.displayValue).toFixed(3), " ", balanceQuery.data.symbol] }) : (0, import_jsx_runtime91.jsx)(Skeleton, { height: fontSize.xs, width: "82px" })] })] });
};
function DetailsModal(props) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n;
  const [screen, setScreen] = (0, import_react59.useState)("main");
  const { disconnect } = useDisconnect();
  const [isOpen, setIsOpen] = (0, import_react59.useState)(true);
  ...
  const networkSwitcherButton = (0, import_jsx_runtime91.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
    setScreen("network-switcher");
  }, "data-variant": "primary", children: [(0, import_jsx_runtime91.jsx)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: !chainIconQuery.isLoading ? (0, import_jsx_runtime91.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.md, active: true, client }) : (0, import_jsx_runtime91.jsx)(Skeleton, { height: `${iconSize.md}px`, width: `${iconSize.md}px` }) }), chainNameQuery.isLoading ? (0, import_jsx_runtime91.jsx)(Skeleton, { height: "16px", width: "150px" }) : (0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", multiline: true, children: chainNameQuery.name || `Unknown chain #${walletChain == null ? void 0 : walletChain.id}` }), (0, import_jsx_runtime91.jsx)(StyledChevronRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    flexShrink: 0,
    marginLeft: "auto"
  } })] });
  let content = (0, import_jsx_runtime91.jsxs)("div", { children: [(0, import_jsx_runtime91.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime91.jsx)(IconButton, { style: {
    position: "absolute",
    top: spacing.lg,
    left: spacing.lg,
    transform: "translateX(-6px)"
  ...
  }, children: (0, import_jsx_runtime91.jsx)("div", { style: {
    width: `${iconSize.md}px`,
    height: `${iconSize.md}px`,
    display: "flex",
    alignItems: "center",
    justifyContent: "center"
  }, children: (0, import_jsx_runtime91.jsx)(ShuffleIconLucide, { size: "20" }) }) }), (0, import_jsx_runtime91.jsxs)(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (0, import_jsx_runtime91.jsx)(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
    borderRadius: radius.lg
  }, client }) : (activeWallet == null ? void 0 : activeWallet.id) ? (0, import_jsx_runtime91.jsx)(WalletImage, { size: iconSize.xxl, id: activeWallet.id, client }) : (0, import_jsx_runtime91.jsx)(GenericWalletIcon, { size: iconSize.xxl }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime91.jsx)(ConnectedToSmartWallet, { client: props.client, connectLocale: locale }), ((activeWallet == null ? void 0 : activeWallet.id) === "embedded" || (activeWallet == null ? void 0 : activeWallet.id) === "inApp") && (0, import_jsx_runtime91.jsx)(InAppWalletUserInfo, { client: props.client }), (0, import_jsx_runtime91.jsxs)("div", { style: {
    display: "flex",
    gap: spacing.xxs,
    alignItems: "center",
    transform: "translateX(10px)"
  }, "data-test": "connected-wallet-address", "data-address": activeAccount == null ? void 0 : activeAccount.address, children: [(0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", weight: 500, size: "md", children: addressOrENS }), (0, import_jsx_runtime91.jsx)(IconButton, { style: {
    padding: "3px"
  }, "data-test": "copy-address", children: (0, import_jsx_runtime91.jsx)(CopyIcon2, { text: (activeAccount == null ? void 0 : activeAccount.address) || "", tip: locale.copyAddress, side: "top" }) })] }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime91.jsxs)(Text, { weight: 500, size: "sm", children: [balanceQuery.data ? Number(balanceQuery.data.displayValue).toFixed(3) : (0, import_jsx_runtime91.jsx)(Skeleton, { height: "1em", width: "100px" }), " ", (_a = balanceQuery.data) == null ? void 0 : _a.symbol, " "] })] }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime91.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime91.jsxs)(Container, { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr 1fr",
    gap: spacing.xs
  }, children: [(0, import_jsx_runtime91.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("send");
  }, children: [(0, import_jsx_runtime91.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime91.jsx)(PaperPlaneIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "translateY(-10%) rotate(-45deg) "
  } }) }), locale.send] }), (0, import_jsx_runtime91.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("receive");
  }, children: [(0, import_jsx_runtime91.jsxs)(Container, { color: "secondaryText", flex: "row", center: "both", children: [(0, import_jsx_runtime91.jsx)(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }), " "] }), locale.receive, " "] }), (0, import_jsx_runtime91.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("buy");
  }, children: [(0, import_jsx_runtime91.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime91.jsx)(PlusIcon, { width: iconSize.sm, height: iconSize.sm }) }), locale.buy] })] }) }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime91.jsxs)(Container, { px: "md", children: [(0, import_jsx_runtime91.jsxs)(Container, { flex: "column", style: {
    gap: "1px"
  }, children: [networkSwitcherButton, (0, import_jsx_runtime91.jsxs)(MenuButton, { onClick: () => {
    setScreen("transactions");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime91.jsx)(TextAlignJustifyIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime91.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", children: locale.transactions }) })] }), (0, import_jsx_runtime91.jsxs)(MenuButton, { onClick: () => {
    setScreen("view-assets");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime91.jsx)(CoinsIcon, { size: iconSize.md }), (0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", children: props.supportedNFTs ? locale.viewFunds.viewAssets : locale.viewFunds.title })] }), (0, import_jsx_runtime91.jsxs)(MenuButton, { onClick: () => {
    setScreen("manage-wallet");
  }, style: {
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime91.jsx)(OutlineWalletIcon, { size: iconSize.md }), (0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.title })] }), (((_b = props.detailsModal) == null ? void 0 : _b.showTestnetFaucet) ?? false) && (chainFaucetsQuery.faucets.length > 0 || (walletChain == null ? void 0 : walletChain.id) === LocalhostChainId) && (0, import_jsx_runtime91.jsxs)(MenuLink, { href: chainFaucetsQuery.faucets ? chainFaucetsQuery.faucets[0] : "#", target: "_blank", as: "a", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: [(0, import_jsx_runtime91.jsx)(Container, { flex: "row", center: "both", color: "secondaryText", children: (0, import_jsx_runtime91.jsx)(FundsIcon, { size: iconSize.md }) }), locale.requestTestnetFunds] }), ((_c = props.detailsModal) == null ? void 0 : _c.footer) && (0, import_jsx_runtime91.jsx)(props.detailsModal.footer, { close: closeModal })] }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "md" })] }), ((_d = props.detailsModal) == null ? void 0 : _d.hideDisconnect) !== true && (0, import_jsx_runtime91.jsxs)(Container, { children: [(0, import_jsx_runtime91.jsx)(Line, {}), (0, import_jsx_runtime91.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime91.jsx)(Container, { px: "md", children: (0, import_jsx_runtime91.jsxs)(MenuButton, { "data-variant": "danger", type: "button", onClick: () => {
  ...
  }, children: [(0, import_jsx_runtime91.jsx)(ExitIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime91.jsx)(Text, { color: "primaryText", children: locale.disconnectWallet })] }) }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "sm" })] })] });
  if (screen === "transactions") {
    content = (0, import_jsx_runtime91.jsx)(TransactionsScreen, { title: locale.buy, onBack: () => setScreen("main"), closeModal, locale, setScreen, client });
  }
  if (screen === "wallet-manager" && activeAccount && walletChain && activeWallet) {
    content = (0, import_jsx_runtime91.jsx)(WalletManagerScreen, { onBack: () => setScreen("main"), accountAbstraction: (_e = props.connectOptions) == null ? void 0 : _e.accountAbstraction, appMetadata: (_f = props.connectOptions) == null ? void 0 : _f.appMetadata, chain: (_g = props.connectOptions) == null ? void 0 : _g.chain, chains: (_h = props.connectOptions) == null ? void 0 : _h.chains, client, connectLocale: locale, recommendedWallets: (_i = props.connectOptions) == null ? void 0 : _i.recommendedWallets, showAllWallets: !!((_j = props.connectOptions) == null ? void 0 : _j.showAllWallets), walletConnect: (_k = props.connectOptions) == null ? void 0 : _k.walletConnect, wallets: (_l = props.connectOptions) == null ? void 0 : _l.wallets, activeAccount, activeChain: walletChain, activeWallet });
  }
  if (screen === "network-switcher") {
    content = (0, import_jsx_runtime91.jsx)(
      NetworkSelectorContent,
      {
        ...
        closeModal,
        networkSelector: (_m = props.detailsModal) == null ? void 0 : _m.networkSelector,
        onBack: () => {
          setScreen("main");
        },
    ...
    if (props.supportedNFTs) {
      content = (0, import_jsx_runtime91.jsx)(ViewAssets, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
        setScreen("main");
      }, theme: props.theme, setScreen, client, connectLocale: locale });
    } else {
      content = (0, import_jsx_runtime91.jsx)(ViewTokens, { supportedTokens: props.supportedTokens, onBack: () => {
        setScreen("main");
      }, client, connectLocale: locale });
    }
  } else if (screen === "view-nfts") {
    content = (0, import_jsx_runtime91.jsx)(ViewNFTs, { theme: props.theme, supportedNFTs: props.supportedNFTs, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
    ...
    content = (0, import_jsx_runtime91.jsx)(PrivateKey, { theme: props.theme, onBack: () => {
      setScreen("manage-wallet");
    }, wallet: activeWallet, client });
  } else if (screen === "manage-wallet") {
    content = (0, import_jsx_runtime91.jsx)(ManageWalletScreen, { onBack: () => {
      setScreen("main");
    }, locale, closeModal, client, setScreen });
  } else if (screen === "wallet-connect-receiver") {
    content = (0, import_jsx_runtime91.jsx)(WalletConnectReceiverScreen, { onBack: () => {
      setScreen("manage-wallet");
    }, chains: props.chains, client });
  } else if (screen === "send") {
    content = (0, import_jsx_runtime91.jsx)(SendFunds, { supportedTokens: props.supportedTokens, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "receive") {
    content = (0, import_jsx_runtime91.jsx)(ReceiveFunds, { walletId: activeWallet == null ? void 0 : activeWallet.id, onBack: () => {
      setScreen("main");
    }, client, connectLocale: locale });
  } else if (screen === "buy") {
    content = (0, import_jsx_runtime91.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_n = props.detailsModal) == null ? void 0 : _n.payOptions) || {
      mode: "fund_wallet"
    }, theme: typeof props.theme === "string" ? props.theme : props.theme.type, onDone: closeModal, connectOptions: void 0 });
  }
  return (0, import_jsx_runtime91.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime91.jsx)(Modal, { size: "compact", open: isOpen, setOpen: (_open) => {
    if (!_open) {
      closeModal();
    }
  }, children: content }) });
...
function ConnectedToSmartWallet(props) {
  ...
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = (0, import_react59.useState)(false);
  ...
  const content = (0, import_jsx_runtime91.jsxs)(Container, { flex: "row", bg: "secondaryButtonBg", gap: "xxs", style: {
    borderRadius: radius.md,
    padding: `${spacing.xxs} ${spacing.sm} ${spacing.xxs} ${spacing.xs}`
  }, center: "y", children: [(0, import_jsx_runtime91.jsx)(Container, { flex: "row", color: "accentText", center: "both", children: (0, import_jsx_runtime91.jsx)(SmartWalletBadgeIcon, { size: iconSize.xs }) }), (0, import_jsx_runtime91.jsx)(Text, { size: "xs", color: "secondaryButtonText", children: locale.connectedToSmartWallet })] });
  if (chain && activeAccount && isSmartWallet) {
    return (0, import_jsx_runtime91.jsxs)(import_jsx_runtime91.Fragment, { children: [isSmartWalletDeployed ? (0, import_jsx_runtime91.jsx)(Link, { color: "secondaryText", hoverColor: "primaryText", href: `https://thirdweb.com/${chain.id}/${activeAccount.address}/account`, target: "_blank", size: "sm", children: content }) : (0, import_jsx_runtime91.jsxs)(Text, { size: "sm", children: [" ", content] }), (0, import_jsx_runtime91.jsx)(Spacer, { y: "xs" })] });
  }
  return null;
}
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-NFYAD7D4.js");
  ...
  if (userInfoQuery.data) {
    return (0, import_jsx_runtime91.jsx)(Container, { flex: "row", center: "x", style: {
      paddingBottom: spacing.xs
    }, children: (0, import_jsx_runtime91.jsx)(Text, { size: "sm", children: userInfoQuery.data }) });
  }
  return null;
}
function SwitchNetworkButton2(props) {
  const switchChain = useSwitchActiveWalletChain();
  const [switching, setSwitching] = (0, import_react59.useState)(false);
  const locale = props.connectLocale;
  const switchNetworkBtnTitle = props.switchNetworkBtnTitle ?? locale.switchNetwork;
  return (0, import_jsx_runtime91.jsx)(Button, { className: `tw-connect-wallet--switch-network ${props.className || ""}`, variant: "primary", type: "button", "data-is-loading": switching, "data-test": "switch-network-button", disabled: switching, onClick: async () => {
    setSwitching(true);
    try {
    ...
    minWidth: "140px",
    ...props.style
  }, "aria-label": switching ? locale.switchingNetwork : void 0, children: switching ? (0, import_jsx_runtime91.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : switchNetworkBtnTitle });
}
function useWalletDetailsModal() {
  ...
  function openModal(props) {
    ...
    getConnectLocale(props.locale || "en_US").then((locale) => {
      setRootEl((0, import_jsx_runtime91.jsx)(DetailsModal, { client: props.client, locale, detailsModal: {
        footer: props.footer,
...
var ConnectModal = (props) => {
  ...
  const [hideModal, setHideModal] = (0, import_react60.useState)(false);
  const closeModal = (0, import_react60.useCallback)(() => {
    var _a;
  ...
  const setModalVisibility = (0, import_react60.useCallback)((value) => setHideModal(!value), []);
  (0, import_react60.useEffect)(() => {
  ...
  return (0, import_jsx_runtime92.jsx)(Modal, { hide: hideModal, size: props.size, open: isWalletModalOpen, setOpen: (value) => {
    if (hideModal) {
      return;
    }
    if (!value) {
  ...
  }, children: (0, import_jsx_runtime92.jsx)(ConnectModalContent, { shouldSetActive: props.shouldSetActive, screenSetup, setModalVisibility, isOpen: isWalletModalOpen, onClose: closeModal, accountAbstraction: props.accountAbstraction, auth: props.auth, client: props.client, connectLocale: props.connectLocale, size: props.size, welcomeScreen: props.welcomeScreen, meta: props.meta, isEmbed: props.isEmbed, onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, wallets: props.wallets, chain: props.chain, showAllWallets: props.showAllWallets, chains: props.chains, walletConnect: props.walletConnect, modalHeader: void 0, walletIdsToHide: void 0 }) });
};
...
var LockIcon = (props) => {
  return (0, import_jsx_runtime93.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 16 21", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime93.jsx)("path", { d: "M2 21C1.45 21 0.979333 20.8043 0.588 20.413C0.196 20.021 0 19.55 0 19V9C0 8.45 0.196 7.979 0.588 7.587C0.979333 7.19567 1.45 7 2 7H3V5C3 3.61667 3.48767 2.43733 4.463 1.462C5.43767 0.487333 6.61667 0 8 0C9.38333 0 10.5627 0.487333 11.538 1.462C12.5127 2.43733 13 3.61667 13 5V7H14C14.55 7 15.021 7.19567 15.413 7.587C15.8043 7.979 16 8.45 16 9V19C16 19.55 15.8043 20.021 15.413 20.413C15.021 20.8043 14.55 21 14 21H2ZM8 16C8.55 16 9.021 15.8043 9.413 15.413C9.80433 15.021 10 14.55 10 14C10 13.45 9.80433 12.979 9.413 12.587C9.021 12.1957 8.55 12 8 12C7.45 12 6.97933 12.1957 6.588 12.587C6.196 12.979 6 13.45 6 14C6 14.55 6.196 15.021 6.588 15.413C6.97933 15.8043 7.45 16 8 16ZM5 7H11V5C11 4.16667 10.7083 3.45833 10.125 2.875C9.54167 2.29167 8.83333 2 8 2C7.16667 2 6.45833 2.29167 5.875 2.875C5.29167 3.45833 5 4.16667 5 5V7Z", fill: "currentColor" }) });
};
...
function ConnectButton(props) {
  ...
  const wallets = (0, import_react61.useMemo)(() => props.wallets || getDefaultWallets({
    appMetadata: props.appMetadata,
    chains: props.chains
  ...
  const size4 = (0, import_react61.useMemo)(() => {
    var _a2;
    return !canFitWideModal() || wallets.length === 1 ? "compact" : ((_a2 = props.connectModal) == null ? void 0 : _a2.size) || "wide";
  }, [wallets.length, (_a = props.connectModal) == null ? void 0 : _a.size]);
  const autoConnectComp = props.autoConnect !== false && (0, import_jsx_runtime94.jsx)(AutoConnect, { appMetadata: props.appMetadata, client: props.client, wallets, timeout: typeof props.autoConnect === "boolean" ? void 0 : (_b = props.autoConnect) == null ? void 0 : _b.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect });
  if (!localeQuery.data) {
    return (0, import_jsx_runtime94.jsxs)(AnimatedButton, { disabled: true, className: `${((_c = props.connectButton) == null ? void 0 : _c.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
      minWidth: "140px",
      ...(_d = props.connectButton) == null ? void 0 : _d.style
    }, children: [autoConnectComp, (0, import_jsx_runtime94.jsx)(Spinner, { size: "sm", color: "primaryButtonText" })] });
  }
  return (0, import_jsx_runtime94.jsxs)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: [(0, import_jsx_runtime94.jsx)(ConnectButtonInner, { ...props, connectLocale: localeQuery.data }), (0, import_jsx_runtime94.jsx)(ConnectModal_default, { shouldSetActive: true, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: props.chain || ((_e = props.accountAbstraction) == null ? void 0 : _e.chain), chains: props.chains, client: props.client, connectLocale: localeQuery.data, meta: {
  ...
  }, welcomeScreen: (_k = props.connectModal) == null ? void 0 : _k.welcomeScreen, size: size4, isEmbed: false, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets }), autoConnectComp] });
}
function ConnectButtonInner(props) {
  ...
  const activeAccount = useActiveAccount();
  const siweAuth = useSiweAuth(activeWallet, activeAccount, props.auth);
  const [showSignatureModal, setShowSignatureModal] = (0, import_react61.useState)(false);
  ...
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const supportedTokens = (0, import_react61.useMemo)(() => {
  ...
  if (!activeAccount) {
    return (0, import_jsx_runtime94.jsx)(AnimatedButton, { disabled: isLoading, className: `${((_b = props.connectButton) == null ? void 0 : _b.className) || ""} ${TW_CONNECT_WALLET}`, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
      minWidth: "140px",
    ...
    }, "data-test": "connect-wallet-button", children: isLoading ? (0, import_jsx_runtime94.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : connectButtonLabel });
  }
  if (siweAuth.requiresAuth) {
    if (siweAuth.isLoading || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
      return (0, import_jsx_runtime94.jsx)(AnimatedButton, { disabled: true, className: `${((_d = props.connectButton) == null ? void 0 : _d.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
        minWidth: "140px",
        ...(_e = props.connectButton) == null ? void 0 : _e.style
      }, children: (0, import_jsx_runtime94.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) });
    }
    if (!siweAuth.isLoggedIn) {
      return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime94.Fragment, { children: [(0, import_jsx_runtime94.jsx)(Button, { variant: "primary", type: "button", onClick: () => {
        setShowSignatureModal(true);
      }, className: (_f = props.signInButton) == null ? void 0 : _f.className, style: {
        minWidth: "140px",
        ...(_g = props.signInButton) == null ? void 0 : _g.style
      }, children: siweAuth.isLoggingIn ? (0, import_jsx_runtime94.jsx)(Spinner, { size: "sm", color: "primaryButtonText" }) : (0, import_jsx_runtime94.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime94.jsx)(LockIcon, { size: iconSize.sm }), (0, import_jsx_runtime94.jsxs)("span", { children: [" ", ((_h = props.signInButton) == null ? void 0 : _h.label) || locale.signIn, " "] })] }) }), (0, import_jsx_runtime94.jsx)(Modal, { size: "compact", open: showSignatureModal, setOpen: setShowSignatureModal, children: (0, import_jsx_runtime94.jsx)(SignatureScreen, { client: props.client, connectLocale: locale, modalSize: "compact", termsOfServiceUrl: (_i = props.connectModal) == null ? void 0 : _i.termsOfServiceUrl, privacyPolicyUrl: (_j = props.connectModal) == null ? void 0 : _j.privacyPolicyUrl, onDone: () => setShowSignatureModal(false), auth: props.auth }) })] });
    }
  }
  return (0, import_jsx_runtime94.jsx)(ConnectedWalletDetails, { theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
    var _a2;
    if (siweAuth.requiresAuth) {
      siweAuth.doLogout();
    }
...
function DirectPaymentModeScreen(props) {
  ...
  if (!chainData || totalCost === void 0) {
    return (0, import_jsx_runtime95.jsx)(LoadingScreen, {});
  }
  ...
  return (0, import_jsx_runtime95.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime95.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Payment Details" }), (0, import_jsx_runtime95.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime95.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime95.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeWallet ? (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", center: "both", style: {
    padding: spacing.md,
    marginBottom: spacing.md,
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  }, children: [(0, import_jsx_runtime95.jsx)(WalletImage, { size: iconSize.xl, id: activeWallet.id, client }), (0, import_jsx_runtime95.jsx)("div", { style: {
    flexGrow: 1,
    borderBottom: "6px dotted",
    borderColor: theme.colors.secondaryIconColor,
    marginLeft: spacing.md,
    marginRight: spacing.md
  } }), (0, import_jsx_runtime95.jsx)(ChainIcon, { client, size: iconSize.xl, chainIconUrl: (_e = chainData.icon) == null ? void 0 : _e.url })] }) : null, (0, import_jsx_runtime95.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime95.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime95.jsx)(Text, { size: "md", color: "primaryText", weight: 700, children: "Price" }) }), (0, import_jsx_runtime95.jsx)(Container, { expand: true, children: (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime95.jsx)(TokenIcon, { chain: paymentInfo.chain, client: props.client, size: "sm", token }), (0, import_jsx_runtime95.jsxs)(Text, { color: "primaryText", size: "md", weight: 700, children: [String(formatNumber(Number(totalCost), 6)), " ", token.symbol] })] }) })] }), (0, import_jsx_runtime95.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime95.jsx)(Line, {}), (0, import_jsx_runtime95.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime95.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime95.jsx)(Text, { size: "xs", color: "secondaryText", children: "Network" }) }), (0, import_jsx_runtime95.jsx)(Container, { expand: true, children: (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime95.jsx)(ChainIcon, { chainIconUrl: (_f = chainData.icon) == null ? void 0 : _f.url, size: "xs", client: props.client }), (0, import_jsx_runtime95.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: chainData.name })] }) })] }), (0, import_jsx_runtime95.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime95.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime95.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime95.jsx)(Text, { size: "xs", color: "secondaryText", children: "Seller" }) }), (0, import_jsx_runtime95.jsx)(Container, { expand: true, children: (0, import_jsx_runtime95.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: (0, import_jsx_runtime95.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: sellerEns || shortenAddress(paymentInfo.sellerAddress) }) }) })] })] }), (0, import_jsx_runtime95.jsx)(Spacer, { y: "xl" }), payerAccount ? (0, import_jsx_runtime95.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    onContinue(totalCost, paymentInfo.chain, token);
  }, children: "Choose Payment Method" }) : (0, import_jsx_runtime95.jsx)("div", { children: (0, import_jsx_runtime95.jsx)(ConnectButton, { ...props.connectOptions, client, theme, connectButton: {
    style: {
      width: "100%"
    }
  } }) })] });
...
function EstimatedTimeAndFees(props) {
  ...
  return (0, import_jsx_runtime96.jsxs)(Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
    borderRadius: radius.md,
    ...
    borderWidth: "1px",
    borderStyle: "solid"
  }, children: [(0, import_jsx_runtime96.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "accentText", p: "sm", children: [(0, import_jsx_runtime96.jsx)(ClockIcon, { width: iconSize.sm, height: iconSize.sm }), quoteIsLoading ? (0, import_jsx_runtime96.jsx)(Skeleton, { height: fontSize.xs, width: "50px", color: "borderColor" }) : (0, import_jsx_runtime96.jsx)(Text, { size: "xs", color: "secondaryText", children: estimatedSeconds !== void 0 ? `~${formatSeconds(estimatedSeconds)}` : "--" })] }), (0, import_jsx_runtime96.jsxs)(Button, { variant: "ghost", onClick: props.onViewFees, gap: "xs", children: [(0, import_jsx_runtime96.jsx)(Container, { color: "accentText", flex: "row", center: "both", children: (0, import_jsx_runtime96.jsx)(ViewFeeIcon, { size: iconSize.sm }) }), (0, import_jsx_runtime96.jsx)(Text, { size: "xs", color: "secondaryText", children: "View Fees" })] })] });
}
var ViewFeeIcon = (props) => {
  return (0, import_jsx_runtime96.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", children: [(0, import_jsx_runtime96.jsx)("path", { d: "M9.5 1.5H2.5C1.94772 1.5 1.5 1.94772 1.5 2.5V9.5C1.5 10.0523 1.94772 10.5 2.5 10.5H9.5C10.0523 10.5 10.5 10.0523 10.5 9.5V2.5C10.5 1.94772 10.0523 1.5 9.5 1.5Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime96.jsx)("path", { d: "M4.5 7.5L7.5 4.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function PayWithCreditCard(props) {
  return (0, import_jsx_runtime97.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    ...
    justifyContent: "space-between",
    alignItems: "center"
  }, children: [(0, import_jsx_runtime97.jsxs)(CurrencyButton, { variant: "ghost", onClick: props.onSelectCurrency, style: {
    minHeight: "64px",
    justifyContent: "flex-start",
    minWidth: "50%"
  }, gap: "sm", children: [(0, import_jsx_runtime97.jsx)(props.currency.icon, { size: iconSize.md }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", center: "y", gap: "xxs", color: "secondaryText", children: [(0, import_jsx_runtime97.jsx)(Text, { color: "primaryText", children: props.currency.shorthand }), (0, import_jsx_runtime97.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] })] }), (0, import_jsx_runtime97.jsx)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
  ...
  }, children: props.isLoading ? (0, import_jsx_runtime97.jsx)(Skeleton, { width: "100px", height: fontSize.lg }) : (0, import_jsx_runtime97.jsx)(Text, { size: "lg", color: props.value ? "primaryText" : "secondaryText", children: props.value ? `${formatNumber(Number(props.value), 6)}` : "--" }) })] });
}
...
function useTransactionCostAndData(args) {
  ...
  const [txQueryKey, setTxQueryKey] = (0, import_react62.useState)();
...
function TransactionModeScreen(props) {
  ...
  if (!transactionCostAndData || !chainData) {
    return (0, import_jsx_runtime98.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime98.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime98.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Transaction" }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime98.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime98.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeWallet ? (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", center: "both", style: {
    padding: spacing.md,
    marginBottom: spacing.md,
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  }, children: [(0, import_jsx_runtime98.jsx)(WalletImage, { size: iconSize.xl, id: activeWallet.id, client }), (0, import_jsx_runtime98.jsx)("div", { style: {
    flexGrow: 1,
    borderBottom: "6px dotted",
    borderColor: theme.colors.secondaryIconColor,
    marginLeft: spacing.md,
    marginRight: spacing.md
  } }), (0, import_jsx_runtime98.jsx)(ChainIcon, { client, size: iconSize.xl, chainIconUrl: (_a = chainData.icon) == null ? void 0 : _a.url })] }) : null, (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime98.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime98.jsx)(Text, { size: "md", color: "primaryText", weight: 700, children: "Price" }) }), (0, import_jsx_runtime98.jsx)(Container, { expand: true, children: (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime98.jsx)(TokenIcon, { chain: payUiOptions.transaction.chain, client: props.client, size: "sm", token: transactionCostAndData.token }), (0, import_jsx_runtime98.jsxs)(Text, { color: "primaryText", size: "md", weight: 700, children: [String(formatNumber(Number(toTokens(transactionCostAndData.transactionValueWei, transactionCostAndData.decimals)), 6)), " ", transactionCostAndData.token.symbol] })] }) })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsx)(Line, {}), (0, import_jsx_runtime98.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime98.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime98.jsx)(Text, { size: "xs", color: "secondaryText", children: "Gas Fees" }) }), (0, import_jsx_runtime98.jsx)(Container, { expand: true, children: (0, import_jsx_runtime98.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: (0, import_jsx_runtime98.jsx)(Text, { color: sponsoredTransactionsEnabled ? "success" : "primaryText", size: "xs", children: sponsoredTransactionsEnabled ? "Sponsored" : `${String(formatNumber(Number(toTokens(transactionCostAndData.gasCostWei, chainData.nativeCurrency.decimals)), 6))} ${chainData.nativeCurrency.symbol}` }) }) })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime98.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime98.jsx)(Text, { size: "xs", color: "secondaryText", children: "Network" }) }), (0, import_jsx_runtime98.jsx)(Container, { expand: true, children: (0, import_jsx_runtime98.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime98.jsx)(ChainIcon, { chainIconUrl: (_b = chainData.icon) == null ? void 0 : _b.url, size: "xs", client: props.client }), (0, import_jsx_runtime98.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: chainData.name })] }) })] })] }), (0, import_jsx_runtime98.jsx)(Spacer, { y: "xl" }), payerAccount ? (0, import_jsx_runtime98.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
  ...
  }, children: "Choose Payment Method" }) : (0, import_jsx_runtime98.jsx)("div", { children: (0, import_jsx_runtime98.jsx)(ConnectButton, { ...props.connectOptions, client, theme, connectButton: {
    style: {
      width: "100%"
    }
  } }) })] });
...
function WalletSelectorButton(props) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime99.jsx)(Container, { bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    ...props.containerStyle
  }, children: (0, import_jsx_runtime99.jsxs)(Button, { fullWidth: true, disabled: props.disabled, onClick: props.onClick, variant: "ghost", style: {
    justifyContent: "space-between",
    padding: spacing.sm,
    backgroundColor: theme.colors.tertiaryBg
  }, gap: "sm", children: [(0, import_jsx_runtime99.jsx)(WalletRow, { client: props.client, address: props.address }), !props.disableChevron && (0, import_jsx_runtime99.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    color: theme.colors.secondaryText
  } }), props.checked && (0, import_jsx_runtime99.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md })] }) });
}
function WalletRow(props) {
  ...
  return (0, import_jsx_runtime99.jsxs)(Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [ensAvatarQuery.data ? (0, import_jsx_runtime99.jsx)(Img, { src: ensAvatarQuery.data, width: iconSize.md, height: iconSize.md, style: {
    borderRadius: radius.sm
  }, client: props.client }) : walletId ? (0, import_jsx_runtime99.jsx)(WalletImage, { id: walletId, size: iconSize.md, client: props.client }) : null, (0, import_jsx_runtime99.jsx)(Text, { size: "sm", color: "primaryText", children: addressOrENS || shortenAddress(props.address) }), walletId === "smart" && (0, import_jsx_runtime99.jsx)(Container, { color: "accentText", center: "both", children: (0, import_jsx_runtime99.jsx)(SmartWalletBadgeIcon, { size: iconSize.sm }) })] });
}
...
function CurrencySelection(props) {
  return (0, import_jsx_runtime100.jsxs)(Container, { children: [(0, import_jsx_runtime100.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime100.jsx)(ModalHeader, { title: "Pay with", onBack: props.onBack }) }), (0, import_jsx_runtime100.jsx)(Line, {}), (0, import_jsx_runtime100.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime100.jsx)(Container, { flex: "column", gap: "xs", px: "lg", children: currencies.map((c) => {
    return (0, import_jsx_runtime100.jsxs)(SelectCurrencyButton, { fullWidth: true, variant: "secondary", onClick: () => props.onSelect(c), gap: "sm", children: [(0, import_jsx_runtime100.jsx)(c.icon, { size: iconSize.lg }), (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime100.jsx)(Text, { color: "primaryText", children: c.shorthand }), (0, import_jsx_runtime100.jsx)(Text, { size: "sm", children: c.name })] })] }, c.shorthand);
  }) }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "lg" })] });
}
...
function OnrampStatusScreen(props) {
  ...
  const invalidatedBalance = (0, import_react63.useRef)(false);
  (0, import_react63.useEffect)(() => {
    var _a2;
  ...
  return (0, import_jsx_runtime101.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime101.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.hasTwoSteps && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime101.jsx)(StepBar, { steps: 2, currentStep: 1 }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime101.jsxs)(Text, { size: "xs", children: ["Step 1 of 2 - Buying ", props.quote.onRampToken.token.symbol, " with", " ", props.quote.fromCurrencyWithFees.currencySymbol] })] }), (0, import_jsx_runtime101.jsx)(OnrampStatusScreenUI, { uiStatus, onDone: props.onDone, fiatStatus: statusQuery.data, client: props.client, transactionMode: props.transactionMode, quote: props.quote, isEmbed: props.isEmbed })] });
}
function OnrampStatusScreenUI(props) {
  ...
  const txDetails = (0, import_jsx_runtime101.jsx)(OnRampTxDetailsTable, { client: props.client, token: (fiatStatus == null ? void 0 : fiatStatus.source) ? {
  ...
  return (0, import_jsx_runtime101.jsxs)(Container, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "xl" }), uiStatus === "loading" && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime101.jsx)(Spinner, { size: "xxl", color: "accentText" }) }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Buy Pending" }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "sm" }), !isMobile() && (0, import_jsx_runtime101.jsx)(Text, { center: true, children: "Complete the purchase in popup" }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "xxl" }), txDetails] }), uiStatus === "failed" && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime101.jsx)(AccentFailIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime101.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Transaction Failed" }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "xxl" }), txDetails] }), uiStatus === "completed" && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Container, { flex: "row", center: "x", color: "success", children: (0, import_jsx_runtime101.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }) }), (0, import_jsx_runtime101.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime101.jsx)(Text, { color: "primaryText", size: "lg", center: true, children: "Buy Complete" }), props.fiatStatus && props.fiatStatus.status !== "NOT_FOUND" && (0, import_jsx_runtime101.jsxs)(import_jsx_runtime101.Fragment, { children: [(0, import_jsx_runtime101.jsx)(Spacer, { y: "xxl" }), txDetails, (0, import_jsx_runtime101.jsx)(Spacer, { y: "sm" })] }), !props.isEmbed && (0, import_jsx_runtime101.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/FiatFlow.js
function FiatFlow(props) {
  const hasTwoSteps = isSwapRequiredPostOnramp(props.quote);
  const [screen, setScreen] = (0, import_react64.useState)(hasTwoSteps ? {
    id: "step-1"
  } : {
    id: "onramp-status"
  });
  const [popupWindow, setPopupWindow] = (0, import_react64.useState)(props.openedWindow);
  if (screen.id === "step-1") {
    return (0, import_jsx_runtime102.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: fiatQuoteToPartialQuote(props.quote), step: 1, onContinue: () => {
  ...
  if (screen.id === "onramp-status") {
    return (0, import_jsx_runtime102.jsx)(OnrampStatusScreen, { title: props.title, client: props.client, intentId: props.quote.intentId, onBack: props.onBack, hasTwoSteps, openedWindow: popupWindow, quote: props.quote, onDone: props.onDone, onShowSwapFlow: (_status) => {
      setScreen({ id: "postonramp-swap", data: _status });
    }, transactionMode: props.transactionMode, isEmbed: props.isEmbed });
  }
  if (screen.id === "postonramp-swap") {
    return (0, import_jsx_runtime102.jsx)(PostOnRampSwapFlow, { title: props.title, status: screen.data, quote: fiatQuoteToPartialQuote(props.quote), client: props.client, onBack: props.onBack, onDone: props.onDone, onSwapFlowStarted: () => {
...
function useUISelectionStates(options) {
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react65.useState)(initialTokenAmount);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const [toChain, setToChain] = (0, import_react65.useState)(
  ...
  const [toToken, setToToken] = (0, import_react65.useState)((prefillBuy == null ? void 0 : prefillBuy.token) || payOptions.mode === "direct_payment" && payOptions.paymentInfo.token || NATIVE_TOKEN);
  const [fromChain, setFromChain] = (0, import_react65.useState)(
    // use prefill chain if available
  ...
  const [fromToken, setFromToken] = (0, import_react65.useState)(
  ...
  const [selectedCurrency, setSelectedCurrency] = (0, import_react65.useState)(defaultSelectedCurrency);
  return {
    tokenAmount,
    setTokenAmount,
    toChain,
...
function BuyTokenInput(props) {
  ...
  return (0, import_jsx_runtime103.jsxs)(Container, { children: [(0, import_jsx_runtime103.jsx)("div", { onClick: (e) => {
    var _a;
    (_a = e.currentTarget.querySelector("input")) == null ? void 0 : _a.focus();
  }, children: (0, import_jsx_runtime103.jsxs)(Container, { flex: "row", center: "both", gap: "xs", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime103.jsx)(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", tabIndex: -1, placeholder: "0", type: "text", "data-placeholder": props.value === "", value: props.value || "0", disabled: props.freezeAmount, onClick: (e) => {
    if (props.value === "") {
  ...
  } }), (0, import_jsx_runtime103.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "lg", color: "secondaryText" })] }) }), !props.hideTokenSelector && (0, import_jsx_runtime103.jsxs)(import_jsx_runtime103.Fragment, { children: [(0, import_jsx_runtime103.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime103.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime103.jsxs)(TokenButton, { variant: "secondary", fullWidth: true, style: {
    fontSize: fontSize.sm
  }, gap: "xxs", onClick: props.onSelectToken, disabled: props.freezeChainAndToken, children: [(0, import_jsx_runtime103.jsxs)(Container, { flex: "row", center: "y", gap: "sm", children: [(0, import_jsx_runtime103.jsx)(TokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime103.jsxs)(Container, { flex: "column", style: {
    gap: "4px"
  }, children: [(0, import_jsx_runtime103.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), name ? (0, import_jsx_runtime103.jsx)(Text, { size: "xs", color: "secondaryText", children: name }) : (0, import_jsx_runtime103.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), (0, import_jsx_runtime103.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    marginLeft: "auto"
  } })] }) })] })] });
}
...
function PayWithCrypto(props) {
  ...
  return (0, import_jsx_runtime104.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    borderWidth: "1px",
    borderTopWidth: 0,
    borderStyle: "solid",
    flexWrap: "nowrap",
  ...
  }, children: [(0, import_jsx_runtime104.jsxs)(Button, { variant: "ghost", onClick: props.onSelectToken, gap: "sm", style: {
    paddingInline: spacing.sm,
    paddingBlock: spacing.sm,
    minWidth: "50%",
    justifyContent: "flex-start"
  }, disabled: props.freezeChainAndTokenSelection, children: [(0, import_jsx_runtime104.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime104.jsxs)(Container, { flex: "column", gap: "3xs", children: [(0, import_jsx_runtime104.jsxs)(Container, { flex: "row", gap: "xs", center: "y", color: "primaryText", children: [(0, import_jsx_runtime104.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), (0, import_jsx_runtime104.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] }), name ? (0, import_jsx_runtime104.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime104.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), (0, import_jsx_runtime104.jsxs)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
    ...
    justifyContent: "center",
    paddingRight: spacing.sm
  }, children: [props.isLoading ? (0, import_jsx_runtime104.jsx)(Skeleton, { width: "120px", height: fontSize.md, color: "borderColor" }) : (0, import_jsx_runtime104.jsx)(Text, { size: "md", color: props.value ? "primaryText" : "secondaryText", style: {}, children: formatNumber(Number(props.value), 6) || "" }), (0, import_jsx_runtime104.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", color: "secondaryText", children: [(0, import_jsx_runtime104.jsx)(GenericWalletIcon, { size: fontSize.xs }), balanceQuery.data ? (0, import_jsx_runtime104.jsx)(Text, { size: "xs", color: "secondaryText", weight: 500, children: formatTokenBalance(balanceQuery.data, false) }) : (0, import_jsx_runtime104.jsx)(Skeleton, { width: "70px", height: fontSize.xs })] })] })] });
}
...
function TransferFlow(props) {
  ...
  const [step, setStep] = (0, import_react66.useState)("transfer");
  const [status, setStatus] = (0, import_react66.useState)("idle");
  const { symbol } = useChainSymbol(chain);
  return (0, import_jsx_runtime105.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime105.jsx)(ModalHeader, { title, onBack }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "xl" }), transactionMode && (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: [(0, import_jsx_runtime105.jsx)(StepBar, { steps: 2, currentStep: step === "transfer" ? 1 : 2 }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime105.jsx)(Text, { size: "sm", children: step === "transfer" ? "Step 1 of 2 - Transfer funds" : "Step 2 of 2 - Finalize transaction" }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "xl" })] }), (0, import_jsx_runtime105.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime105.jsx)(Text, { size: "sm", children: "From" }), (0, import_jsx_runtime105.jsx)(WalletRow, { address: payer.account.address, client })] }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime105.jsx)(Line, {}), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime105.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime105.jsx)(Text, { size: "sm", children: "To" }), (0, import_jsx_runtime105.jsx)(WalletRow, { address: receiverAddress, client })] }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime105.jsx)(Line, {}), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime105.jsx)(TokenInfoRow, { chainId: chain.id, client, label: "Amount", tokenAmount, tokenSymbol: isNativeToken(token) ? symbol || "" : token.symbol, tokenAddress: isNativeToken(token) ? NATIVE_TOKEN_ADDRESS : token.address }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "lg" }), transactionMode && (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: [(0, import_jsx_runtime105.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime105.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime105.jsx)(Step, { isDone: step === "execute", isActive: step === "transfer", label: step === "transfer" ? "Transfer" : "Done" }), (0, import_jsx_runtime105.jsx)(ConnectorLine, {}), (0, import_jsx_runtime105.jsx)(Step, { isDone: false, label: "Finalize", isActive: step === "execute" })] }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "lg" })] }), status === "error" && (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: [(0, import_jsx_runtime105.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, import_jsx_runtime105.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime105.jsx)(Text, { color: "danger", size: "sm", children: step === "transfer" ? "Failed to Transfer" : "Failed to Execute" })] }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" })] }), !transactionMode && step === "execute" && status === "done" && (0, import_jsx_runtime105.jsxs)(import_jsx_runtime105.Fragment, { children: [(0, import_jsx_runtime105.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "success", children: [(0, import_jsx_runtime105.jsx)(CheckCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime105.jsx)(Text, { color: "success", size: "sm", children: "Payment completed" })] }), (0, import_jsx_runtime105.jsx)(Spacer, { y: "md" })] }), payer.chain.id !== chain.id ? (0, import_jsx_runtime105.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(chain);
  } }) : (0, import_jsx_runtime105.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
    if (step === "execute") {
      onDone();
      return;
    }
  ...
  }, gap: "xs", children: [step === "execute" && (status === "done" ? "Done" : "Continue"), step === "transfer" && (status === "pending" ? "Confirming" : "Confirm"), status === "pending" && (0, import_jsx_runtime105.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}
...
function WalletSwitcherDrawerContent(props) {
  ...
  const connectedWallets = useConnectedWallets();
  const hideConnectButton = !props.showAllWallets && ((_a = props.wallets) == null ? void 0 : _a.every((w) => connectedWallets.includes(w)));
  return (0, import_jsx_runtime106.jsxs)(Container, { children: [(0, import_jsx_runtime106.jsxs)(Container, { flex: "column", gap: "xs", children: [connectedWallets.map((w) => {
    var _a2;
    const address = (_a2 = w.getAccount()) == null ? void 0 : _a2.address;
    return (0, import_jsx_runtime106.jsx)(WalletSelectorButton, { walletId: w.id, client: props.client, address: address || "", onClick: () => {
      props.onSelect(w);
      props.onBack();
    }, disableChevron: true, checked: false }, w.id);
  }), !hideConnectButton && (0, import_jsx_runtime106.jsx)(Button, { variant: "secondary", fullWidth: true, onClick: props.onConnect, gap: "xs", bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    padding: spacing.sm
  }, children: (0, import_jsx_runtime106.jsxs)(Container, { flex: "row", gap: "sm", center: "y", expand: true, children: [(0, import_jsx_runtime106.jsx)(PlusIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime106.jsx)(Text, { size: "sm", color: "primaryText", children: "Add Another Wallet" })] }) })] }), (0, import_jsx_runtime106.jsx)(Spacer, { y: "sm" })] });
}
...
function usePayerSetup() {
  ...
  const account = useActiveAccount();
  const activeChain = useActiveWalletChain();
  const [_payer, setPayer] = (0, import_react67.useState)();
...
function BuyScreen2(props) {
  ...
  return (0, import_jsx_runtime107.jsx)(BuyScreenContent, { ...props, supportedDestinations: supportedDestinationsQuery.data });
}
function BuyScreenContent(props) {
  ...
  const [screen, setScreen] = (0, import_react68.useState)({
    id: "main"
  });
  const [hasEditedAmount, setHasEditedAmount] = (0, import_react68.useState)(false);
  const onDone = (0, import_react68.useCallback)(() => {
    setScreen({ id: "main" });
    props.onDone();
  }, [props.onDone]);
  ...
  const destinationSupportedTokens = (0, import_react68.useMemo)(() => {
  ...
  const sourceSupportedTokens = (0, import_react68.useMemo)(() => {
  ...
  if (screen.id === "connect-payer-wallet") {
    ...
    }, recommendedWallets: (_e = props.connectOptions) == null ? void 0 : _e.recommendedWallets, showAllWallets: !!((_f = props.connectOptions) == null ? void 0 : _f.showAllWallets), walletConnect: (_g = props.connectOptions) == null ? void 0 : _g.walletConnect, wallets: (_h = props.connectOptions) == null ? void 0 : _h.wallets });
  }
  if (screen.id === "swap-flow" && payer) {
    return (0, import_jsx_runtime107.jsx)(SwapFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", isEmbed: props.isEmbed, client, onBack: () => {
      setScreen({
        id: "buy-with-crypto"
      });
  ...
  if (screen.id === "fiat-flow" && payer) {
    return (0, import_jsx_runtime107.jsx)(FiatFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", quote: screen.quote, onBack: () => {
      setScreen({
        id: "buy-with-fiat"
      });
    }, client, testMode: props.payOptions.buyWithFiat !== false && ((_i = props.payOptions.buyWithFiat) == null ? void 0 : _i.testMode) === true, theme: typeof props.theme === "string" ? props.theme : props.theme.type, openedWindow: screen.openedWindow, onDone, isEmbed: props.isEmbed, payer });
  }
  if (screen.id === "transfer-flow" && payer && activeAccount) {
    const goBack = () => setScreen({ id: "buy-with-crypto" });
    const defaultRecipientAddress = (_k = (_j = props.payOptions) == null ? void 0 : _j.paymentInfo) == null ? void 0 : _k.sellerAddress;
    const receiverAddress = defaultRecipientAddress || activeAccount.address;
    return (0, import_jsx_runtime107.jsx)(TransferFlow, { title: props.title, onBack: goBack, payer, client: props.client, onDone, chain: toChain, token: toToken, tokenAmount, receiverAddress, transactionMode: props.payOptions.mode === "transaction" });
  }
  if (screen.id === "select-currency") {
    const goBack = () => setScreen(screen.backScreen);
    return (0, import_jsx_runtime107.jsx)(CurrencySelection, { onSelect: (currency) => {
      goBack();
  ...
  if (screen.id === "select-to-token") {
    ...
    const goBack = () => setScreen(screen.backScreen);
    const allowEdits = (_l = payOptions == null ? void 0 : payOptions.prefillBuy) == null ? void 0 : _l.allowEdits;
    if ((allowEdits == null ? void 0 : allowEdits.token) === false) {
      return (0, import_jsx_runtime107.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setToChain, goBack });
    }
    return (0, import_jsx_runtime107.jsx)(TokenSelector, { onBack: goBack, tokenList: (((toChain == null ? void 0 : toChain.id) ? destinationSupportedTokens[toChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
  ...
  if (screen.id === "select-from-token" && supportedSourcesQuery.data && sourceSupportedTokens) {
    ...
    const goBack = () => setScreen(screen.backScreen);
    if (payOptions.buyWithCrypto !== false && ((_o = (_n = (_m = payOptions.buyWithCrypto) == null ? void 0 : _m.prefillSource) == null ? void 0 : _n.allowEdits) == null ? void 0 : _o.token) === false) {
      return (0, import_jsx_runtime107.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setFromChain, goBack });
    }
    return (0, import_jsx_runtime107.jsx)(TokenSelector, { onBack: goBack, tokenList: (((fromChain == null ? void 0 : fromChain.id) ? sourceSupportedTokens[fromChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
      setFromToken(tokenInfo);
      goBack();
    }, chain: fromChain, chainSelection: (
      // hide chain selection if it's disabled
      payOptions.buyWithCrypto !== false && ((_r = (_q = (_p = payOptions.buyWithCrypto) == null ? void 0 : _p.prefillSource) == null ? void 0 : _q.allowEdits) == null ? void 0 : _r.chain) !== false ? {
        chains: supportedSourcesQuery.data.map((x) => x.chain),
        select: (c) => setFromChain(c)
      } : void 0
    ), connectLocale, client, modalTitle: "Pay with" });
  }
  return (0, import_jsx_runtime107.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime107.jsxs)("div", { children: [screen.id === "main" && (0, import_jsx_runtime107.jsx)(MainScreen, { title: props.title, payerAccount: payer == null ? void 0 : payer.account, client, onSelectBuyToken: () => setScreen({ id: "select-to-token", backScreen: screen }), payOptions, setTokenAmount, setToChain, setToToken, setFromChain, setFromToken, toChain, toToken, tokenAmount, connectOptions: props.connectOptions, setScreen, supportedDestinations, onBack: props.onBack, theme: props.theme, hasEditedAmount, setHasEditedAmount, enabledPaymentMethods }), (screen.id === "select-payment-method" || screen.id === "select-wallet" || screen.id === "buy-with-crypto" || screen.id === "buy-with-fiat") && payer && (0, import_jsx_runtime107.jsxs)(TokenSelectedLayout, { title: props.title, selectedChain: toChain, selectedToken: toToken, tokenAmount, client, onBack: () => {
  ...
  }, children: [screen.id === "select-payment-method" && (0, import_jsx_runtime107.jsx)(PaymentMethodSelection, { setScreen: (id) => setScreen({ id }) }), screen.id === "select-wallet" && (0, import_jsx_runtime107.jsx)(WalletSwitcherDrawerContent, { client, onSelect: (w) => {
    const chain = w.getChain();
    const account = w.getAccount();
    if (chain && account) {
      setPayer({
  ...
  }, showAllWallets: !!((_s = props.connectOptions) == null ? void 0 : _s.showAllWallets), wallets: (_t = props.connectOptions) == null ? void 0 : _t.wallets, onBack: () => {
  }, onConnect: () => {
    setScreen({
  ...
  }, selectedAddress: payer.account.address }), screen.id === "buy-with-crypto" && activeAccount && (0, import_jsx_runtime107.jsx)(SwapScreenContent, {
    setScreen,
    ...
    setTokenAmount,
    setHasEditedAmount,
    disableTokenSelection: payDisabled === true || payOptions.buyWithCrypto !== false && ((_w = (_v = (_u = payOptions.buyWithCrypto) == null ? void 0 : _u.prefillSource) == null ? void 0 : _v.allowEdits) == null ? void 0 : _w.chain) === false && ((_z = (_y = (_x = payOptions.buyWithCrypto) == null ? void 0 : _x.prefillSource) == null ? void 0 : _y.allowEdits) == null ? void 0 : _z.token) === false
  }), screen.id === "buy-with-fiat" && (0, import_jsx_runtime107.jsx)(FiatScreenContent, { setScreen, tokenAmount: deferredTokenAmount, toChain, toToken, selectedCurrency, client, isEmbed: props.isEmbed, onDone, payOptions, theme: props.theme, showCurrencySelector: () => {
    setScreen({
      id: "select-currency",
      backScreen: screen
    });
...
function SelectedTokenInfo(props) {
  return (0, import_jsx_runtime107.jsx)("div", { children: (0, import_jsx_runtime107.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime107.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime107.jsx)(Text, { color: "primaryText", "data-testid": "tokenAmount", size: "xl", children: formatNumber(Number(props.tokenAmount), 6) }), (0, import_jsx_runtime107.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime107.jsx)(TokenSymbol, { token: props.selectedToken, chain: props.selectedChain, size: "md", color: "secondaryText" }), (0, import_jsx_runtime107.jsx)(PayTokenIcon, { chain: props.selectedChain, client: props.client, size: "sm", token: props.selectedToken })] })] }), (0, import_jsx_runtime107.jsx)(ChainName, { chain: props.selectedChain, client: props.client, size: "sm", short: true })] }) });
}
function MainScreen(props) {
  ...
  switch (payOptions.mode) {
    case "transaction": {
      return (0, import_jsx_runtime107.jsx)(TransactionModeScreen, { supportedDestinations, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, client, onContinue: (tokenAmount2, toChain2, toToken2) => {
    ...
    case "direct_payment": {
      return (0, import_jsx_runtime107.jsx)(DirectPaymentModeScreen, { client, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, supportedDestinations, onContinue: (tokenAmount2, toChain2, toToken2) => {
        setTokenAmount(tokenAmount2);
        setToChain(toChain2);
        setFromChain(toChain2);
        setFromToken(toToken2);
    ...
    default: {
      return (0, import_jsx_runtime107.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime107.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime107.jsx)(BuyTokenInput, { value: tokenAmount, onChange: async (value) => {
        props.setHasEditedAmount(true);
        setTokenAmount(value);
      }, freezeAmount: ((_b = (_a = payOptions.prefillBuy) == null ? void 0 : _a.allowEdits) == null ? void 0 : _b.amount) === false, freezeChainAndToken: ((_d = (_c = payOptions.prefillBuy) == null ? void 0 : _c.allowEdits) == null ? void 0 : _d.chain) === false && ((_f = (_e = payOptions.prefillBuy) == null ? void 0 : _e.allowEdits) == null ? void 0 : _f.token) === false, token: toToken, chain: toChain, onSelectToken: props.onSelectBuyToken, client: props.client }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime107.jsx)(Container, { flex: "column", gap: "sm", children: !payerAccount ? (0, import_jsx_runtime107.jsx)("div", { children: (0, import_jsx_runtime107.jsx)(ConnectButton, { ...props.connectOptions, client: props.client, theme: props.theme, connectButton: {
        style: {
          width: "100%"
        }
      } }) }) : (0, import_jsx_runtime107.jsx)(Button, { variant: "accent", fullWidth: true, disabled: disableContinue, "data-disabled": disableContinue, onClick: () => {
        if (showPaymentSelection) {
          props.setScreen({ id: "select-payment-method" });
        } else if (buyWithCryptoEnabled) {
          props.setScreen({ id: "buy-with-crypto" });
...
function TokenSelectedLayout(props) {
  return (0, import_jsx_runtime107.jsxs)(Container, { children: [(0, import_jsx_runtime107.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime107.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime107.jsxs)(Container, { px: "lg", style: {
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime107.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime107.jsx)(SelectedTokenInfo, { selectedToken: props.selectedToken, selectedChain: props.selectedChain, tokenAmount: props.tokenAmount, client: props.client }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime107.jsx)(Line, {}), (0, import_jsx_runtime107.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime107.jsx)(Text, { size: "sm", children: " Pay with " }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "sm" }), props.children] })] });
}
function PaymentMethodSelection(props) {
  return (0, import_jsx_runtime107.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime107.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime107.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => props.setScreen("buy-with-fiat"), gap: "sm", style: {
    justifyContent: "flex-start",
    textAlign: "left"
  }, children: [(0, import_jsx_runtime107.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime107.jsx)(IdCardIcon, { style: {
    width: iconSize.md,
    height: iconSize.md
  } }) }), (0, import_jsx_runtime107.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime107.jsx)(Text, { size: "md", color: "primaryText", children: "Credit Card" }), (0, import_jsx_runtime107.jsx)(Text, { size: "xs", children: "Securely pay with credit card" })] })] }), (0, import_jsx_runtime107.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => props.setScreen("select-wallet"), style: {
    justifyContent: "flex-start"
  }, gap: "sm", children: [(0, import_jsx_runtime107.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime107.jsx)(CoinsIcon, { size: iconSize.md }) }), (0, import_jsx_runtime107.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime107.jsx)(Text, { size: "md", color: "primaryText", children: "Crypto" }), (0, import_jsx_runtime107.jsx)(Text, { size: "xs", children: "Pay with your connected wallet" })] })] })] }) });
}
function SwapScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react68.useState)("fees");
  ...
  return (0, import_jsx_runtime107.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime107.jsxs)(import_jsx_runtime107.Fragment, { children: [(0, import_jsx_runtime107.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime107.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && quoteQuery.data && (0, import_jsx_runtime107.jsxs)("div", { children: [(0, import_jsx_runtime107.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime107.jsx)(SwapFees, { quote: quoteQuery.data, align: "left" })] }) })] }), (0, import_jsx_runtime107.jsxs)("div", { children: [(0, import_jsx_runtime107.jsx)(WalletSelectorButton, { client: props.client, onClick: () => {
    setScreen({ id: "select-wallet" });
  }, address: props.payer.account.address, walletId: props.payer.wallet.id, containerStyle: {
    borderBottomRightRadius: 0,
    borderBottomLeftRadius: 0
  } }), (0, import_jsx_runtime107.jsx)(PayWithCrypto, { value: sourceTokenAmount || "", onSelectToken: showFromTokenSelector, chain: fromChain, token: fromToken, isLoading: quoteQuery.isLoading && !sourceTokenAmount, client, freezeChainAndTokenSelection: disableTokenSelection, payerAccount: props.payer.account, swapRequired }), swapRequired && (0, import_jsx_runtime107.jsx)(EstimatedTimeAndFees, { quoteIsLoading: quoteQuery.isLoading, estimatedSeconds: (_d = quoteQuery.data) == null ? void 0 : _d.swapDetails.estimated.durationSeconds, onViewFees: showFees }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime107.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime107.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime107.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime107.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), !errorMsg && isNotEnoughBalance && (0, import_jsx_runtime107.jsxs)("div", { children: [(0, import_jsx_runtime107.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Not enough funds." }), (0, import_jsx_runtime107.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Try a different wallet or token." })] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime107.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : switchChainRequired && !quoteQuery.isLoading && !isNotEnoughBalance && !quoteQuery.error ? (0, import_jsx_runtime107.jsx)(SwitchNetworkButton, { variant: "accent", fullWidth: true, switchChain: async () => {
    await props.payer.wallet.switchChain(fromChain);
  } }) : (0, import_jsx_runtime107.jsx)(Button, { variant: disableContinue ? "outline" : "accent", fullWidth: true, "data-disabled": disableContinue, disabled: disableContinue, onClick: async () => {
    if (!disableContinue) {
      showSwapFlow();
    }
  }, gap: "xs", children: quoteQuery.isLoading ? (0, import_jsx_runtime107.jsxs)(import_jsx_runtime107.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime107.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
function FiatScreenContent(props) {
  ...
  return (0, import_jsx_runtime107.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime107.jsxs)(import_jsx_runtime107.Fragment, { children: [(0, import_jsx_runtime107.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime107.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && fiatQuoteQuery.data && (0, import_jsx_runtime107.jsxs)("div", { children: [(0, import_jsx_runtime107.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime107.jsx)(FiatFees, { quote: fiatQuoteQuery.data })] }) })] }), (0, import_jsx_runtime107.jsxs)("div", { children: [(0, import_jsx_runtime107.jsx)(PayWithCreditCard, { isLoading: fiatQuoteQuery.isLoading, value: (_c = fiatQuoteQuery.data) == null ? void 0 : _c.fromCurrencyWithFees.amount, client, currency: selectedCurrency, onSelectCurrency: showCurrencySelector }), (0, import_jsx_runtime107.jsx)(EstimatedTimeAndFees, { quoteIsLoading: fiatQuoteQuery.isLoading, estimatedSeconds: (_d = fiatQuoteQuery.data) == null ? void 0 : _d.estimatedDurationSeconds, onViewFees: showFees }), (0, import_jsx_runtime107.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime107.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime107.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime107.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime107.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime107.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : (0, import_jsx_runtime107.jsx)(Button, { variant: disableSubmit ? "outline" : "accent", "data-disabled": disableSubmit, disabled: disableSubmit, fullWidth: true, onClick: handleSubmit, gap: "xs", children: fiatQuoteQuery.isLoading ? (0, import_jsx_runtime107.jsxs)(import_jsx_runtime107.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime107.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
...
function ChainSelectionScreen(props) {
  return (0, import_jsx_runtime107.jsx)(NetworkSelectorContent, { client: props.client, connectLocale: props.connectLocale, showTabs: false, onBack: props.goBack, chains: props.chains, closeModal: props.goBack, networkSelector: {
    renderChain(renderChainProps) {
      return (0, import_jsx_runtime107.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
...
//# sourceMappingURL=chunk-IV5RXYAW.js.map
