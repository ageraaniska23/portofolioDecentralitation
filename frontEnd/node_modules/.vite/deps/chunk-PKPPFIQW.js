...
function createEcosystemWallet(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-3LWTX44P.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-3LWTX44P.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, {
        id,
        partnerId: createOptions == null ? void 0 : createOptions.partnerId
      });
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-FSTFG62C.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-FSTFG62C.js");
      const provider = await args.providerFactory();
  ...
  switch (true) {
    ...
    case id === COINBASE: {
      ...
      return coinbaseWalletSDK({
        ...
        onConnectRequested: async (provider) => {
          const { showCoinbasePopup } = await import("./utils-DPFKF4HN.js");
    ...
    default: {
      ...
      const wallet = {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
          const { injectedProvider } = await import("./mipdStore-Z7BWT6NR.js");
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-4MLODEDP.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-TFNQI7OK.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-TFNQI7OK.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-4MLODEDP.js");
...
//# sourceMappingURL=chunk-PKPPFIQW.js.map
