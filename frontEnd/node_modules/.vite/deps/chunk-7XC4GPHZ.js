...
function smartWallet(createOptions) {
  ...
  const _smartWallet = {
    ...
    autoConnect: async (options) => {
      const { connectSmartWallet } = await import("./smart-YZU3KMOU.js");
    ...
    disconnect: async () => {
      account = void 0;
      chain = void 0;
      const { disconnectSmartWallet } = await import("./smart-YZU3KMOU.js");
...
//# sourceMappingURL=chunk-7XC4GPHZ.js.map
