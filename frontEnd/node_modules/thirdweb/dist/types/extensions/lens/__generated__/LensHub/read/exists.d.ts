 ...
 * @returns A promise that resolves to a boolean indicating if the `exists` method is supported.
 * @extension LENS
 * @example
 * ```ts
 * import { isExistsSupported } from "thirdweb/extensions/lens";
 *
 * const supported = await isExistsSupported(contract);
 * ```
 */
export declare function isExistsSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
