...
export declare function prepareContractCall<const TAbi extends Abi, const TMethod extends TAbi extends {
    length: 0;
} ? AbiFunction | `function ${string}` | ((contract: ThirdwebContract<TAbi>) => Promise<AbiFunction>) : ExtractAbiFunctionNames<TAbi>, const TPreparedMethod extends PreparedMethod<ParseMethod<TAbi, TMethod>> = PreparedMethod<ParseMethod<TAbi, TMethod>>>(options: PrepareContractCallOptions<TAbi, TMethod, TPreparedMethod>): import("./prepare-transaction.js").PreparedTransaction<TAbi, ParseMethod<TAbi, TMethod>, PrepareTransactionOptions>;
