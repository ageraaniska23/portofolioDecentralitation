...
import type { SendTransactionPayModalConfig, useSendTransactionCore } from "./useSendTransaction.js";
/**
...
export declare const useTransactionButtonMutation: (props: TransactionButtonProps, sendTransactionFn: ReturnType<typeof useSendTransactionCore>["mutateAsync"]) => import("@tanstack/react-query").UseMutationResult<void, Error, void, unknown>;
//# sourceMappingURL=transaction-button-utils.d.ts.map