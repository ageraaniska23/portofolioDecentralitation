    ...
    if (!_provider) {
        ...
        react_native_1.Linking.addEventListener("url", ({ url }) => {
            ...
            if (callbackURL &&
                ...
                (0, wallet_mobile_sdk_1.handleResponse)(url);
            }
        });
