...
const get_ecosystem_partner_permissions_js_1 = require("../../../ecosystem/get-ecosystem-partner-permissions.js");
...
class IFrameWallet {
    ...
    constructor({ client, ecosystem, querier, }) {
        ...
        this.localStorage = new LocalStorage_js_1.LocalStorage({
    ...
    async getAccount() {
        ...
        const permissions = this.ecosystem?.partnerId
            ? await (0, get_ecosystem_partner_permissions_js_1.getEcosystemPartnerPermissions)(this.ecosystem.id, this.ecosystem?.partnerId)
            : undefined;
        ...
        return {
            ...
            async signMessage({ message }) {
                ...
                const messageDecoded = (() => {
                    ...
                    return (0, hex_js_1.hexToString)(message.raw);
                })();
