...
exports.prepareContractCall = prepareContractCall;
...
const prepare_transaction_js_1 = require("./prepare-transaction.js");
...
function prepareContractCall(options) {
    ...
    return (0, prepare_transaction_js_1.prepareTransaction)({
        ...
        data: async () => {
            ...
            return (preparedM[0] +
                (0, encodeAbiParameters_js_1.encodeAbiParameters)(preparedM[1], 
                // @ts-expect-error - TODO: fix this type issue
                await (0, resolve_promised_value_js_1.resolvePromisedValue)(params ?? [])).slice(2));
        },
    }, {
