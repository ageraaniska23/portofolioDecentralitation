...
function EcosystemWalletConnectUI(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(EcosystemWalletFormUI_js_1.EcosystemWalletFormUIScreen, { select: () => { }, locale: locale, done: props.done, goBack: props.goBack, wallet: props.wallet, chain: props.chain, client: props.client, size: props.size, connectLocale: props.connectLocale, meta: props.meta }));
}
