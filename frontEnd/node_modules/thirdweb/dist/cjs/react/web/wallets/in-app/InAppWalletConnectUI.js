...
function InAppWalletConnectUI(props) {
    ...
    const otpUserInfo = state?.emailLogin
        ...
        : state?.phoneLogin
            ...
            : undefined;
    if (otpUserInfo) {
        return ((0, jsx_runtime_1.jsx)(OTPLoginUI_js_1.OTPLoginUI, { userInfo: otpUserInfo, locale: locale, done: props.done, goBack: goBackToMain, wallet: props.wallet, chain: props.chain, client: props.client, size: props.size }));
    }
    if (state?.passkeyLogin) {
        return ((0, jsx_runtime_1.jsx)(PassKeyLogin_js_1.PassKeyLogin, { wallet: props.wallet, done: props.done, onBack: goBackToMain, chain: props.chain, client: props.client, size: props.size }));
    }
    if (state?.socialLogin) {
        return ((0, jsx_runtime_1.jsx)(SocialLogin_js_1.SocialLogin, { socialAuth: state.socialLogin.type, locale: locale, done: props.done, goBack: goBackToMain, wallet: props.wallet, state: state, chain: props.chain, client: props.client, size: props.size }));
    }
    return ((0, jsx_runtime_1.jsx)(InAppWalletFormUI_js_1.InAppWalletFormUIScreen, { select: () => { }, connectLocale: props.connectLocale, inAppWalletLocale: locale, done: props.done, goBack: props.goBack, wallet: props.wallet, client: props.client, meta: props.meta, size: props.size, chain: props.chain }));
}
