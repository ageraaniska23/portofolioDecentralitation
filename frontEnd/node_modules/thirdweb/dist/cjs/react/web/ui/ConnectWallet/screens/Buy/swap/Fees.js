...
function SwapFees(props) {
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "xs", style: {
            ...
            return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", children: [(0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", size: "sm", style: { textAlign: "right" }, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "xs", style: { textAlign: "right" }, children: ["$", (fee.amountUSDCents / 100).toFixed(2)] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`));
        }) }));
}
/**
 * @internal
