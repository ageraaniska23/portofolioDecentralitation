...
function WalletConnectReceiverScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
            minHeight: "300px",
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Connect an App", onBack: props.onBack }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", scrollY: true, style: {
                    maxHeight: "500px",
                }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { py: "sm", style: { position: "relative" }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { py: "md", children: (0, jsx_runtime_1.jsx)(WalletLogoSpinner_js_1.WalletLogoSpinner, { client: props.client, error: !!errorConnecting, id: "walletConnect", hideSpinner: !loading }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", style: {
                                animationDuration: "200ms",
                            }, children: !errorConnecting ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { balance: true, center: true, multiline: true, size: "sm", children: "Copy your connection URI from the external app." }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { type: "text", disabled: loading || !!errorConnecting || !walletConnectClient, onSelect: async (value) => {
                                            setLoading(true);
                                            if (!walletConnectClient) {
                                        ...
                                        }, placeholder: "WalletConnect URI", name: "wcUri", emptyErrorMessage: "Please enter a valid URI", submitButtonText: "Connect" })] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { center: true, balance: true, multiline: true, size: "sm", children: errorConnecting }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", animate: "fadein", children: (0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { fullWidth: true, variant: "accent", onClick: () => setErrorConnecting(false), style: {
                                                gap: index_js_2.spacing.xs,
                                                alignItems: "center",
                                            }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.ReloadIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm }), " ", "Retry"] }) })] })) })] }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", p: "lg", children: (0, jsx_runtime_1.jsx)("a", { href: "https://blog.thirdweb.com/p/a62c0ef4-1d8f-424d-95b9-a006e5239849/", children: (0, jsx_runtime_1.jsx)(buttons_js_1.Button, { variant: "link", onClick: () => { }, children: "Where do I find the URI?" }) }) })] })] }));
}
