...
function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return ((0, jsx_runtime_1.jsx)(PostOnRampSwap_js_1.PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer }));
    }
