...
function ConnectButton(props) {
    ...
    if (props.chains) {
        (0, utils_js_1.cacheChains)(props.chains);
    }
    if (props.chain) {
        (0, utils_js_1.cacheChains)([props.chain]);
    }
...
function ConnectButtonInner(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(Details_js_1.ConnectedWalletDetails, { theme: theme, detailsButton: props.detailsButton, detailsModal: props.detailsModal, supportedTokens: supportedTokens, supportedNFTs: props.supportedNFTs, onDisconnect: (info) => {
