...
function SwapFlow(props) {
    ...
    if (swapTxHash) {
        return ((0, jsx_runtime_1.jsx)(SwapStatusScreen_js_1.SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash: swapTxHash, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote: quote }));
    }
