...
async function getERC721ClaimTo({ contract, account, claimParams, }) {
    const [{ isERC721 }, { isClaimSupported }, { claimTo }] = await Promise.all([
        ...
        Promise.resolve().then(() => require("../../../../../../extensions/erc721/__generated__/IDrop/write/claim.js")),
        Promise.resolve().then(() => require("../../../../../../extensions/erc721/drops/write/claimTo.js")),
    ]);
...
async function getERC1155ClaimTo({ contract, account, claimParams, }) {
    const [{ isERC1155 }, { isClaimSupported }, { claimTo }] = await Promise.all([
        ...
        Promise.resolve().then(() => require("../../../../../../extensions/erc1155/__generated__/IDrop1155/write/claim.js")),
        Promise.resolve().then(() => require("../../../../../../extensions/erc1155/drops/write/claimTo.js")),
    ]);
...
async function getERC20ClaimTo({ contract, account, claimParams, }) {
    ...
    const [{ isClaimSupported }, { claimTo }] = await Promise.all([
        Promise.resolve().then(() => require("../../../../../../extensions/erc20/__generated__/IDropERC20/write/claim.js")),
        Promise.resolve().then(() => require("../../../../../../extensions/erc20/drops/write/claimTo.js")),
    ]);
