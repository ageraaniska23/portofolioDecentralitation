        ...
        async function fetchImage() {
            ...
            if (activeEOAId === "inApp" &&
                ...
                switch (lastAuthProvider) {
                    case "google":
                        image = socialIcons_js_1.googleIconUri;
                        break;
                    case "apple":
                        image = socialIcons_js_1.appleIconUri;
                        break;
                    case "facebook":
                        image = socialIcons_js_1.facebookIconUri;
                        break;
                    case "phone":
                        image = socialIcons_js_1.phoneIcon;
                        break;
                    case "email":
                        image = socialIcons_js_1.emailIcon;
                        break;
                    case "passkey":
                        image = socialIcons_js_1.passkeyIcon;
                        break;
                    case "discord":
                        image = socialIcons_js_1.discordIconUri;
                        break;
                    case "farcaster":
                        image = socialIcons_js_1.farcasterIconUri;
                        break;
                    case "telegram":
                        image = socialIcons_js_1.telegramIconUri;
                        break;
                }
            }
            else {
...
function WalletImageQuery(props) {
    ...
    if (walletImage.isFetched && !walletImage.data) {
        return ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, src: socialIcons_js_1.genericWalletIcon, width: props.size, height: props.size }));
    }
    return ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, src: walletImage.isLoading ? undefined : walletImage.data, fallbackImage: socialIcons_js_1.genericWalletIcon, width: props.size, height: props.size, loading: "eager", style: {
            borderRadius: index_js_2.radius.md,
        } }));
}
