...
const ShuffleIconLucide_js_1 = require("./icons/ShuffleIconLucide.js");
...
const ConnectedWalletDetails = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${props.detailsButton?.className || ""}`, style: props.detailsButton?.style, "data-test": "connected-wallet-details", onClick: openModal, children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.lg, height: index_js_1.iconSize.lg, style: {
                    borderRadius: index_js_1.radius.sm,
                }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_1.iconSize.lg, id: activeWallet.id, client: client })) : ((0, jsx_runtime_1.jsx)(GenericWalletIcon_js_1.GenericWalletIcon, { size: index_js_1.iconSize.lg })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", children: [addressOrENS ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: addressOrENS })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.sm, width: "88px" })), balanceQuery.data ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", weight: 500, children: [Number(balanceQuery.data.displayValue).toFixed(3), " ", balanceQuery.data.symbol] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.xs, width: "82px" }))] })] }));
};
...
function DetailsModal(props) {
    ...
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: !chainIconQuery.isLoading ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chainIconUrl: chainIconQuery.url, size: index_js_1.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: `${index_js_1.iconSize.md}px`, width: `${index_js_1.iconSize.md}px` })) }), chainNameQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "150px" })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", multiline: true, children: chainNameQuery.name || `Unknown chain #${walletChain?.id}` })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsx)(buttons_js_1.IconButton, { style: {
                    position: "absolute",
                    top: index_js_1.spacing.lg,
                    left: index_js_1.spacing.lg,
                    ...
                    }, children: (0, jsx_runtime_1.jsx)(ShuffleIconLucide_js_1.ShuffleIconLucide, { size: "20" }) }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.xxl, height: index_js_1.iconSize.xxl, style: {
                            borderRadius: index_js_1.radius.lg,
                        }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_1.iconSize.xxl, id: activeWallet.id, client: client })) : ((0, jsx_runtime_1.jsx)(GenericWalletIcon_js_1.GenericWalletIcon, { size: index_js_1.iconSize.xxl })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(ConnectedToSmartWallet, { client: props.client, connectLocale: locale }), (activeWallet?.id === "embedded" || activeWallet?.id === "inApp") && ((0, jsx_runtime_1.jsx)(InAppWalletUserInfo, { client: props.client })), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
    ...
    return ((0, jsx_runtime_1.jsx)(CustomThemeProvider_js_1.CustomThemeProvider, { theme: props.theme, children: (0, jsx_runtime_1.jsx)(Modal_js_1.Modal, { size: "compact", open: isOpen, setOpen: (_open) => {
                if (!_open) {
                    closeModal();
                }
            }, children: content }) }));
