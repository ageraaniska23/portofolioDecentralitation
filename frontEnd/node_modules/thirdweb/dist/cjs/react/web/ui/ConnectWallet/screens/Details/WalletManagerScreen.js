...
function WalletManagerScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", style: {
                    minHeight: "150px",
                }, children: (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "xs", children: connectedWallets.map((w) => {
...
function WalletManangerButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            position: "relative",
                ...
                }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "sm", center: "y", children: [(0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { client: props.client, id: walletId, size: index_js_1.iconSize.xl }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: (0, address_js_1.shortenAddress)(address || "") }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxs" }), balanceQuery.data ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "secondaryText", children: (0, formatTokenBalance_js_1.formatTokenBalance)(balanceQuery.data) })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: "100px", height: index_js_1.fontSize.sm }))] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: {
                    position: "absolute",
                    zIndex: 1,
                    ...
                    transform: "translateY(-50%)",
                        ...
                        }, children: (0, jsx_runtime_1.jsx)(react_icons_1.CrossCircledIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, style: {
