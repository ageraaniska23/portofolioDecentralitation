...
function SwapTxDetailsTable(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
            // Expected + Got
            ...
            // Receive
            (0, jsx_runtime_1.jsx)(TokenInfoRow_js_1.TokenInfoRow, { chainId: toToken.chainId, client: client, label: "Receive", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })), lineSpacer, (0, jsx_runtime_1.jsx)(TokenInfoRow_js_1.TokenInfoRow, { chainId: fromToken.chainId, client: client, label: "Pay", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", style: {
                    justifyContent: "space-between",
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { children: " Time " }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", children: ["~", (0, formatSeconds_js_1.formatSeconds)(estimatedDuration || 0)] }) })] }), statusMeta && showStatusRow && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", style: {
                            justifyContent: "space-between",
                        }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { children: "Status" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: statusMeta.color, children: statusMeta.status }) })] })] })), uiData.fromAddress.toLowerCase() !== uiData.toAddress.toLowerCase() && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [lineSpacer, (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", style: {
                            justifyContent: "space-between",
                        }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { children: "Send to" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "sm", children: (0, address_js_1.shortenAddress)(uiData.toAddress) }) })] })] })), lineSpacer, fromChainExplorers.explorers?.[0]?.url && sourceTxHash && ((0, jsx_runtime_1.jsxs)(buttons_js_1.ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
                ...
                toChainExplorers?.explorers?.[0]?.url && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsxs)(buttons_js_1.ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainExplorers.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
                            fontSize: index_js_1.fontSize.sm,
                            padding: index_js_1.spacing.sm,
