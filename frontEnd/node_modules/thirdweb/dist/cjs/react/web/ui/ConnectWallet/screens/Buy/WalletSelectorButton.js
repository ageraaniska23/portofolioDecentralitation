...
function WalletRow(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, style: {
                ...
                }, client: props.client })) : walletId ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { id: walletId, size: index_js_1.iconSize.md, client: props.client })) : null, (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", children: addressOrENS || (0, address_js_1.shortenAddress)(props.address) }), walletId === "smart" && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { color: "accentText", center: "both", children: (0, jsx_runtime_1.jsx)(SmartAccountBadgeIcon_js_1.SmartWalletBadgeIcon, { size: index_js_1.iconSize.sm }) }))] }));
}
