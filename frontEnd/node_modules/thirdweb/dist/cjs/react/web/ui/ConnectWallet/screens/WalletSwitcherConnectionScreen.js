...
function WalletSwitcherConnectionScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ConnectModalContent_js_1.ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: undefined, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, isEmbed: props.isEmbed, isOpen: true, meta: {
