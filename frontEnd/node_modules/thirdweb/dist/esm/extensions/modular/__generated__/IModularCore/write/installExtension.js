...
export const FN_SELECTOR = "0xaca696f5";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export async function isInstallExtensionSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function encodeInstallExtensionParams(options) {
 ...
 * ```
 */
export function encodeInstallExtension(options) {
