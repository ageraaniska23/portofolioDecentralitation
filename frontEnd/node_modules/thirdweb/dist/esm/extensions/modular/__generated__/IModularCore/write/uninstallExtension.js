...
export const FN_SELECTOR = "0x42b7d0c8";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export async function isUninstallExtensionSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function encodeUninstallExtensionParams(options) {
 ...
 * ```
 */
export function encodeUninstallExtension(options) {
