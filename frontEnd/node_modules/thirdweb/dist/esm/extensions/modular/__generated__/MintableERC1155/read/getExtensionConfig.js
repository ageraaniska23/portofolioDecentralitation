...
export const FN_SELECTOR = "0x7c173ecc";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "config",
 ...
 * ```
 */
export async function isGetExtensionConfigSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function decodeGetExtensionConfigResult(result) {
 ...
 * ```
 */
export async function getExtensionConfig(options) {
    return readContract({
