 ...
 * @returns A promise that resolves to a boolean indicating if the `getFollowTimestamp` method is supported.
 * @extension LENS
 * @example
 * ```ts
 * import { isGetFollowTimestampSupported } from "thirdweb/extensions/lens";
 *
 * const supported = await isGetFollowTimestampSupported(contract);
 * ```
 */
export async function isGetFollowTimestampSupported(contract) {
    return detectMethod({
        contract,
