...
export function SwapFees(props) {
    return (_jsx(Container, { flex: "column", gap: "xs", style: {
            ...
            return (_jsxs(Container, { flex: "column", gap: "xxs", children: [_jsxs(Text, { color: "primaryText", size: "sm", style: { textAlign: "right" }, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), _jsxs(Text, { color: "secondaryText", size: "xs", style: { textAlign: "right" }, children: ["$", (fee.amountUSDCents / 100).toFixed(2)] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`));
        }) }));
}
/**
 * @internal
