...
import { appleIconUri, discordIconUri, emailIcon, facebookIconUri, farcasterIconUri, genericWalletIcon, googleIconUri, passkeyIcon, phoneIcon, telegramIconUri, } from "../../../core/utils/socialIcons.js";
...
function WalletImageQuery(props) {
    ...
    if (walletImage.isFetched && !walletImage.data) {
        return (_jsx(Img, { client: props.client, src: genericWalletIcon, width: props.size, height: props.size }));
    }
