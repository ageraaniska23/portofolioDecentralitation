...
function DetailsModal(props) {
    ...
    const networkSwitcherButton = (_jsxs(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: !chainIconQuery.isLoading ? (_jsx(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.md, active: true, client: client })) : (_jsx(Skeleton, { height: `${iconSize.md}px`, width: `${iconSize.md}px` })) }), chainNameQuery.isLoading ? (_jsx(Skeleton, { height: "16px", width: "150px" })) : (_jsx(Text, { color: "primaryText", multiline: true, children: chainNameQuery.name || `Unknown chain #${walletChain?.id}` })), _jsx(StyledChevronRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xl" }), _jsx(IconButton, { style: {
                    position: "absolute",
                    top: spacing.lg,
                    left: spacing.lg,
                    ...
                    }, children: _jsx(ShuffleIconLucide, { size: "20" }) }) }), _jsxs(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
