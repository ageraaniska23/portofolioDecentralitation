...
export function WalletManagerScreen(props) {
    ...
    return (_jsxs(Container, { children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), _jsx(Line, {}), _jsx(Spacer, { y: "md" }), _jsx(Container, { px: "md", style: {
                    minHeight: "150px",
                }, children: _jsx(Container, { flex: "column", gap: "xs", children: connectedWallets.map((w) => {
...
function WalletManangerButton(props) {
    ...
    return (_jsxs("div", { style: {
            position: "relative",
                ...
                }, children: _jsxs(Container, { flex: "row", gap: "sm", center: "y", children: [_jsx(WalletImage, { client: props.client, id: walletId, size: iconSize.xl }), _jsxs("div", { children: [_jsx(Text, { color: "primaryText", children: shortenAddress(address || "") }), _jsx(Spacer, { y: "xxs" }), balanceQuery.data ? (_jsx(Text, { size: "sm", color: "secondaryText", children: formatTokenBalance(balanceQuery.data) })) : (_jsx(Skeleton, { width: "100px", height: fontSize.sm }))] })] }) }), _jsx("div", { style: {
                    position: "absolute",
                    zIndex: 1,
                    right: spacing.xxs,
                    top: "50%",
                    transform: "translateY(-50%)",
                        ...
                        }, children: _jsx(CrossCircledIcon, { width: iconSize.md, height: iconSize.md, style: {
