...
export function TransactionButton(props) {
    ...
    return (_jsx(CustomThemeProvider, { theme: props.theme, children: _jsxs(Button, { gap: "xs", disabled: !account || disabled || isPending, variant: "primary", unstyled: unstyled, "data-is-loading": isPending, onClick: () => handleClick(), ...buttonProps, style: !unstyled
                ? {
