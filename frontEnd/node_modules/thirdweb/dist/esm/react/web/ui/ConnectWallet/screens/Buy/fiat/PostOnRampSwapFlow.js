...
export function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return (_jsx(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer }));
    }
    // show step 1 and step 2 details
    return (_jsx(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
