...
export function ConnectEmbed(props) {
    ...
    if (show) {
        ...
        return (_jsxs(WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: [_jsx(ConnectEmbedContent, { auth: props.auth, accountAbstraction: props.accountAbstraction, chain: props.chain || props.accountAbstraction?.chain, chains: props.chains, client: props.client, connectLocale: localeQuery.data, size: modalSize, meta: meta, isEmbed: true, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets: wallets, className: props.className, modalSize: modalSize, style: props.style, welcomeScreen: props.welcomeScreen }), autoConnectComp] }));
    }
