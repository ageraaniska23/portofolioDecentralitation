...
export function WalletSwitcherConnectionScreen(props) {
    ...
    return (_jsx(ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: undefined, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, isEmbed: props.isEmbed, isOpen: true, meta: {
