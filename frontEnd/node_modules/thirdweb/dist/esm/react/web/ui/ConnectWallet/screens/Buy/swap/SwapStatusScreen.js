...
export function SwapStatusScreen(props) {
    ...
    const swapDetails = swapStatus.data && swapStatus.data.status !== "NOT_FOUND" ? (_jsx(SwapTxDetailsTable, { status: swapStatus.data, type: "status", hideStatusRow: true, client: props.client })) : (_jsx(SwapTxDetailsTable, { type: "quote", quote: props.quote, client: props.client }));
