...
export function WalletRow(props) {
    ...
    return (_jsxs(Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.md, height: iconSize.md, style: {
                ...
                }, client: props.client })) : walletId ? (_jsx(WalletImage, { id: walletId, size: iconSize.md, client: props.client })) : null, _jsx(Text, { size: "sm", color: "primaryText", children: addressOrENS || shortenAddress(props.address) }), walletId === "smart" && (_jsx(Container, { color: "accentText", center: "both", children: _jsx(SmartWalletBadgeIcon, { size: iconSize.sm }) }))] }));
}
