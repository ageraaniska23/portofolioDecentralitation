...
export function ViewNFTsContent(props) {
    ...
    const results = useQueries({
        queries: nftList.map((nft) => ({
            ...
            queryFn: () => fetchNFTs(props.client, nft.chain, nft.address, activeAccount?.address),
        })),
    });
