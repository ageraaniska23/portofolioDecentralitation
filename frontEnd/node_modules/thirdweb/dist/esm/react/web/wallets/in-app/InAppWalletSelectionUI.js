...
function InAppWalletSelectionUI(props) {
    ...
    return (_jsx(ConnectWalletSocialOptions, { locale: locale, wallet: props.wallet, done: props.done, select: props.select, goBack: props.goBack, chain: props.chain, client: props.client, size: props.size }));
}
